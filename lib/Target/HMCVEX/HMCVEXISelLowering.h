//===-- HMCVEXISelLowering.h - HMCVEX DAG Lowering Interface --------*- C++ -*-===//
//
...
#ifndef HMCVEXISELLOWERING_H
#define HMCVEXISELLOWERING_H
...
//===--------------------------------------------------------------------===//
class HMCVEXFunctionInfo;
class HMCVEXSubtarget;

//@ Class HMCVEXTargetLowering
class HMCVEXTargetLowering : public TargetLowering{

public:
    explicit HMCVEXTargetLowering(const TargetMachine &TM,
                               const HMCVEXSubtarget &STI);
    
    static const HMCVEXTargetLowering *create(const HMCVEXTargetMachine &TM,
                                           const HMCVEXSubtarget &STI);
