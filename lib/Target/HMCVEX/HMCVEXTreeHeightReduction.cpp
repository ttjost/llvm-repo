//===-- HMCVEXTreeHeightReduction.cpp - Tree Height Reduction Pass -------------===//
//
...
//===----------------------------------------------------------------------===//
//
// Implements the a Tree Height reduction pass for the HMCVEX target.
//
...
#define DEBUG_TYPE "HMCVEX-thr"

using namespace llvm;

namespace {
    
class HMCVEXTreeHeightReductionPass : public BasicBlockPass {
...
public:
    ...
    HMCVEXTreeHeightReductionPass() : BasicBlockPass(ID) {
    }
    
    const char *getPassName() const override {
        return "HMCVEX Tree Height Reduction Pass";
    }
...
bool HMCVEXTreeHeightReductionPass::isValidOperation(Instruction* I) {
...
void HMCVEXTreeHeightReductionPass::computeLeaves() {
...
void HMCVEXTreeHeightReductionPass::computeNode(Instruction* I) {
...
void HMCVEXTreeHeightReductionPass::computeNodes(BasicBlock &BB) {
...
void HMCVEXTreeHeightReductionPass::computeHeight(Instruction* I) {
...
void HMCVEXTreeHeightReductionPass::computeHeights() {
...
void HMCVEXTreeHeightReductionPass::updateLeaves() {
...
bool HMCVEXTreeHeightReductionPass::isLeaf(Instruction *I) {
...
void HMCVEXTreeHeightReductionPass::removeUnrelatedNodes() {
...
void HMCVEXTreeHeightReductionPass::BalanceTree(Instruction *I) {
...
void HMCVEXTreeHeightReductionPass::FindRoots() {
...
bool HMCVEXTreeHeightReductionPass::runOnBasicBlock(BasicBlock &BB) {
    
    DEBUG(dbgs() << "HMCVEX Tree Height Reduction!\n");
    DEBUG(BB.dump());
...
char HMCVEXTreeHeightReductionPass::ID = 0;

BasicBlockPass *llvm::createHMCVEXTreeHeightReductionPass() {
    return new HMCVEXTreeHeightReductionPass();
}
