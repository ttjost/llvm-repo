//===-- HMCVEXFrameLowering.h - Define frame lowering for Cpu0 ----*- C++ -*-===//
//
...
#ifndef HMCVEX_FRAMEINFO_H
#define HMCVEX_FRAMEINFO_H
...
class HMCVEXFrameLowering : public TargetFrameLowering {
