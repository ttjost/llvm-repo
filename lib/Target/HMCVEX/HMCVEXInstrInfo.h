//===-- HMCVEXInstrInfo.h - HMCVEX Instruction Information ----------*- C++ -*-===//
//
...
#ifndef HMCVEXINSTRUCTIONINFO_H
#define HMCVEXINSTRUCTIONINFO_H
...
namespace llvm{
    ...
    class HMCVEXInstrInfo : public HMCVEXGenInstrInfo{
        const HMCVEXRegisterInfo RI;

    protected:
        const HMCVEXSubtarget &Subtarget;
        
    public:
        explicit HMCVEXInstrInfo(const HMCVEXSubtarget &STI);
        ...
        const HMCVEXRegisterInfo &getRegisterInfo() const { return RI; }
        ...
        void adjustStackPtr(HMCVEXFunctionInfo *HMCVEXFI, unsigned SP, uint64_t Amount,
