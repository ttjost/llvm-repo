//===-- HMCVEXISelDAGToDAG.cpp - Top-level interface for HMCVEX representation ----*- C++ -*-===//
//
...
bool HMCVEXDAGToDAGISel::runOnMachineFunction(MachineFunction &MF){
...
bool HMCVEXDAGToDAGISel::SelectAddr(SDValue Addr, SDValue &Base, SDValue &Offset) {
...
SDNode * HMCVEXDAGToDAGISel::Select(SDNode *Node){
...
std::pair<bool, SDNode*> HMCVEXDAGToDAGISel::selectNode(SDNode *Node){
...
//                if (Val == 0) {
//                    SDValue Reg0 = CurDAG->getRegister(HMCVEX::Reg0, MVT::i32);
//                    SDNode* Result = CurDAG->SelectNodeTo(Node, HMCVEX::MTB, Node->getValueType(0), Reg0);
...
void HMCVEXDAGToDAGISel::processFunctionAfterISel(MachineFunction &MF){
...
// createHMCVEXISelDag - This pass converts a legalized DAG into a
// HMCVEX-specific DAG, ready for instruction scheduling.
FunctionPass *llvm::createHMCVEXISelDag(HMCVEXTargetMachine &TM){
    return new HMCVEXDAGToDAGISel(TM);
}
