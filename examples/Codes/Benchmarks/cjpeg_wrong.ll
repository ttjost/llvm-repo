...
entry:
  ...
  %isEqual = alloca i32, align 4
  %position = alloca i32, align 4
  store i32 0, i32* %retval
  store i32 1, i32* %isEqual, align 4
...
if.then12:                                        ; preds = %for.body7
  store i32 0, i32* %isEqual, align 4
  %10 = load i32, i32* %j, align 4
  %11 = load i32, i32* %k, align 4
  %mul = mul nsw i32 %10, %11
  store i32 %mul, i32* %position, align 4
  br label %if.end

if.end:                                           ; preds = %if.then12, %for.body7
  br label %for.inc
...
for.end19:                                        ; preds = %for.cond
  %15 = load i32, i32* %isEqual, align 4
