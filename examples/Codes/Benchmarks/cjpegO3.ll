...
for.cond5.preheader:                              ; preds = %for.cond5.preheader.preheader, %for.inc.7
  %j.031 = phi i32 [ %inc14, %for.inc.7 ], [ 0, %for.cond5.preheader.preheader ]
  %arrayidx8 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data, i32 0, i32 %j.031, i32 0
  %1 = load i32, i32* %arrayidx8, align 4, !tbaa !1
  %arrayidx10 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data_ref, i32 0, i32 %j.031, i32 0
  %2 = load i32, i32* %arrayidx10, align 4, !tbaa !1
  %cmp11 = icmp eq i32 %1, %2
  br i1 %cmp11, label %for.inc, label %if.then12

if.then12:                                        ; preds = %for.inc.6, %for.inc.5, %for.inc.4, %for.inc.3, %for.inc.2, %for.inc.1, %for.inc, %for.cond5.preheader
  %j.031.lcssa = phi i32 [ %j.031, %for.inc.6 ], [ %j.031, %for.inc.5 ], [ %j.031, %for.inc.4 ], [ %j.031, %for.inc.3 ], [ %j.031, %for.inc.2 ], [ %j.031, %for.inc.1 ], [ %j.031, %for.inc ], [ %j.031, %for.cond5.preheader ]
  %k.030.lcssa = phi i32 [ 0, %for.cond5.preheader ], [ 1, %for.inc ], [ 2, %for.inc.1 ], [ 3, %for.inc.2 ], [ 4, %for.inc.3 ], [ 5, %for.inc.4 ], [ 6, %for.inc.5 ], [ 7, %for.inc.6 ]
  %add = add nsw i32 %k.030.lcssa, %j.031.lcssa
  br label %return

for.inc:                                          ; preds = %for.cond5.preheader
  %arrayidx8.1 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data, i32 0, i32 %j.031, i32 1
  %3 = load i32, i32* %arrayidx8.1, align 4, !tbaa !1
  %arrayidx10.1 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data_ref, i32 0, i32 %j.031, i32 1
  %4 = load i32, i32* %arrayidx10.1, align 4, !tbaa !1
  %cmp11.1 = icmp eq i32 %3, %4
  br i1 %cmp11.1, label %for.inc.1, label %if.then12

for.inc17.loopexit:                               ; preds = %for.inc.7
  br label %for.inc17
...
return.loopexit:                                  ; preds = %for.inc17
  br label %return

return:                                           ; preds = %return.loopexit, %if.then12
  %retval.0 = phi i32 [ %add, %if.then12 ], [ -1, %return.loopexit ]
  ret i32 %retval.0

for.inc.1:                                        ; preds = %for.inc
  %arrayidx8.2 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data, i32 0, i32 %j.031, i32 2
  %5 = load i32, i32* %arrayidx8.2, align 4, !tbaa !1
  %arrayidx10.2 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data_ref, i32 0, i32 %j.031, i32 2
  %6 = load i32, i32* %arrayidx10.2, align 4, !tbaa !1
  %cmp11.2 = icmp eq i32 %5, %6
  br i1 %cmp11.2, label %for.inc.2, label %if.then12

for.inc.2:                                        ; preds = %for.inc.1
  %arrayidx8.3 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data, i32 0, i32 %j.031, i32 3
  %7 = load i32, i32* %arrayidx8.3, align 4, !tbaa !1
  %arrayidx10.3 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data_ref, i32 0, i32 %j.031, i32 3
  %8 = load i32, i32* %arrayidx10.3, align 4, !tbaa !1
  %cmp11.3 = icmp eq i32 %7, %8
  br i1 %cmp11.3, label %for.inc.3, label %if.then12

for.inc.3:                                        ; preds = %for.inc.2
  %arrayidx8.4 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data, i32 0, i32 %j.031, i32 4
  %9 = load i32, i32* %arrayidx8.4, align 4, !tbaa !1
  %arrayidx10.4 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data_ref, i32 0, i32 %j.031, i32 4
  %10 = load i32, i32* %arrayidx10.4, align 4, !tbaa !1
  %cmp11.4 = icmp eq i32 %9, %10
  br i1 %cmp11.4, label %for.inc.4, label %if.then12

for.inc.4:                                        ; preds = %for.inc.3
  %arrayidx8.5 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data, i32 0, i32 %j.031, i32 5
  %11 = load i32, i32* %arrayidx8.5, align 4, !tbaa !1
  %arrayidx10.5 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data_ref, i32 0, i32 %j.031, i32 5
  %12 = load i32, i32* %arrayidx10.5, align 4, !tbaa !1
  %cmp11.5 = icmp eq i32 %11, %12
  br i1 %cmp11.5, label %for.inc.5, label %if.then12

for.inc.5:                                        ; preds = %for.inc.4
  %arrayidx8.6 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data, i32 0, i32 %j.031, i32 6
  %13 = load i32, i32* %arrayidx8.6, align 4, !tbaa !1
  %arrayidx10.6 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data_ref, i32 0, i32 %j.031, i32 6
  %14 = load i32, i32* %arrayidx10.6, align 4, !tbaa !1
  %cmp11.6 = icmp eq i32 %13, %14
  br i1 %cmp11.6, label %for.inc.6, label %if.then12

for.inc.6:                                        ; preds = %for.inc.5
  %arrayidx8.7 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data, i32 0, i32 %j.031, i32 7
  %15 = load i32, i32* %arrayidx8.7, align 4, !tbaa !1
  %arrayidx10.7 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data_ref, i32 0, i32 %j.031, i32 7
  %16 = load i32, i32* %arrayidx10.7, align 4, !tbaa !1
  %cmp11.7 = icmp eq i32 %15, %16
  br i1 %cmp11.7, label %for.inc.7, label %if.then12

for.inc.7:                                        ; preds = %for.inc.6
  %inc14 = add nuw nsw i32 %j.031, 1
  %cmp3 = icmp slt i32 %inc14, 8
  br i1 %cmp3, label %for.cond5.preheader, label %for.inc17.loopexit
}
