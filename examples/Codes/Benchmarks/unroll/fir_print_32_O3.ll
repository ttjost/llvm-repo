...
for.body.i.preheader:                             ; preds = %fir_filter_int.exit, %entry
  %i.014 = phi i32 [ 0, %entry ], [ %inc, %fir_filter_int.exit ]
  br label %for.body.i

for.cond1.preheader:                              ; preds = %fir_filter_int.exit
...
for.body7.i.preheader:                            ; preds = %for.body.i
  ...
  br i1 %backedge.overflow, label %for.body7.i, label %overflow.checked

overflow.checked:                                 ; preds = %for.body7.i.preheader
  %2 = add i32 %acc_length.045.i, -1
  %n.vec = and i32 %2, -4
  %end.idx.rnd.down40 = or i32 %n.vec, 1
  %cmp.zero = icmp eq i32 %end.idx.rnd.down40, 1
  %3 = sub i32 0, %n.vec
  %ptr.ind.end = getelementptr i32, i32* %in_ptr.046.i, i32 %3
  %incdec.ptr.i.sum41 = or i32 %n.vec, 1
  %ptr.ind.end17 = getelementptr i32, i32* %coef_start.047.i, i32 %incdec.ptr.i.sum41
  %4 = insertelement <4 x i32> <i32 undef, i32 0, i32 0, i32 0>, i32 %mul.i, i32 0
  br i1 %cmp.zero, label %middle.block, label %vector.body

vector.body:                                      ; preds = %overflow.checked, %vector.body
  %index = phi i32 [ %index.next, %vector.body ], [ 1, %overflow.checked ]
  %vec.phi = phi <4 x i32> [ %10, %vector.body ], [ %4, %overflow.checked ]
  %5 = sub i32 1, %index
  %next.gep27 = getelementptr i32, i32* %coef_start.047.i, i32 %index
  %6 = bitcast i32* %next.gep27 to <4 x i32>*
  %wide.load = load <4 x i32>, <4 x i32>* %6, align 4, !tbaa !1
  %.sum = add i32 %5, -4
  %7 = getelementptr i32, i32* %in_ptr.046.i, i32 %.sum
  %8 = bitcast i32* %7 to <4 x i32>*
  %wide.load35 = load <4 x i32>, <4 x i32>* %8, align 4, !tbaa !1
  %reverse = shufflevector <4 x i32> %wide.load35, <4 x i32> undef, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %9 = mul nsw <4 x i32> %reverse, %wide.load
  %10 = add nsw <4 x i32> %9, %vec.phi
  %index.next = add i32 %index, 4
  %11 = icmp eq i32 %index.next, %end.idx.rnd.down40
  br i1 %11, label %middle.block, label %vector.body, !llvm.loop !5

middle.block:                                     ; preds = %vector.body, %overflow.checked
  %resume.val = phi i32* [ %in_ptr.046.i, %overflow.checked ], [ %ptr.ind.end, %vector.body ]
  %resume.val15 = phi i32* [ %incdec.ptr.i, %overflow.checked ], [ %ptr.ind.end17, %vector.body ]
  %resume.val18 = phi i32 [ 1, %overflow.checked ], [ %end.idx.rnd.down40, %vector.body ]
  %rdx.vec.exit.phi = phi <4 x i32> [ %4, %overflow.checked ], [ %10, %vector.body ]
  ...
  %rdx.shuf38 = shufflevector <4 x i32> %bin.rdx, <4 x i32> undef, <4 x i32> <i32 1, i32 undef, i32 undef, i32 undef>
  %bin.rdx39 = add <4 x i32> %bin.rdx, %rdx.shuf38
  %12 = extractelement <4 x i32> %bin.rdx39, i32 0
  %cmp.n = icmp eq i32 %acc_length.045.i, %resume.val18
  br i1 %cmp.n, label %for.end.i, label %for.body7.i

for.body7.i:                                      ; preds = %for.body7.i.preheader, %middle.block, %for.body7.i
  %in_ptr.046.pn.i = phi i32* [ %data_ptr.042.i, %for.body7.i ], [ %resume.val, %middle.block ], [ %in_ptr.046.i, %for.body7.i.preheader ]
  %coef_ptr.041.i = phi i32* [ %incdec.ptr8.i, %for.body7.i ], [ %resume.val15, %middle.block ], [ %incdec.ptr.i, %for.body7.i.preheader ]
  %acc.040.i = phi i32 [ %add11.i, %for.body7.i ], [ %12, %middle.block ], [ %mul.i, %for.body7.i.preheader ]
  %j.039.i = phi i32 [ %inc.i, %for.body7.i ], [ %resume.val18, %middle.block ], [ 1, %for.body7.i.preheader ]
  ...
  br i1 %exitcond.i, label %for.end.i, label %for.body7.i, !llvm.loop !8

for.end.i:                                        ; preds = %for.body7.i, %middle.block, %for.body.i
  %acc.0.lcssa.i = phi i32 [ %mul.i, %for.body.i ], [ %add11.i, %for.body7.i ], [ %12, %middle.block ]
...
fir_filter_int.exit:                              ; preds = %for.end.i
  ...
  br i1 %exitcond, label %for.cond1.preheader, label %for.body.i.preheader
}
...
for.body7.preheader:                              ; preds = %for.body
  ...
  br i1 %backedge.overflow, label %for.body7, label %overflow.checked
...
middle.block:                                     ; preds = %vector.body, %overflow.checked
  %resume.val = phi i32* [ %in_ptr.046, %overflow.checked ], [ %ptr.ind.end, %vector.body ]
  %resume.val50 = phi i32* [ %incdec.ptr, %overflow.checked ], [ %ptr.ind.end52, %vector.body ]
  %resume.val53 = phi i32 [ 1, %overflow.checked ], [ %end.idx.rnd.down75, %vector.body ]
  %rdx.vec.exit.phi = phi <4 x i32> [ %4, %overflow.checked ], [ %10, %vector.body ]
  %rdx.shuf = shufflevector <4 x i32> %rdx.vec.exit.phi, <4 x i32> undef, <4 x i32> <i32 2, i32 3, i32 undef, i32 undef>
  %bin.rdx = add <4 x i32> %rdx.vec.exit.phi, %rdx.shuf
  ...
  br i1 %cmp.n, label %for.end, label %for.body7

for.body7:                                        ; preds = %for.body7.preheader, %middle.block, %for.body7
  %in_ptr.046.pn = phi i32* [ %data_ptr.042, %for.body7 ], [ %resume.val, %middle.block ], [ %in_ptr.046, %for.body7.preheader ]
  %coef_ptr.041 = phi i32* [ %incdec.ptr8, %for.body7 ], [ %resume.val50, %middle.block ], [ %incdec.ptr, %for.body7.preheader ]
  %acc.040 = phi i32 [ %add11, %for.body7 ], [ %12, %middle.block ], [ %mul, %for.body7.preheader ]
  %j.039 = phi i32 [ %inc, %for.body7 ], [ %resume.val53, %middle.block ], [ 1, %for.body7.preheader ]
  ...
  br i1 %exitcond, label %for.end, label %for.body7, !llvm.loop !11

for.end:                                          ; preds = %for.body7, %middle.block, %for.body
  %acc.0.lcssa = phi i32 [ %mul, %for.body ], [ %add11, %for.body7 ], [ %12, %middle.block ]
