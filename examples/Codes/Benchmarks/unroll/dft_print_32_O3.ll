...
middle.block:                                     ; preds = %vector.body
  %rdx.shuf241 = shufflevector <4 x i32> %39, <4 x i32> undef, <4 x i32> <i32 2, i32 3, i32 undef, i32 undef>
  %bin.rdx242 = add <4 x i32> %39, %rdx.shuf241
  ...
  %rdx.shuf = shufflevector <4 x i32> %71, <4 x i32> undef, <4 x i32> <i32 2, i32 3, i32 undef, i32 undef>
  %bin.rdx = add <4 x i32> %71, %rdx.shuf
