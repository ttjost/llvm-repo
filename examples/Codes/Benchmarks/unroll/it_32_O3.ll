...
for.body:                                         ; preds = %entry, %for.body
  %indvars.iv1269 = phi i32 [ %indvars.iv.next1270, %for.body ], [ 0, %entry ]
...
for.body170:                                      ; preds = %entry, %for.body170
  %indvars.iv1272 = phi i32 [ %indvars.iv.next1273, %for.body170 ], [ 0, %entry ]
...
for.end392:                                       ; preds = %for.body288, %if.end.for.end392_crit_edge
  %arraydecay397.pre-phi = phi i32* [ %.pre, %if.end.for.end392_crit_edge ], [ %arraydecay303, %for.body288 ]
...
for.body409:                                      ; preds = %for.body409, %for.body409.lr.ph
  ...
  br i1 %exitcond1268, label %for.end579, label %for.body409

for.end579:                                       ; preds = %for.body409, %for.end392
  br i1 %tobool, label %vector.body1283, label %vector.body

vector.body:                                      ; preds = %for.end579, %vector.body
  %index = phi i32 [ %index.next, %vector.body ], [ 0, %for.end579 ]
  ...
  br i1 %80, label %vector.body1306, label %vector.body, !llvm.loop !7

vector.body1283:                                  ; preds = %for.end579, %vector.body1283
  %index1286 = phi i32 [ %index.next1293, %vector.body1283 ], [ 0, %for.end579 ]
  ...
  br i1 %174, label %vector.body1306, label %vector.body1283, !llvm.loop !10

vector.body1306:                                  ; preds = %vector.body1283, %vector.body, %vector.body1306
  %index1309 = phi i32 [ %index.next1316, %vector.body1306 ], [ 0, %vector.body ], [ 0, %vector.body1283 ]
