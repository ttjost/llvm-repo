...
for.body:                                         ; preds = %for.body, %entry
  %i.032 = phi i32 [ 0, %entry ], [ %inc, %for.body ]
...
for.cond4.preheader:                              ; preds = %for.cond4.preheader.preheader, %for.inc11.9
  %i.131 = phi i32 [ %inc15, %for.inc11.9 ], [ 0, %for.cond4.preheader.preheader ]
  %arrayidx7 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @c, i32 0, i32 %i.131, i32 0
  %0 = load i32, i32* %arrayidx7, align 4, !tbaa !1
  %arrayidx9 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @result, i32 0, i32 %i.131, i32 0
...
if.then:                                          ; preds = %for.inc11.8, %for.inc11.7, %for.inc11.6, %for.inc11.5, %for.inc11.4, %for.inc11.3, %for.inc11.2, %for.inc11.1, %for.inc11, %for.cond4.preheader
  %i.131.lcssa = phi i32 [ %i.131, %for.inc11.8 ], [ %i.131, %for.inc11.7 ], [ %i.131, %for.inc11.6 ], [ %i.131, %for.inc11.5 ], [ %i.131, %for.inc11.4 ], [ %i.131, %for.inc11.3 ], [ %i.131, %for.inc11.2 ], [ %i.131, %for.inc11.1 ], [ %i.131, %for.inc11 ], [ %i.131, %for.cond4.preheader ]
  %j.030.lcssa = phi i32 [ 0, %for.cond4.preheader ], [ 1, %for.inc11 ], [ 2, %for.inc11.1 ], [ 3, %for.inc11.2 ], [ 4, %for.inc11.3 ], [ 5, %for.inc11.4 ], [ 6, %for.inc11.5 ], [ 7, %for.inc11.6 ], [ 8, %for.inc11.7 ], [ 9, %for.inc11.8 ]
  %mul = mul nsw i32 %i.131.lcssa, 100
  %add = add nsw i32 %j.030.lcssa, %mul
  br label %return

for.inc11:                                        ; preds = %for.cond4.preheader
  %arrayidx7.1 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @c, i32 0, i32 %i.131, i32 1
  %2 = load i32, i32* %arrayidx7.1, align 4, !tbaa !1
  %arrayidx9.1 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @result, i32 0, i32 %i.131, i32 1
  %3 = load i32, i32* %arrayidx9.1, align 4, !tbaa !1
  %cmp10.1 = icmp eq i32 %2, %3
  br i1 %cmp10.1, label %for.inc11.1, label %if.then

for.end16:                                        ; preds = %for.inc11.9
  %call17 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0)) #1
  br label %return

return:                                           ; preds = %for.end16, %if.then
  %retval.0 = phi i32 [ %add, %if.then ], [ -1, %for.end16 ]
  ret i32 %retval.0

for.inc11.1:                                      ; preds = %for.inc11
  %arrayidx7.2 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @c, i32 0, i32 %i.131, i32 2
  %4 = load i32, i32* %arrayidx7.2, align 4, !tbaa !1
  %arrayidx9.2 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @result, i32 0, i32 %i.131, i32 2
...
for.inc11.2:                                      ; preds = %for.inc11.1
  %arrayidx7.3 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @c, i32 0, i32 %i.131, i32 3
  %6 = load i32, i32* %arrayidx7.3, align 4, !tbaa !1
  %arrayidx9.3 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @result, i32 0, i32 %i.131, i32 3
...
for.inc11.3:                                      ; preds = %for.inc11.2
  %arrayidx7.4 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @c, i32 0, i32 %i.131, i32 4
  %8 = load i32, i32* %arrayidx7.4, align 4, !tbaa !1
  %arrayidx9.4 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @result, i32 0, i32 %i.131, i32 4
...
for.inc11.4:                                      ; preds = %for.inc11.3
  %arrayidx7.5 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @c, i32 0, i32 %i.131, i32 5
  %10 = load i32, i32* %arrayidx7.5, align 4, !tbaa !1
  %arrayidx9.5 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @result, i32 0, i32 %i.131, i32 5
...
for.inc11.5:                                      ; preds = %for.inc11.4
  %arrayidx7.6 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @c, i32 0, i32 %i.131, i32 6
  %12 = load i32, i32* %arrayidx7.6, align 4, !tbaa !1
  %arrayidx9.6 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @result, i32 0, i32 %i.131, i32 6
...
for.inc11.6:                                      ; preds = %for.inc11.5
  %arrayidx7.7 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @c, i32 0, i32 %i.131, i32 7
  %14 = load i32, i32* %arrayidx7.7, align 4, !tbaa !1
  %arrayidx9.7 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @result, i32 0, i32 %i.131, i32 7
...
for.inc11.7:                                      ; preds = %for.inc11.6
  %arrayidx7.8 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @c, i32 0, i32 %i.131, i32 8
  %16 = load i32, i32* %arrayidx7.8, align 4, !tbaa !1
  %arrayidx9.8 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @result, i32 0, i32 %i.131, i32 8
...
for.inc11.8:                                      ; preds = %for.inc11.7
  %arrayidx7.9 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @c, i32 0, i32 %i.131, i32 9
  %18 = load i32, i32* %arrayidx7.9, align 4, !tbaa !1
  %arrayidx9.9 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @result, i32 0, i32 %i.131, i32 9
...
for.inc11.9:                                      ; preds = %for.inc11.8
  %inc15 = add nuw nsw i32 %i.131, 1
  %cmp2 = icmp slt i32 %inc15, 10
  br i1 %cmp2, label %for.cond4.preheader, label %for.end16
}
