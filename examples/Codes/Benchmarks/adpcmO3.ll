...
@pcmdata_2_ref = global [10 x i16] [i16 0, i16 0, i16 11, i16 17, i16 16, i16 23, i16 24, i16 25, i16 33, i16 32], align 4
...
for.body:                                         ; preds = %adpcm_decoder.exit, %entry
  %i.038 = phi i32 [ 0, %entry ], [ %inc, %adpcm_decoder.exit ]
  ...
  tail call void @adpcm_coder(i16* getelementptr inbounds ([10 x i16], [10 x i16]* @pcmdata, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @adpcmdata, i32 0, i32 0), i32 signext 10, %struct.adpcm_state* @coder_state)
...
adpcm_decoder.exit:                               ; preds = %if.end.i
  %conv50.i.lcssa = phi i16 [ %conv50.i, %if.end.i ]
  %..add40.i.lcssa = phi i32 [ %..add40.i, %if.end.i ]
  store i16 %conv50.i.lcssa, i16* getelementptr inbounds (%struct.adpcm_state, %struct.adpcm_state* @decoder_state, i32 0, i32 0), align 2, !tbaa !6
  %conv54.i = trunc i32 %..add40.i.lcssa to i8
...
for.end:                                          ; preds = %adpcm_decoder.exit
  %conv54.i.lcssa = phi i8 [ %conv54.i, %adpcm_decoder.exit ]
  %conv50.i.lcssa.lcssa = phi i16 [ %conv50.i.lcssa, %adpcm_decoder.exit ]
...
if.end:                                           ; preds = %for.end
  %cmp7 = icmp eq i16 %conv50.i.lcssa.lcssa, 32
  %cmp11 = icmp eq i8 %conv54.i.lcssa, 1
  %or.cond35 = and i1 %cmp7, %cmp11
  br i1 %or.cond35, label %for.cond15.preheader, label %return

for.cond15.preheader:                             ; preds = %if.end
  %10 = load i16, i16* getelementptr inbounds ([10 x i16], [10 x i16]* @pcmdata_2, i32 0, i32 0), align 2, !tbaa !10
  %11 = load i16, i16* getelementptr inbounds ([10 x i16], [10 x i16]* @pcmdata_2_ref, i32 0, i32 0), align 4, !tbaa !10
  %cmp22 = icmp eq i16 %10, %11
  br i1 %cmp22, label %for.inc26, label %return

for.inc26:                                        ; preds = %for.cond15.preheader
  %12 = load i16, i16* getelementptr inbounds ([10 x i16], [10 x i16]* @pcmdata_2, i32 0, i32 1), align 2, !tbaa !10
  %13 = load i16, i16* getelementptr inbounds ([10 x i16], [10 x i16]* @pcmdata_2_ref, i32 0, i32 1), align 2, !tbaa !10
  %cmp22.1 = icmp eq i16 %12, %13
  br i1 %cmp22.1, label %for.inc26.1, label %return

return:                                           ; preds = %for.cond15.preheader, %for.inc26, %for.inc26.1, %for.inc26.2, %for.inc26.3, %for.inc26.4, %for.inc26.5, %for.inc26.6, %for.inc26.7, %if.end, %for.end
  %retval.0 = phi i32 [ -3, %for.end ], [ -2, %if.end ], [ 0, %for.cond15.preheader ], [ 101, %for.inc26 ], [ 202, %for.inc26.1 ], [ 303, %for.inc26.2 ], [ 404, %for.inc26.3 ], [ 505, %for.inc26.4 ], [ 606, %for.inc26.5 ], [ 707, %for.inc26.6 ], [ 808, %for.inc26.7 ]
  ret i32 %retval.0

for.inc26.1:                                      ; preds = %for.inc26
  %14 = load i16, i16* getelementptr inbounds ([10 x i16], [10 x i16]* @pcmdata_2, i32 0, i32 2), align 2, !tbaa !10
  %15 = load i16, i16* getelementptr inbounds ([10 x i16], [10 x i16]* @pcmdata_2_ref, i32 0, i32 2), align 4, !tbaa !10
  %cmp22.2 = icmp eq i16 %14, %15
  br i1 %cmp22.2, label %for.inc26.2, label %return

for.inc26.2:                                      ; preds = %for.inc26.1
  %16 = load i16, i16* getelementptr inbounds ([10 x i16], [10 x i16]* @pcmdata_2, i32 0, i32 3), align 2, !tbaa !10
  %17 = load i16, i16* getelementptr inbounds ([10 x i16], [10 x i16]* @pcmdata_2_ref, i32 0, i32 3), align 2, !tbaa !10
  %cmp22.3 = icmp eq i16 %16, %17
  br i1 %cmp22.3, label %for.inc26.3, label %return

for.inc26.3:                                      ; preds = %for.inc26.2
  %18 = load i16, i16* getelementptr inbounds ([10 x i16], [10 x i16]* @pcmdata_2, i32 0, i32 4), align 2, !tbaa !10
  %19 = load i16, i16* getelementptr inbounds ([10 x i16], [10 x i16]* @pcmdata_2_ref, i32 0, i32 4), align 4, !tbaa !10
  %cmp22.4 = icmp eq i16 %18, %19
  br i1 %cmp22.4, label %for.inc26.4, label %return

for.inc26.4:                                      ; preds = %for.inc26.3
  %20 = load i16, i16* getelementptr inbounds ([10 x i16], [10 x i16]* @pcmdata_2, i32 0, i32 5), align 2, !tbaa !10
  %21 = load i16, i16* getelementptr inbounds ([10 x i16], [10 x i16]* @pcmdata_2_ref, i32 0, i32 5), align 2, !tbaa !10
  %cmp22.5 = icmp eq i16 %20, %21
  br i1 %cmp22.5, label %for.inc26.5, label %return

for.inc26.5:                                      ; preds = %for.inc26.4
  %22 = load i16, i16* getelementptr inbounds ([10 x i16], [10 x i16]* @pcmdata_2, i32 0, i32 6), align 2, !tbaa !10
  %23 = load i16, i16* getelementptr inbounds ([10 x i16], [10 x i16]* @pcmdata_2_ref, i32 0, i32 6), align 4, !tbaa !10
  %cmp22.6 = icmp eq i16 %22, %23
  br i1 %cmp22.6, label %for.inc26.6, label %return

for.inc26.6:                                      ; preds = %for.inc26.5
  %24 = load i16, i16* getelementptr inbounds ([10 x i16], [10 x i16]* @pcmdata_2, i32 0, i32 7), align 2, !tbaa !10
  %25 = load i16, i16* getelementptr inbounds ([10 x i16], [10 x i16]* @pcmdata_2_ref, i32 0, i32 7), align 2, !tbaa !10
  %cmp22.7 = icmp eq i16 %24, %25
  br i1 %cmp22.7, label %for.inc26.7, label %return

for.inc26.7:                                      ; preds = %for.inc26.6
  %26 = load i16, i16* getelementptr inbounds ([10 x i16], [10 x i16]* @pcmdata_2, i32 0, i32 8), align 2, !tbaa !10
  %27 = load i16, i16* getelementptr inbounds ([10 x i16], [10 x i16]* @pcmdata_2_ref, i32 0, i32 8), align 4, !tbaa !10
  %cmp22.8 = icmp eq i16 %26, %27
  br i1 %cmp22.8, label %for.inc26.8, label %return

for.inc26.8:                                      ; preds = %for.inc26.7
  %28 = load i16, i16* getelementptr inbounds ([10 x i16], [10 x i16]* @pcmdata_2, i32 0, i32 9), align 2, !tbaa !10
  %29 = load i16, i16* getelementptr inbounds ([10 x i16], [10 x i16]* @pcmdata_2_ref, i32 0, i32 9), align 2, !tbaa !10
  %cmp22.9 = icmp eq i16 %28, %29
  %. = select i1 %cmp22.9, i32 -1, i32 909
  ret i32 %.
}

; Function Attrs: nounwind
define void @adpcm_coder(i16* nocapture readonly %indata, i8* nocapture %outdata, i32 signext %len, %struct.adpcm_state* nocapture %state) #0 {
entry:
...
if.then63:                                        ; preds = %for.end
  ...
  store i8 %conv64, i8* %outp.1.lcssa, align 1, !tbaa !9
  br label %if.end66
