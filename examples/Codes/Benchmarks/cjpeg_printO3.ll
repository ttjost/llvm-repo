...
for.cond5.preheader:                              ; preds = %for.cond5.preheader.preheader, %for.cond5.7
  %j.029 = phi i32 [ %inc14, %for.cond5.7 ], [ 0, %for.cond5.preheader.preheader ]
  %arrayidx8 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data, i32 0, i32 %j.029, i32 0
  %1 = load i32, i32* %arrayidx8, align 4, !tbaa !1
  %arrayidx10 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data_ref, i32 0, i32 %j.029, i32 0
...
for.cond5:                                        ; preds = %for.cond5.preheader
  %arrayidx8.1 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data, i32 0, i32 %j.029, i32 1
  %3 = load i32, i32* %arrayidx8.1, align 4, !tbaa !1
  %arrayidx10.1 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data_ref, i32 0, i32 %j.029, i32 1
  %4 = load i32, i32* %arrayidx10.1, align 4, !tbaa !1
  %cmp11.1 = icmp eq i32 %3, %4
  br i1 %cmp11.1, label %for.cond5.1, label %if.then12

if.then12:                                        ; preds = %for.cond5.6, %for.cond5.5, %for.cond5.4, %for.cond5.3, %for.cond5.2, %for.cond5.1, %for.cond5, %for.cond5.preheader
  %puts27 = tail call i32 @puts(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @str2, i32 0, i32 0))
  br label %return

for.inc17.loopexit:                               ; preds = %for.cond5.7
  br label %for.inc17
...
for.cond5.1:                                      ; preds = %for.cond5
  %arrayidx8.2 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data, i32 0, i32 %j.029, i32 2
  %5 = load i32, i32* %arrayidx8.2, align 4, !tbaa !1
  %arrayidx10.2 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data_ref, i32 0, i32 %j.029, i32 2
  %6 = load i32, i32* %arrayidx10.2, align 4, !tbaa !1
  %cmp11.2 = icmp eq i32 %5, %6
  br i1 %cmp11.2, label %for.cond5.2, label %if.then12

for.cond5.2:                                      ; preds = %for.cond5.1
  %arrayidx8.3 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data, i32 0, i32 %j.029, i32 3
  %7 = load i32, i32* %arrayidx8.3, align 4, !tbaa !1
  %arrayidx10.3 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data_ref, i32 0, i32 %j.029, i32 3
  %8 = load i32, i32* %arrayidx10.3, align 4, !tbaa !1
  %cmp11.3 = icmp eq i32 %7, %8
  br i1 %cmp11.3, label %for.cond5.3, label %if.then12

for.cond5.3:                                      ; preds = %for.cond5.2
  %arrayidx8.4 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data, i32 0, i32 %j.029, i32 4
  %9 = load i32, i32* %arrayidx8.4, align 4, !tbaa !1
  %arrayidx10.4 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data_ref, i32 0, i32 %j.029, i32 4
  %10 = load i32, i32* %arrayidx10.4, align 4, !tbaa !1
  %cmp11.4 = icmp eq i32 %9, %10
  br i1 %cmp11.4, label %for.cond5.4, label %if.then12

for.cond5.4:                                      ; preds = %for.cond5.3
  %arrayidx8.5 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data, i32 0, i32 %j.029, i32 5
  %11 = load i32, i32* %arrayidx8.5, align 4, !tbaa !1
  %arrayidx10.5 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data_ref, i32 0, i32 %j.029, i32 5
  %12 = load i32, i32* %arrayidx10.5, align 4, !tbaa !1
  %cmp11.5 = icmp eq i32 %11, %12
  br i1 %cmp11.5, label %for.cond5.5, label %if.then12

for.cond5.5:                                      ; preds = %for.cond5.4
  %arrayidx8.6 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data, i32 0, i32 %j.029, i32 6
  %13 = load i32, i32* %arrayidx8.6, align 4, !tbaa !1
  %arrayidx10.6 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data_ref, i32 0, i32 %j.029, i32 6
  %14 = load i32, i32* %arrayidx10.6, align 4, !tbaa !1
  %cmp11.6 = icmp eq i32 %13, %14
  br i1 %cmp11.6, label %for.cond5.6, label %if.then12

for.cond5.6:                                      ; preds = %for.cond5.5
  %arrayidx8.7 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data, i32 0, i32 %j.029, i32 7
  %15 = load i32, i32* %arrayidx8.7, align 4, !tbaa !1
  %arrayidx10.7 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @data_ref, i32 0, i32 %j.029, i32 7
  %16 = load i32, i32* %arrayidx10.7, align 4, !tbaa !1
  %cmp11.7 = icmp eq i32 %15, %16
  br i1 %cmp11.7, label %for.cond5.7, label %if.then12
