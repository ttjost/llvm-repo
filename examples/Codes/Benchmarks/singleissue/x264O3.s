...
LBB1_18::                               ## %x264_pixel_sad_x4_16x16.exit
	...
	c0	cmpeq $b0.0 = $r0.13, 1000
	c0	br $b0.0, LBB1_2
	c0	goto LBB1_1
LBB1_2::                                ## %for.cond1.preheader
	c0	mov $r0.58 = scores_temp
	c0	ldw $r0.59 = 0[$r0.58]
	c0	cmpeq $b0.0 = $r0.14, $r0.59
	c0	ldw $r0.59 = 4[$r0.58]
	c0	cmpeq $b0.1 = $r0.15, $r0.59
	c0	ldw $r0.59 = 8[$r0.58]
	c0	mfb $r0.60 = $b0.0
	c0	cmpeq $b0.0 = $r0.16, $r0.59
	c0	ldw $r0.58 = 12[$r0.58]
	c0	mfb $r0.59 = $b0.1
	c0	cmpeq $b0.1 = $r0.17, $r0.58
	c0	and $r0.58 = $r0.60, $r0.59
	c0	mfb $r0.59 = $b0.0
	c0	and $r0.58 = $r0.58, $r0.59
	c0	mfb $r0.59 = $b0.1
	c0	and $r0.58 = $r0.58, $r0.59
	c0	mtb $b0.0 = $r0.58
	c0	mfb $r0.3 = $b0.0
