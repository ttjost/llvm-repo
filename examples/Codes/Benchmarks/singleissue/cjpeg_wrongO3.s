...
LBB1_2::                                ## %for.cond5.preheader
	...
	c0	ldw $r0.22 = -16[$r0.16]
	c0	ldw $r0.23 = -16[$r0.18]
	c0	cmpeq $b0.0 = $r0.22, $r0.23
	c0	ldw $r0.22 = -12[$r0.18]
	c0	slct $r0.20 = $b0.0, $r0.20, 0
	c0	ldw $r0.23 = -12[$r0.16]
	c0	slct $r0.17 = $b0.0, $r0.17, 0
	c0	cmpeq $b0.0 = $r0.23, $r0.22
	c0	ldw $r0.22 = -8[$r0.18]
	c0	slct $r0.17 = $b0.0, $r0.17, $r0.21
	c0	ldw $r0.23 = -8[$r0.16]
	c0	slct $r0.20 = $b0.0, $r0.20, 0
	c0	cmpeq $b0.0 = $r0.23, $r0.22
	c0	ldw $r0.22 = -4[$r0.18]
	c0	slct $r0.17 = $b0.0, $r0.17, $r0.59
	c0	ldw $r0.23 = -4[$r0.16]
	c0	slct $r0.20 = $b0.0, $r0.20, 0
	c0	cmpeq $b0.0 = $r0.23, $r0.22
	c0	ldw $r0.22 = 0[$r0.18]
	c0	slct $r0.17 = $b0.0, $r0.17, $r0.60
	c0	ldw $r0.23 = 0[$r0.16]
	c0	slct $r0.20 = $b0.0, $r0.20, 0
	c0	cmpeq $b0.0 = $r0.23, $r0.22
	c0	ldw $r0.22 = 4[$r0.18]
	c0	slct $r0.17 = $b0.0, $r0.17, $r0.61
	c0	ldw $r0.23 = 4[$r0.16]
	c0	slct $r0.20 = $b0.0, $r0.20, 0
	c0	add $r0.59 = $r0.59, 2
	c0	cmpeq $b0.0 = $r0.23, $r0.22
	c0	ldw $r0.22 = 8[$r0.18]
	c0	slct $r0.17 = $b0.0, $r0.17, $r0.62
	c0	ldw $r0.23 = 8[$r0.16]
	c0	slct $r0.20 = $b0.0, $r0.20, 0
	c0	add $r0.61 = $r0.61, 4
	c0	cmpeq $b0.0 = $r0.23, $r0.22
	c0	ldw $r0.22 = 12[$r0.16]
	c0	slct $r0.17 = $b0.0, $r0.17, $r0.63
	c0	ldw $r0.23 = 12[$r0.18]
	c0	slct $r0.20 = $b0.0, $r0.20, 0
	c0	add $r0.60 = $r0.60, 3
	c0	cmpeq $b0.0 = $r0.22, $r0.23
	c0	slct $r0.17 = $b0.0, $r0.17, $r0.19
	c0	slct $r0.20 = $b0.0, $r0.20, 0
	c0	add $r0.18 = $r0.18, 32
	c0	add $r0.63 = $r0.63, 6
	c0	add $r0.16 = $r0.16, 32
	c0	add $r0.19 = $r0.19, 7
	c0	add $r0.62 = $r0.62, 5
	c0	add $r0.21 = $r0.21, 1
	c0	cmpne $b0.0 = $r0.21, 8
	c0	br $b0.0, LBB1_2
	c0	goto LBB1_3
LBB1_3::                                ## %for.inc17
