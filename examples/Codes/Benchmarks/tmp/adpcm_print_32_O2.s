...
;;
	...
	c0	mov $r0.63 = 10
	c0	mov $r0.57 = adpcmdata
;;
	c0	mov $r0.62 = pcmdata_2
;;
LBB0_1::                                ## %for.body
                                        ## =>This Inner Loop Header: Depth=1
	c0	stb 2[$r0.59] = $r0.61
;;
	c0	sth 0[$r0.59] = $r0.61
;;
	c0	stb 2[$r0.58] = $r0.61
;;
	c0	sth 0[$r0.58] = $r0.61
;;
	c0	ldw $r0.3 = 28[$r0.1]
	c0	mov $r0.4 = $r0.57
	c0	mov $r0.5 = $r0.63
...
;;
	c0	ldhu $r0.12 = 0[$r0.11]
;;
	c0	ldhu $r0.13 = 0[$r0.62]
;;
...
;;
## BB#9:                                ## %for.cond16
	c0	ldhu $r0.12 = 2[$r0.11]
;;
	c0	ldhu $r0.13 = 2[$r0.62]
;;
	c0	cmpeq $b0.0 = $r0.13, $r0.12
;;
	c0	brf $b0.0, LBB0_10
;;
## BB#12:                               ## %for.cond16.1
	c0	ldhu $r0.12 = 4[$r0.11]
;;
	c0	ldhu $r0.13 = 4[$r0.62]
;;
...
;;
## BB#13:                               ## %for.cond16.2
	c0	ldhu $r0.12 = 6[$r0.11]
;;
	c0	ldhu $r0.13 = 6[$r0.62]
;;
	c0	cmpne $b0.0 = $r0.13, $r0.12
;;
	c0	br $b0.0, LBB0_10
;;
## BB#14:                               ## %for.cond16.3
	c0	ldhu $r0.12 = 8[$r0.11]
;;
	c0	ldhu $r0.13 = 8[$r0.62]
;;
	c0	cmpne $b0.0 = $r0.13, $r0.12
;;
	c0	br $b0.0, LBB0_10
;;
## BB#15:                               ## %for.cond16.4
	c0	ldhu $r0.12 = 10[$r0.11]
;;
	c0	ldhu $r0.13 = 10[$r0.62]
;;
	c0	cmpne $b0.0 = $r0.13, $r0.12
;;
	c0	br $b0.0, LBB0_10
;;
## BB#16:                               ## %for.cond16.5
	c0	ldhu $r0.12 = 12[$r0.11]
;;
	c0	ldhu $r0.13 = 12[$r0.62]
;;
	c0	cmpne $b0.0 = $r0.13, $r0.12
;;
	c0	br $b0.0, LBB0_10
;;
## BB#17:                               ## %for.cond16.6
	c0	ldhu $r0.12 = 14[$r0.11]
;;
	c0	ldhu $r0.13 = 14[$r0.62]
;;
	c0	cmpne $b0.0 = $r0.13, $r0.12
;;
	c0	br $b0.0, LBB0_10
;;
## BB#18:                               ## %for.cond16.7
	c0	ldhu $r0.12 = 16[$r0.11]
;;
	c0	ldhu $r0.13 = 16[$r0.62]
;;
	c0	cmpne $b0.0 = $r0.13, $r0.12
;;
	c0	br $b0.0, LBB0_10
...
;;
	c0	slct $r0.35 = $b0.0, $r0.18, $r0.27
	c0	slct $r0.31 = $b0.0, $r0.18, 4
;;
...
;;
	c0	cmpge $b0.0 = $r0.32, $r0.27
	c0	or $r0.30 = $r0.31, $r0.30
;;
	c0	mfb $r0.31 = $b0.0
	c0	cmplt $b0.0 = $r0.32, $r0.27
;;
	c0	or $r0.30 = $r0.30, $r0.31
	c0	slct $r0.27 = $b0.0, $r0.18, $r0.27
;;
	c0	sh2add $r0.31 = $r0.30, $r0.20
	c0	add $r0.27 = $r0.27, $r0.29
;;
	c0	sub $r0.29 = $r0.18, $r0.27
	c0	ldw $r0.31 = 0[$r0.31]
;;
	c0	add $r0.11 = $r0.31, $r0.11
	c0	cmpgt $b0.0 = $r0.28, -1
;;
	c0	slct $r0.27 = $b0.0, $r0.27, $r0.29
	c0	max $r0.11 = $r0.11, 0
;;
	c0	add $r0.14 = $r0.27, $r0.14
	c0	min $r0.11 = $r0.11, 88
;;
	c0	sh2add $r0.27 = $r0.11, $r0.12
...
LBB2_4::                                ## %if.end
	...
	c0	shr $r0.33 = $r0.27, $r0.18
	c0	shr $r0.34 = $r0.27, $r0.19
;;
	c0	shr $r0.31 = $r0.31, $r0.20
	c0	shr $r0.32 = $r0.32, $r0.20
	c0	shl $r0.35 = $r0.29, $r0.20
	c0	shr $r0.36 = $r0.27, $r0.21
;;
	c0	and $r0.27 = $r0.31, $r0.27
	c0	shr $r0.31 = $r0.35, $r0.20
	c0	and $r0.32 = $r0.32, $r0.33
	c0	and $r0.33 = $r0.29, 15
;;
	c0	add $r0.27 = $r0.27, $r0.34
	c0	and $r0.31 = $r0.31, $r0.36
...
;;
	...
	c0	ldw $r0.31 = 0[$r0.33]
	c0	cmpeq $b0.0 = $r0.29, 0
;;
	c0	sub $r0.29 = $r0.15, $r0.27
	c0	add $r0.11 = $r0.31, $r0.11
;;
	c0	slct $r0.27 = $b0.0, $r0.27, $r0.29
	c0	max $r0.11 = $r0.11, 0
