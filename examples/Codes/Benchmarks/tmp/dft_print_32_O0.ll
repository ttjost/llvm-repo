...
define i32 @cast_uint32(%struct.int_64_t* byval %x) #0 {
entry:
...
; Function Attrs: nounwind
define i32 @cast_int32(%struct.int_64_t* byval %x) #0 {
entry:
  %result = alloca i32, align 4
  store i32 0, i32* %result, align 4
  %high = getelementptr inbounds %struct.int_64_t, %struct.int_64_t* %x, i32 0, i32 0
  %0 = load i32, i32* %high, align 4
...
; Function Attrs: nounwind
define void @add(%struct.int_64_t* noalias sret %agg.result, %struct.int_64_t* byval %x, %struct.int_64_t* byval %y) #0 {
entry:
...
; Function Attrs: nounwind
define void @neg(%struct.int_64_t* noalias sret %agg.result, %struct.int_64_t* byval %x) #0 {
entry:
...
; Function Attrs: nounwind
define void @sll(%struct.int_64_t* noalias sret %agg.result, %struct.int_64_t* byval %value, i8 zeroext %pos) #0 {
entry:
...
; Function Attrs: nounwind
define void @sra(%struct.int_64_t* noalias sret %agg.result, %struct.int_64_t* byval %value, i8 zeroext %pos) #0 {
entry:
  %pos.addr = alloca i8, align 1
  %temp = alloca i32, align 4
  store i8 %pos, i8* %pos.addr, align 1
...
if.else:                                          ; preds = %entry
  ...
  %9 = load i32, i32* %high9, align 4
  %10 = load i8, i8* %pos.addr, align 1
  %conv10 = zext i8 %10 to i32
  %sub11 = sub nsw i32 %conv10, 32
  %shr12 = ashr i32 %9, %sub11
  %low13 = getelementptr inbounds %struct.int_64_t, %struct.int_64_t* %value, i32 0, i32 1
...
entry:
  ...
  call void @ucast(%struct.int_64_t* sret %tmp, i32 %12)
  ...
  call void @ucast(%struct.int_64_t* sret %agg.tmp6, i32 %15)
  call void @sll(%struct.int_64_t* sret %agg.tmp, %struct.int_64_t* byval %agg.tmp6, i8 zeroext 16)
  call void @add(%struct.int_64_t* sret %tmp7, %struct.int_64_t* byval %res, %struct.int_64_t* byval %agg.tmp)
  %16 = bitcast %struct.int_64_t* %res to i8*
  %17 = bitcast %struct.int_64_t* %tmp7 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %16, i8* %17, i32 8, i32 4, i1 false)
  %18 = load i32, i32* %p_hl, align 4
  call void @ucast(%struct.int_64_t* sret %agg.tmp9, i32 %18)
  call void @sll(%struct.int_64_t* sret %agg.tmp8, %struct.int_64_t* byval %agg.tmp9, i8 zeroext 16)
  call void @add(%struct.int_64_t* sret %tmp10, %struct.int_64_t* byval %res, %struct.int_64_t* byval %agg.tmp8)
  %19 = bitcast %struct.int_64_t* %res to i8*
  %20 = bitcast %struct.int_64_t* %tmp10 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %19, i8* %20, i32 8, i32 4, i1 false)
  %21 = load i32, i32* %p_hh, align 4
  call void @ucast(%struct.int_64_t* sret %agg.tmp12, i32 %21)
  call void @sll(%struct.int_64_t* sret %agg.tmp11, %struct.int_64_t* byval %agg.tmp12, i8 zeroext 32)
  call void @add(%struct.int_64_t* sret %tmp13, %struct.int_64_t* byval %res, %struct.int_64_t* byval %agg.tmp11)
  %22 = bitcast %struct.int_64_t* %res to i8*
  %23 = bitcast %struct.int_64_t* %tmp13 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %22, i8* %23, i32 8, i32 4, i1 false)
  %24 = bitcast %struct.int_64_t* %agg.result to i8*
  %25 = bitcast %struct.int_64_t* %res to i8*
...
if.then:                                          ; preds = %entry
  call void @neg(%struct.int_64_t* sret %tmp4, %struct.int_64_t* byval %product)
  %9 = bitcast %struct.int_64_t* %product to i8*
  %10 = bitcast %struct.int_64_t* %tmp4 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %9, i8* %10, i32 8, i32 4, i1 false)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %11 = bitcast %struct.int_64_t* %agg.result to i8*
  %12 = bitcast %struct.int_64_t* %product to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* %11, i8* %12, i32 8, i32 4, i1 false)
  ret void
}
...
for.body3:                                        ; preds = %for.cond1
  ...
  %7 = load i32, i32* %fp_cospart, align 4
  %add6 = add nsw i32 %7, %call
  store i32 %add6, i32* %fp_cospart, align 4
  %8 = load i32, i32* %i, align 4
  %arrayidx9 = getelementptr inbounds [24 x i32], [24 x i32]* @rowsums, i32 0, i32 %8
  %9 = load i32, i32* %arrayidx9, align 4
  %shl10 = shl i32 %9, 17
  %10 = load i32, i32* %i, align 4
  %11 = load i32, i32* %w, align 4
  %mul11 = mul nsw i32 %11, 24
  ...
  call void @mult(%struct.int_64_t* sret %agg.tmp8, i32 %shl10, i32 %12)
  ...
  %13 = load i32, i32* %fp_sinpart, align 4
  %add15 = add nsw i32 %13, %call14
...
for.end:                                          ; preds = %for.cond1
  %15 = load i32, i32* %fp_cospart, align 4
  %shr = ashr i32 %15, 12
  %16 = load i32, i32* %fp_cospart, align 4
  %shr18 = ashr i32 %16, 12
  call void @mult(%struct.int_64_t* sret %agg.tmp17, i32 %shr, i32 %shr18)
  ...
  %17 = load i32, i32* %fp_sinpart, align 4
  %shr22 = ashr i32 %17, 12
  %18 = load i32, i32* %fp_sinpart, align 4
  %shr23 = ashr i32 %18, 12
  call void @mult(%struct.int_64_t* sret %agg.tmp21, i32 %shr22, i32 %shr23)
  ...
  %20 = load [24 x i32]*, [24 x i32]** %powers.addr, align 4
  %arrayidx26 = getelementptr inbounds [24 x i32], [24 x i32]* %20, i32 %19
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx = getelementptr inbounds [4 x [24 x i32]], [4 x [24 x i32]]* @powers, i32 0, i32 %3
  %arrayidx4 = getelementptr inbounds [24 x i32], [24 x i32]* %arrayidx, i32 0, i32 0
  %4 = load i32, i32* %arrayidx4, align 4
  %5 = load i32, i32* %i, align 4
  %arrayidx5 = getelementptr inbounds [4 x [24 x i32]], [4 x [24 x i32]]* @powers_temp, i32 0, i32 %5
...
for.end10:                                        ; preds = %for.cond1
  %call11 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str1, i32 0, i32 0))
...
attributes #3 = { "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "stack-protector-buffer-size"="8" "target-features"="+soft-float" "unsafe-fp-math"="false" "use-soft-float"="true" }
