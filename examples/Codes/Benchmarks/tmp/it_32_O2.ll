...
for.body:                                         ; preds = %for.body.preheader, %for.body
  %indvars.iv1272 = phi i32 [ %indvars.iv.next1273, %for.body ], [ 0, %for.body.preheader ]
...
for.body170:                                      ; preds = %for.body170.preheader, %for.body170
  %indvars.iv1275 = phi i32 [ %indvars.iv.next1276, %for.body170 ], [ 0, %for.body170.preheader ]
...
if.end:                                           ; preds = %if.end.loopexit1241, %if.end.loopexit
  ...
  br i1 %cmp2861252, label %if.end.for.end392_crit_edge, label %for.body288.lr.ph
...
for.body409:                                      ; preds = %for.body409, %for.body409.lr.ph
  ...
  %cond429 = select i1 %cmp410, i32* %arraydecay397.pre-phi, i32* %ffti_buf.21250
...
for.body751:                                      ; preds = %for.body751.preheader, %for.body751
  ...
  br i1 %exitcond1270, label %for.body838.preheader.loopexit1280, label %for.body751

for.body838.preheader.loopexit:                   ; preds = %for.body586
  br label %for.body838.preheader

for.body838.preheader.loopexit1280:               ; preds = %for.body751
  br label %for.body838.preheader

for.body838.preheader:                            ; preds = %for.body838.preheader.loopexit1280, %for.body838.preheader.loopexit
  br label %for.body838

for.body838:                                      ; preds = %for.body838.preheader, %for.body838
  %indvars.iv = phi i32 [ %indvars.iv.next, %for.body838 ], [ 0, %for.body838.preheader ]
  %arrayidx840 = getelementptr inbounds [256 x i32], [256 x i32]* %wr_buf1, i32 0, i32 %indvars.iv
  %39 = load i32, i32* %arrayidx840, align 4, !tbaa !1
  %arrayidx842 = getelementptr inbounds i32, i32* %tcbuf, i32 %indvars.iv
  store i32 %39, i32* %arrayidx842, align 4, !tbaa !1
  %arrayidx844 = getelementptr inbounds [256 x i32], [256 x i32]* %wi_buf1, i32 0, i32 %indvars.iv
  %40 = load i32, i32* %arrayidx844, align 4, !tbaa !1
  %add846 = add nuw nsw i32 %indvars.iv, 128
  %arrayidx847 = getelementptr inbounds i32, i32* %tcbuf, i32 %add846
  store i32 %40, i32* %arrayidx847, align 4, !tbaa !1
