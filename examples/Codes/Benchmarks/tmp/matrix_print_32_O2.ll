...
for.cond4.preheader:                              ; preds = %for.cond4.preheader.preheader, %for.cond4.9
  %i.129 = phi i32 [ %inc16, %for.cond4.9 ], [ 0, %for.cond4.preheader.preheader ]
  %arrayidx7 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @c, i32 0, i32 %i.129, i32 0
  %0 = load i32, i32* %arrayidx7, align 4, !tbaa !1
  %arrayidx9 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @result, i32 0, i32 %i.129, i32 0
...
for.cond4:                                        ; preds = %for.cond4.preheader
  %arrayidx7.1 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @c, i32 0, i32 %i.129, i32 1
  %2 = load i32, i32* %arrayidx7.1, align 4, !tbaa !1
  %arrayidx9.1 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @result, i32 0, i32 %i.129, i32 1
...
for.cond4.1:                                      ; preds = %for.cond4
  %arrayidx7.2 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @c, i32 0, i32 %i.129, i32 2
  %4 = load i32, i32* %arrayidx7.2, align 4, !tbaa !1
  %arrayidx9.2 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @result, i32 0, i32 %i.129, i32 2
...
for.cond4.2:                                      ; preds = %for.cond4.1
  %arrayidx7.3 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @c, i32 0, i32 %i.129, i32 3
  %6 = load i32, i32* %arrayidx7.3, align 4, !tbaa !1
  %arrayidx9.3 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @result, i32 0, i32 %i.129, i32 3
...
for.cond4.3:                                      ; preds = %for.cond4.2
  %arrayidx7.4 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @c, i32 0, i32 %i.129, i32 4
  %8 = load i32, i32* %arrayidx7.4, align 4, !tbaa !1
  %arrayidx9.4 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @result, i32 0, i32 %i.129, i32 4
...
for.cond4.4:                                      ; preds = %for.cond4.3
  %arrayidx7.5 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @c, i32 0, i32 %i.129, i32 5
  %10 = load i32, i32* %arrayidx7.5, align 4, !tbaa !1
  %arrayidx9.5 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @result, i32 0, i32 %i.129, i32 5
...
for.cond4.5:                                      ; preds = %for.cond4.4
  %arrayidx7.6 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @c, i32 0, i32 %i.129, i32 6
  %12 = load i32, i32* %arrayidx7.6, align 4, !tbaa !1
  %arrayidx9.6 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @result, i32 0, i32 %i.129, i32 6
...
for.cond4.6:                                      ; preds = %for.cond4.5
  %arrayidx7.7 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @c, i32 0, i32 %i.129, i32 7
  %14 = load i32, i32* %arrayidx7.7, align 4, !tbaa !1
  %arrayidx9.7 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @result, i32 0, i32 %i.129, i32 7
...
for.cond4.7:                                      ; preds = %for.cond4.6
  %arrayidx7.8 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @c, i32 0, i32 %i.129, i32 8
  %16 = load i32, i32* %arrayidx7.8, align 4, !tbaa !1
  %arrayidx9.8 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @result, i32 0, i32 %i.129, i32 8
...
for.cond4.8:                                      ; preds = %for.cond4.7
  %arrayidx7.9 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @c, i32 0, i32 %i.129, i32 9
  %18 = load i32, i32* %arrayidx7.9, align 4, !tbaa !1
  %arrayidx9.9 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @result, i32 0, i32 %i.129, i32 9
