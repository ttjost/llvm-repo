...
for.cond16.preheader:                             ; preds = %if.end
  ...
  %11 = load i16, i16* getelementptr inbounds ([10 x i16], [10 x i16]* @pcmdata_2_ref, i32 0, i32 0), align 2, !tbaa !10
...
for.cond16.1:                                     ; preds = %for.cond16
  ...
  %15 = load i16, i16* getelementptr inbounds ([10 x i16], [10 x i16]* @pcmdata_2_ref, i32 0, i32 2), align 2, !tbaa !10
...
for.cond16.3:                                     ; preds = %for.cond16.2
  ...
  %19 = load i16, i16* getelementptr inbounds ([10 x i16], [10 x i16]* @pcmdata_2_ref, i32 0, i32 4), align 2, !tbaa !10
...
for.cond16.5:                                     ; preds = %for.cond16.4
  ...
  %23 = load i16, i16* getelementptr inbounds ([10 x i16], [10 x i16]* @pcmdata_2_ref, i32 0, i32 6), align 2, !tbaa !10
...
for.cond16.7:                                     ; preds = %for.cond16.6
  ...
  %27 = load i16, i16* getelementptr inbounds ([10 x i16], [10 x i16]* @pcmdata_2_ref, i32 0, i32 8), align 2, !tbaa !10
