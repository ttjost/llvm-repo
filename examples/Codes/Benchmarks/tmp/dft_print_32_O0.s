...
;;
	...
	c0	add $r0.58 = $r0.1, 88
	c0	mov $r0.59 = 16
;;
	c0	ldhu $r0.11 = 158[$r0.1]
	c0	add $r0.60 = $r0.1, 96
	c0	add $r0.12 = $r0.1, 80
;;
...
;;
	c0	ldw $r0.11 = 144[$r0.1]
;;
	c0	ldw $r0.12 = 136[$r0.1]
;;
	c0	mpyhs $r0.13 = $r0.11, $r0.12
...
;;
	c0	stw 168[$r0.1] = $r0.57
;;
	c0	stw 164[$r0.1] = $r0.58
;;
	c0	stw 160[$r0.1] = $r0.59
;;
	c0	stw 156[$r0.1] = $r0.60
;;
	c0	stw 152[$r0.1] = $r0.61
;;
	c0	stw 148[$r0.1] = $r0.62
;;
	c0	stw 144[$r0.1] = $r0.63
;;
...
## BB#4:                                ## %for.inc
	...
	c0	ldw $r0.11 = 132[$r0.1]
;;
	c0	mpylu $r0.12 = $r0.11, 24
	c0	mpyhs $r0.11 = $r0.11, 24
	c0	ldw $r0.13 = 136[$r0.1]
;;
	c0	add $r0.11 = $r0.12, $r0.11
	c0	sh2add $r0.12 = $r0.13, $r0.59
;;
...
;;
LBB11_6::                               ## %for.end30
	c0	ldw $r0.63 = 144[$r0.1]
;;
	c0	ldw $r0.62 = 148[$r0.1]
;;
	c0	ldw $r0.61 = 152[$r0.1]
;;
	c0	ldw $r0.60 = 156[$r0.1]
;;
	c0	ldw $r0.59 = 160[$r0.1]
;;
	c0	ldw $r0.58 = 164[$r0.1]
;;
	c0	ldw $r0.57 = 168[$r0.1]
;;
