...
;;
	...
	c0	mov $r0.57 = 0
	c0	mov $r0.15 = in_data
;;
	c0	mov $r0.11 = 18
	c0	mov $r0.12 = output
	c0	add $r0.13 = $r0.15, 68
;;
	c0	mov $r0.14 = fir_int
	c0	add $r0.15 = $r0.15, 2796
;;
	c0	mov $r0.16 = -1
	c0	mov $r0.17 = $r0.57
;;
...
LBB0_2::                                ## %for.body.i
                                        ...
                                        ##       Child Loop BB0_4 Depth 3
	c0	ldw $r0.24 = 0[$r0.18]
	c0	add $r0.23 = $r0.18, 4
;;
	c0	ldw $r0.25 = 0[$r0.21]
;;
	c0	mpyhs $r0.26 = $r0.25, $r0.24
	c0	mpylu $r0.24 = $r0.25, $r0.24
;;
...
## BB#3:                                ## %for.body7.i.preheader
	...
	c0	add $r0.25 = $r0.20, -1
	c0	add $r0.26 = $r0.21, -4
	c0	mov $r0.27 = $r0.23
;;
LBB0_4::                                ## %for.body7.i
                                        ##   Parent Loop BB0_1 Depth=1
...
LBB0_5::                                ## %for.end.i
                                        ##   in Loop: Header=BB0_2 Depth=2
	c0	cmplt $b0.0 = $r0.20, 35
;;
	c0	mfb $r0.25 = $b0.0
	c0	add $r0.26 = $r0.21, 4
	c0	cmpeq $b0.0 = $r0.21, $r0.15
;;
	c0	slct $r0.25 = $b0.0, $r0.16, $r0.25
	c0	slct $r0.21 = $b0.0, $r0.15, $r0.26
;;
	c0	add $r0.20 = $r0.25, $r0.20
	c0	slct $r0.18 = $b0.0, $r0.23, $r0.18
	c0	add $r0.23 = $r0.19, 4
	c0	add $r0.22 = $r0.22, 1
;;
	c0	stw 0[$r0.19] = $r0.24
	c0	cmpne $b0.0 = $r0.22, 700
	c0	mov $r0.19 = $r0.23
;;
	c0	br $b0.0, LBB0_2
;;
...
;;
## BB#1:                                ## %for.body.lr.ph
	c0	sh2add $r0.12 = $r0.5, $r0.3
	c0	add $r0.11 = $r0.7, 1
	c0	mov $r0.13 = 1
;;
	c0	shr $r0.11 = $r0.11, $r0.13
	c0	add $r0.12 = $r0.12, -4
;;
	c0	sh2add $r0.14 = $r0.11, $r0.3
	c0	mov $r0.13 = 0
;;
...
LBB1_2::                                ## %for.body
	...
	c0	ldw $r0.19 = 0[$r0.17]
	c0	add $r0.18 = $r0.17, 4
;;
...
;;
	...
	c0	cmplt $b0.0 = $r0.11, 2
;;
	c0	br $b0.0, LBB1_5
;;
## BB#3:                                ## %for.body7.preheader
                                        ##   in Loop: Header=BB1_2 Depth=1
	c0	add $r0.20 = $r0.11, -1
	c0	add $r0.21 = $r0.14, -4
	c0	mov $r0.22 = $r0.18
;;
LBB1_4::                                ## %for.body7
                                        ##   Parent Loop BB1_2 Depth=1
                                        ## =>  This Inner Loop Header: Depth=2
	c0	ldw $r0.23 = 0[$r0.21]
;;
	c0	ldw $r0.24 = 0[$r0.22]
;;
	c0	mpylu $r0.25 = $r0.23, $r0.24
	c0	mpyhs $r0.23 = $r0.23, $r0.24
	c0	add $r0.22 = $r0.22, 4
...
LBB1_5::                                ## %for.end
                                        ##   in Loop: Header=BB1_2 Depth=1
	c0	cmplt $b0.0 = $r0.11, $r0.7
	c0	cmpeq $b0.1 = $r0.14, $r0.12
;;
	c0	mfb $r0.20 = $b0.0
	c0	add $r0.21 = $r0.14, 4
;;
	c0	slct $r0.20 = $b0.1, $r0.15, $r0.20
	c0	slct $r0.14 = $b0.1, $r0.14, $r0.21
;;
	c0	add $r0.11 = $r0.11, $r0.20
	c0	slct $r0.17 = $b0.1, $r0.18, $r0.17
	c0	add $r0.18 = $r0.16, 4
	c0	add $r0.13 = $r0.13, 1
;;
	c0	cmpne $b0.0 = $r0.13, $r0.5
