...
;;
	...
	c0	zxth $r0.61 = $r0.5
;;
	c0	mpylu $r0.11 = $r0.61, $r0.60
	c0	mpyhs $r0.12 = $r0.61, $r0.60
	c0	shru $r0.62 = $r0.5, $r0.59
	c0	add $r0.63 = $r0.1, 104
;;
...
.call ucast, caller, arg($r0.3:u32, $r0.4:u32, $r0.5:u32, $r0.6:u32, $r0.7:u32, $r0.8:u32, $r0.9:u32, $r0.10:u32), ret()
	c0	call $l0.0 = ucast
;;
	c0	mpylu $r0.11 = $r0.62, $r0.60
	c0	mpyhs $r0.12 = $r0.62, $r0.60
;;
	c0	add $r0.4 = $r0.11, $r0.12
...
.call add, caller, arg($r0.3:u32, $r0.4:u32, $r0.5:u32, $r0.6:u32, $r0.7:u32, $r0.8:u32, $r0.9:u32, $r0.10:u32), ret()
	c0	call $l0.0 = add
;;
	c0	mpyhs $r0.11 = $r0.62, $r0.57
	c0	mpylu $r0.12 = $r0.62, $r0.57
	c0	ldw $r0.13 = 60[$r0.1]
;;
	c0	ldw $r0.14 = 56[$r0.1]
;;
	c0	stw 108[$r0.1] = $r0.13
