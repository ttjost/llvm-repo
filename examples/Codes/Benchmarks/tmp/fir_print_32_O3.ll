...
for.body7.i.preheader:                            ; preds = %for.body.i
  ...
  br i1 %backedge.overflow, label %for.body7.i.preheader44, label %overflow.checked
...
middle.block:                                     ; preds = %middle.block.loopexit, %overflow.checked
  ...
  %resume.val15 = phi i32* [ %incdec.ptr.i, %overflow.checked ], [ %ptr.ind.end17, %middle.block.loopexit ]
  %resume.val18 = phi i32 [ 1, %overflow.checked ], [ %end.idx.rnd.down40, %middle.block.loopexit ]
  ...
  br i1 %cmp.n, label %for.end.i, label %for.body7.i.preheader44

for.body7.i.preheader44:                          ; preds = %middle.block, %for.body7.i.preheader
  %in_ptr.046.pn.i.ph = phi i32* [ %in_ptr.046.i, %for.body7.i.preheader ], [ %resume.val, %middle.block ]
  %coef_ptr.041.i.ph = phi i32* [ %incdec.ptr.i, %for.body7.i.preheader ], [ %resume.val15, %middle.block ]
  %acc.040.i.ph = phi i32 [ %mul.i, %for.body7.i.preheader ], [ %12, %middle.block ]
  %j.039.i.ph = phi i32 [ 1, %for.body7.i.preheader ], [ %resume.val18, %middle.block ]
  br label %for.body7.i

for.body7.i:                                      ; preds = %for.body7.i.preheader44, %for.body7.i
  %in_ptr.046.pn.i = phi i32* [ %data_ptr.042.i, %for.body7.i ], [ %in_ptr.046.pn.i.ph, %for.body7.i.preheader44 ]
  %coef_ptr.041.i = phi i32* [ %incdec.ptr8.i, %for.body7.i ], [ %coef_ptr.041.i.ph, %for.body7.i.preheader44 ]
  %acc.040.i = phi i32 [ %add11.i, %for.body7.i ], [ %acc.040.i.ph, %for.body7.i.preheader44 ]
  %j.039.i = phi i32 [ %inc.i, %for.body7.i ], [ %j.039.i.ph, %for.body7.i.preheader44 ]
