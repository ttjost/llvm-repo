// Number of 64-element blocks. Must be at least 1.
#define NUM_BLKS 200
// Block size, number of elements in each block. Must be at least 1 and multiple of 16.
#define BLK_SZ 16
// The Q-point, controls rounding and final truncation. Must be in the range from 0 <= q_pt <= 31.
#define Q_PT 16

short           data[NUM_BLKS * BLK_SZ] = {
...
const short     recip_tbl[BLK_SZ] = {
    -10893, -25384, 3695, -1646, -13060, -18192, -3611, -31267, -9771, 2152,
    -6798, -18414, 23482, 7038, 1204, -20764
};
...
(
    short           *data,      /* Data to be quantized.         */
    short           *output,      /* Data to be quantized.         */
    unsigned short  num_blks,            /* Number of 64-element blocks.  */
...
int main() {
	...
	short           output[NUM_BLKS * BLK_SZ];      /* Data to be quantized.         */
    unsigned short  num_blks = NUM_BLKS;            /* Number of 64-element blocks.  */
    unsigned short  blk_size = BLK_SZ;            /* Block size (multiple of 16).  */

    int             q_pt = Q_PT;                 /* Q-point of Quant values.      */
...
(
    ...
    output,
    num_blks,            /* Number of 64-element blocks.  */
