...
for.cond15:                                       ; preds = %for.inc19, %for.end14
  ...
  %cmp16 = icmp slt i32 %23, 64
  br i1 %cmp16, label %for.body17, label %for.end21

for.body17:                                       ; preds = %for.cond15
  %24 = load i32, i32* %i, align 4
  %25 = load i32*, i32** %ar.addr, align 4
  %arrayidx18 = getelementptr inbounds i32, i32* %25, i32 %24
  %26 = load i32, i32* %arrayidx18, align 4
  %call = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), i32 %26)
  br label %for.inc19
