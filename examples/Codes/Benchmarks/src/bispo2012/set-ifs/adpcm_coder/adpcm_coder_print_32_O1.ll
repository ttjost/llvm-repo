...
for.body:                                         ; preds = %if.end57, %entry
  ...
  %sub8 = select i1 %cmp5, i32 0, i32 %step.0106
  %diff.1 = sub nsw i32 %sub4.sub, %sub8
...
for.end:                                          ; preds = %if.end57
  br i1 %tobool50, label %if.then61, label %if.end64

if.then61:                                        ; preds = %for.end
  %conv62 = trunc i32 %outputbuffer.1 to i8
  %arrayidx63 = getelementptr inbounds i8, i8* %outdata, i32 %i.1
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %arrayidx = getelementptr inbounds [513 x i8], [513 x i8]* %outdata, i32 0, i32 %i.03
