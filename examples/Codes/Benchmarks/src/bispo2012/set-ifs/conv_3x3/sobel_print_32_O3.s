...
## BB#6:                                ## %vector.memcheck
	c0	add $r0.17 = $r0.6, -1
;;
	c0	mpyhs $r0.19 = $r0.17, $r0.5
	c0	mpylu $r0.17 = $r0.17, $r0.5
;;
...
LBB0_12::                               ## %vector.body
	...
	c0	add $r0.16 = $r0.20, $r0.5
	c0	add $r0.21 = $r0.20, $r0.17
	c0	add $r0.22 = $r0.3, $r0.20
;;
...
;;
	...
	c0	add $r0.26 = $r0.20, 4
;;
;;
	c0	shl $r0.27 = $r0.25, $r0.11
	c0	ldbu $r0.28 = 5[$r0.22]
;;
	c0	ldbu $r0.29 = 0[$r0.22]
;;
	c0	ldbu $r0.30 = 2[$r0.16]
	c0	cmpne $b0.0 = $r0.18, $r0.26
;;
;;
	c0	shl $r0.31 = $r0.30, $r0.11
	c0	ldbu $r0.32 = 4[$r0.22]
	c0	add $r0.20 = $r0.15, $r0.20
;;
	c0	ldbu $r0.33 = 4[$r0.16]
;;
...
;;
	c0	ldbu $r0.36 = 2[$r0.22]
	c0	sh1add $r0.37 = $r0.35, $r0.29
;;
;;
	c0	sub $r0.29 = $r0.36, $r0.29
	c0	sub $r0.38 = $r0.32, $r0.36
	c0	sh1add $r0.39 = $r0.36, $r0.35
	c0	add $r0.37 = $r0.37, $r0.36
;;
	c0	sub $r0.31 = $r0.38, $r0.31
	c0	sub $r0.24 = $r0.29, $r0.24
	c0	ldbu $r0.22 = 3[$r0.22]
	c0	sub $r0.29 = $r0.34, $r0.37
;;
	c0	sub $r0.37 = $r0.28, $r0.22
	c0	sh1add $r0.38 = $r0.32, $r0.22
	c0	sub $r0.35 = $r0.22, $r0.35
	c0	sh1add $r0.36 = $r0.22, $r0.36
;;
	c0	sub $r0.27 = $r0.37, $r0.27
	c0	add $r0.32 = $r0.36, $r0.32
	c0	sub $r0.23 = $r0.35, $r0.23
	c0	add $r0.22 = $r0.39, $r0.22
;;
	c0	add $r0.28 = $r0.38, $r0.28
	c0	sh1add $r0.23 = $r0.25, $r0.23
	c0	sh1add $r0.25 = $r0.33, $r0.31
	c0	sh1add $r0.16 = $r0.16, $r0.27
;;
	c0	sh1add $r0.24 = $r0.30, $r0.24
	c0	ldbu $r0.27 = 1[$r0.21]
;;
	c0	sub $r0.24 = $r0.24, $r0.34
	c0	sub $r0.22 = $r0.27, $r0.22
	c0	sh1add $r0.29 = $r0.27, $r0.29
...
;;
	c0	ldbu $r0.21 = 3[$r0.21]
	c0	sub $r0.32 = $r0.31, $r0.32
	c0	sub $r0.25 = $r0.25, $r0.31
	c0	sh1add $r0.22 = $r0.31, $r0.22
;;
	c0	sub $r0.28 = $r0.21, $r0.28
	c0	sh1add $r0.32 = $r0.21, $r0.32
	c0	sub $r0.16 = $r0.16, $r0.21
	c0	add $r0.22 = $r0.22, $r0.21
;;
	c0	sh1add $r0.28 = $r0.27, $r0.28
	c0	add $r0.16 = $r0.16, $r0.30
...
;;
	...
	c0	add $r0.23 = $r0.32, $r0.27
;;
	c0	shr $r0.27 = $r0.25, $r0.19
	c0	shr $r0.30 = $r0.23, $r0.19
	c0	shr $r0.31 = $r0.16, $r0.19
	c0	shr $r0.32 = $r0.29, $r0.19
;;
	c0	shr $r0.33 = $r0.28, $r0.19
	c0	shr $r0.34 = $r0.24, $r0.19
	c0	shr $r0.35 = $r0.22, $r0.19
	c0	shr $r0.36 = $r0.21, $r0.19
;;
	c0	add $r0.25 = $r0.25, $r0.27
	c0	add $r0.21 = $r0.21, $r0.36
...
;;
	...
	c0	add $r0.22 = $r0.22, $r0.35
;;
	c0	xor $r0.25 = $r0.25, $r0.27
	c0	xor $r0.22 = $r0.22, $r0.35
	c0	xor $r0.23 = $r0.23, $r0.30
	c0	xor $r0.21 = $r0.21, $r0.36
;;
	c0	xor $r0.27 = $r0.28, $r0.33
	c0	xor $r0.24 = $r0.24, $r0.34
	c0	xor $r0.16 = $r0.16, $r0.31
...
;;
	c0	min $r0.22 = $r0.23, 255
	c0	min $r0.16 = $r0.16, 255
	c0	min $r0.21 = $r0.21, 255
	c0	min $r0.23 = $r0.24, 255
;;
	c0	stb 3[$r0.20] = $r0.16
;;
	c0	stb 2[$r0.20] = $r0.22
;;
	c0	stb 1[$r0.20] = $r0.21
;;
	c0	stb 0[$r0.20] = $r0.23
	c0	mov $r0.20 = $r0.26
	c0	mov $r0.16 = $r0.14
	c0	br $b0.0, LBB0_12
;;
...
LBB0_14::                               ## %for.body.preheader
	c0	add $r0.13 = $r0.16, $r0.5
	c0	sh1add $r0.14 = $r0.5, $r0.16
...
;;
	...
	c0	cmpne $b0.0 = $r0.16, $r0.12
;;
	c0	shr $r0.22 = $r0.21, $r0.17
	c0	shr $r0.23 = $r0.20, $r0.17
;;
	c0	add $r0.21 = $r0.21, $r0.22
...
;;
	...
	c0	add $r0.21 = $r0.16, $r0.15
	c0	add $r0.15 = $r0.15, 1
	c0	add $r0.19 = $r0.19, 1
;;
	c0	cmpgt $b0.1 = $r0.20, 255
;;
;;
	c0	slct $r0.20 = $b0.1, $r0.18, $r0.20
;;
...
;;
	c0	stw 1060[$r0.1] = $r0.59
;;
	c0	stw 1056[$r0.1] = $r0.60
;;
	c0	stw 1052[$r0.1] = $l0.0
...
;;
	c0	sh1add $r0.22 = $r0.23, $r0.22
	c0	sub $r0.18 = $r0.19, $r0.18
	c0	add $r0.23 = $r0.15, 1
;;
	c0	add $r0.18 = $r0.18, $r0.17
	c0	add $r0.19 = $r0.22, $r0.17
;;
	c0	shr $r0.22 = $r0.18, $r0.14
	c0	shr $r0.24 = $r0.19, $r0.14
;;
...
;;
	...
	c0	cmpne $b0.0 = $r0.23, 958
;;
	c0	cmpgt $b0.1 = $r0.18, 255
;;
;;
	c0	slct $r0.18 = $b0.1, $r0.57, $r0.18
;;
	c0	stb 0[$r0.15] = $r0.18
	c0	mov $r0.18 = $r0.21
	c0	mov $r0.19 = $r0.20
	c0	mov $r0.15 = $r0.23
;;
...
LBB1_6::                                ## %cleanup
	c0	mov $r0.3 = $r0.57
	c0	ldw $l0.0 = 1052[$r0.1]
;;
	c0	ldw $r0.60 = 1056[$r0.1]
;;
	c0	ldw $r0.59 = 1060[$r0.1]
;;
