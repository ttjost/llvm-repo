...
for.body.i:                                       ; preds = %for.body.i, %entry
  %1 = phi i8 [ 43, %entry ], [ %8, %for.body.i ]
  %2 = phi i8 [ -63, %entry ], [ %1, %for.body.i ]
  %3 = phi i8 [ 56, %entry ], [ %5, %for.body.i ]
  %4 = phi i8 [ 96, %entry ], [ %3, %for.body.i ]
  %i.085.i = phi i32 [ 0, %entry ], [ %add.i, %for.body.i ]
  %conv5.i = zext i8 %4 to i32
  %add.i = add nuw nsw i32 %i.085.i, 1
  %conv7.i = zext i8 %3 to i32
  %add8.i = add nuw nsw i32 %i.085.i, 2
  %arrayidx9.i = getelementptr inbounds [1024 x i8], [1024 x i8]* @in, i32 0, i32 %add8.i
  %5 = load i8, i8* %arrayidx9.i, align 1, !tbaa !1
  %conv10.i = zext i8 %5 to i32
  %add11.i = add nuw nsw i32 %i.085.i, 32
  %arrayidx12.i = getelementptr inbounds [1024 x i8], [1024 x i8]* @in, i32 0, i32 %add11.i
  %6 = load i8, i8* %arrayidx12.i, align 1, !tbaa !1
  %conv13.i = zext i8 %6 to i32
  %add15.i = add nuw nsw i32 %i.085.i, 34
  %arrayidx16.i = getelementptr inbounds [1024 x i8], [1024 x i8]* @in, i32 0, i32 %add15.i
  %7 = load i8, i8* %arrayidx16.i, align 1, !tbaa !1
  %conv17.i = zext i8 %7 to i32
  %conv21.i = zext i8 %2 to i32
  %conv26.i = zext i8 %1 to i32
  %add29.i = add nuw nsw i32 %i.085.i, 66
  %arrayidx30.i = getelementptr inbounds [1024 x i8], [1024 x i8]* @in, i32 0, i32 %add29.i
  %8 = load i8, i8* %arrayidx30.i, align 1, !tbaa !1
  %conv31.i = zext i8 %8 to i32
  %mul33.i = shl nuw nsw i32 %conv7.i, 1
  %sum = add nuw nsw i32 %mul33.i, %conv5.i
  %sum26 = add nuw nsw i32 %sum, %conv10.i
  %add36.i = sub nsw i32 %conv21.i, %sum26
  %mul37.i = shl nuw nsw i32 %conv26.i, 1
  %add38.i = add nsw i32 %add36.i, %mul37.i
  %add39.i = add nsw i32 %add38.i, %conv31.i
  %add41.i = sub nsw i32 %conv10.i, %conv5.i
  %mul42.i = shl nuw nsw i32 %conv13.i, 1
  %sub43.i = sub nsw i32 %add41.i, %mul42.i
  %mul44.i = shl nuw nsw i32 %conv17.i, 1
  %add45.i = add nsw i32 %sub43.i, %mul44.i
  %sub46.i = sub nsw i32 %add45.i, %conv21.i
  %add47.i = add nsw i32 %sub46.i, %conv31.i
  %ispos.i = icmp sgt i32 %add39.i, -1
  %neg.i = sub i32 0, %add39.i
  %9 = select i1 %ispos.i, i32 %add39.i, i32 %neg.i
  %ispos82.i = icmp sgt i32 %add47.i, -1
  %neg83.i = sub nsw i32 0, %add47.i
  %10 = select i1 %ispos82.i, i32 %add47.i, i32 %neg83.i
  %add49.i = add nsw i32 %9, %10
  %cmp50.i = icmp sgt i32 %add49.i, 255
  %11 = trunc i32 %add49.i to i8
  %conv52.i = select i1 %cmp50.i, i8 -1, i8 %11
  %arrayidx54.i = getelementptr inbounds [1024 x i8], [1024 x i8]* %out, i32 0, i32 %add.i
  store i8 %conv52.i, i8* %arrayidx54.i, align 1, !tbaa !1
  %exitcond.i = icmp eq i32 %add.i, 958
