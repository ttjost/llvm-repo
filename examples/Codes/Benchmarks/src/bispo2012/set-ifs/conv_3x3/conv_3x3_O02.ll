...
entry:
  ...
  call void @IMG_conv_3x3_c(i8* getelementptr inbounds ([451 x i8], [451 x i8]* @inptr, i32 0, i32 0), i8* %arraydecay, i32 %0, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @mask, i32 0, i32 0), i32 %1)
  store i32 0, i32* %i, align 4
  br label %for.cond
