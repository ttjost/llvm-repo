...
entry:
  ...
  call void @IMG_conv_3x3_c(i8* getelementptr inbounds ([454 x i8], [454 x i8]* @inptr, i32 0, i32 0), i8* %arraydecay, i32 %0, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @mask, i32 0, i32 0), i32 %1)
  store i32 0, i32* %i, align 4
  br label %for.cond
