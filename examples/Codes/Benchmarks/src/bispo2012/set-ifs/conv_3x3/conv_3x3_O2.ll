...
for.cond2.preheader:                              ; preds = %for.cond2.preheader, %for.cond2.preheader.lr.ph
  %j.069 = phi i32 [ 0, %for.cond2.preheader.lr.ph ], [ %inc38, %for.cond2.preheader ]
  %IN1.068 = phi i8* [ %inptr, %for.cond2.preheader.lr.ph ], [ %arrayidx.1, %for.cond2.preheader ]
  %IN2.067 = phi i8* [ %add.ptr, %for.cond2.preheader.lr.ph ], [ %arrayidx5.1, %for.cond2.preheader ]
  %IN3.066 = phi i8* [ %add.ptr1, %for.cond2.preheader.lr.ph ], [ %arrayidx7.1, %for.cond2.preheader ]
  %OUT.065 = phi i8* [ %outptr, %for.cond2.preheader.lr.ph ], [ %incdec.ptr36, %for.cond2.preheader ]
  %0 = load i8, i8* %IN1.068, align 1, !tbaa !1
  %1 = load i8, i8* %IN2.067, align 1, !tbaa !1
  %2 = load i8, i8* %IN3.066, align 1, !tbaa !1
  ...
  %arrayidx.1 = getelementptr inbounds i8, i8* %IN1.068, i32 1
  %6 = load i8, i8* %arrayidx.1, align 1, !tbaa !1
  %arrayidx5.1 = getelementptr inbounds i8, i8* %IN2.067, i32 1
  %7 = load i8, i8* %arrayidx5.1, align 1, !tbaa !1
  %arrayidx7.1 = getelementptr inbounds i8, i8* %IN3.066, i32 1
  ...
  %arrayidx.2 = getelementptr inbounds i8, i8* %IN1.068, i32 2
  %12 = load i8, i8* %arrayidx.2, align 1, !tbaa !1
  %arrayidx5.2 = getelementptr inbounds i8, i8* %IN2.067, i32 2
  %13 = load i8, i8* %arrayidx5.2, align 1, !tbaa !1
  %arrayidx7.2 = getelementptr inbounds i8, i8* %IN3.066, i32 2
