...
LBB0_2::                                ## %for.body
	...
	c0	add $r0.18 = $r0.17, $r0.5
	c0	ldbu $r0.19 = 1[$r0.17]
;;
	c0	ldbu $r0.20 = 0[$r0.18]
	c0	add $r0.21 = $r0.17, $r0.12
;;
	c0	ldbu $r0.22 = 0[$r0.17]
	c0	shl $r0.20 = $r0.20, $r0.11
;;
;;
	c0	sh1add $r0.19 = $r0.19, $r0.22
	c0	ldbu $r0.23 = 2[$r0.17]
;;
	c0	ldbu $r0.18 = 2[$r0.18]
...
;;
	...
	c0	ldbu $r0.20 = 1[$r0.21]
;;
	c0	sub $r0.18 = $r0.18, $r0.22
	c0	sh1add $r0.19 = $r0.20, $r0.19
	c0	ldbu $r0.20 = 2[$r0.21]
;;
;;
...
;;
	c0	shr $r0.20 = $r0.18, $r0.15
	c0	shr $r0.21 = $r0.19, $r0.15
;;
	c0	add $r0.18 = $r0.18, $r0.20
	c0	add $r0.19 = $r0.19, $r0.21
;;
	c0	xor $r0.18 = $r0.18, $r0.20
	c0	xor $r0.19 = $r0.19, $r0.21
;;
...
LBB1_1::                                ## %for.body
	...
	c0	add $r0.60 = $r0.58, $r0.57
;;
	c0	ldbu $r0.59 = 0[$r0.12]
;;
	c0	ldbu $r0.12 = 0[$r0.60]
;;
;;
	c0	cmpeq $b0.0 = $r0.12, $r0.59
;;
;;
	c0	brf $b0.0, LBB1_2
;;
