...
entry:
  %cmp64 = icmp sgt i32 %x_dim, 0
  br i1 %cmp64, label %for.cond2.preheader.lr.ph, label %for.end39
...
for.cond2.preheader:                              ; preds = %for.end, %for.cond2.preheader.lr.ph
  %j.069 = phi i32 [ 0, %for.cond2.preheader.lr.ph ], [ %inc38, %for.end ]
  %IN1.068 = phi i8* [ %inptr, %for.cond2.preheader.lr.ph ], [ %incdec.ptr, %for.end ]
  %IN2.067 = phi i8* [ %add.ptr, %for.cond2.preheader.lr.ph ], [ %incdec.ptr27, %for.end ]
  %IN3.066 = phi i8* [ %add.ptr1, %for.cond2.preheader.lr.ph ], [ %incdec.ptr28, %for.end ]
  %OUT.065 = phi i8* [ %outptr, %for.cond2.preheader.lr.ph ], [ %incdec.ptr36, %for.end ]
  br label %for.body4

for.body4:                                        ; preds = %for.body4, %for.cond2.preheader
  %i.063 = phi i32 [ 0, %for.cond2.preheader ], [ %inc, %for.body4 ]
  %sum.062 = phi i32 [ 0, %for.cond2.preheader ], [ %add26, %for.body4 ]
  %arrayidx = getelementptr inbounds i8, i8* %IN1.068, i32 %i.063
  %0 = load i8, i8* %arrayidx, align 1, !tbaa !1
  %arrayidx5 = getelementptr inbounds i8, i8* %IN2.067, i32 %i.063
  %1 = load i8, i8* %arrayidx5, align 1, !tbaa !1
  %arrayidx7 = getelementptr inbounds i8, i8* %IN3.066, i32 %i.063
  %2 = load i8, i8* %arrayidx7, align 1, !tbaa !1
  %arrayidx9 = getelementptr inbounds i8, i8* %mask, i32 %i.063
  %3 = load i8, i8* %arrayidx9, align 1, !tbaa !1
  %add = add nuw nsw i32 %i.063, 3
  %arrayidx11 = getelementptr inbounds i8, i8* %mask, i32 %add
  %4 = load i8, i8* %arrayidx11, align 1, !tbaa !1
  %add13 = add nuw nsw i32 %i.063, 6
...
for.end:                                          ; preds = %for.body4
  %incdec.ptr = getelementptr inbounds i8, i8* %IN1.068, i32 1
  %incdec.ptr27 = getelementptr inbounds i8, i8* %IN2.067, i32 1
  %incdec.ptr28 = getelementptr inbounds i8, i8* %IN3.066, i32 1
  %shr = ashr i32 %add26, %shift
  %call = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32 %shr) #1
  ...
  %incdec.ptr36 = getelementptr inbounds i8, i8* %OUT.065, i32 1
  store i8 %conv35, i8* %OUT.065, align 1, !tbaa !1
  %inc38 = add nuw nsw i32 %j.069, 1
  %exitcond70 = icmp eq i32 %inc38, %x_dim
  br i1 %exitcond70, label %for.end39, label %for.cond2.preheader
