...
;;
	c0	add $r0.13 = $r0.14, $r0.13
;;
	c0	ldb $r0.13 = 6[$r0.13]
;;
	c0	sth 52[$r0.1] = $r0.13
;;
	c0	ldh $r0.13 = 60[$r0.1]
;;
	c0	ldh $r0.14 = 72[$r0.1]
;;
...
;;
	c0	ldh $r0.13 = 56[$r0.1]
;;
	c0	ldh $r0.14 = 68[$r0.1]
;;
	c0	mpyhs $r0.15 = $r0.14, $r0.13
	c0	mpylu $r0.13 = $r0.14, $r0.13
;;
...
;;
	c0	ldh $r0.13 = 52[$r0.1]
;;
	c0	ldh $r0.14 = 64[$r0.1]
;;
	c0	mpyhs $r0.15 = $r0.14, $r0.13
	c0	mpylu $r0.13 = $r0.14, $r0.13
;;
...
;;
	c0	stw 204[$r0.1] = $l0.0
;;
	c0	stw 200[$r0.1] = $r0.57
;;
	c0	stw 196[$r0.1] = $r0.58
	c0	mov $r0.58 = 0
	c0	mov $r0.11 = 150
;;
...
LBB1_3::                                ## %for.end
	c0	mov $r0.3 = 0
	c0	ldw $r0.58 = 196[$r0.1]
;;
	c0	ldw $r0.57 = 200[$r0.1]
;;
	c0	ldw $l0.0 = 204[$r0.1]
;;
.return ret($r0.3:s32)
