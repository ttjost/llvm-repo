...
entry:
  ...
  br i1 %cmp139, label %for.body.lr.ph, label %for.body79.preheader

for.body79.preheader.loopexit:                    ; preds = %for.cond60.preheader
  br label %for.body79.preheader

for.body79.preheader:                             ; preds = %for.body79.preheader.loopexit, %entry
  br label %for.body79
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  %arrayidx64.1 = getelementptr inbounds i16, i16* %old, i32 1
  %arrayidx66.1 = getelementptr inbounds i16, i16* %new_s, i32 1
  %arrayidx64.2 = getelementptr inbounds i16, i16* %old, i32 2
  %arrayidx66.2 = getelementptr inbounds i16, i16* %new_s, i32 2
  %arrayidx64.3 = getelementptr inbounds i16, i16* %old, i32 3
  %arrayidx66.3 = getelementptr inbounds i16, i16* %new_s, i32 3
  %arrayidx64.4 = getelementptr inbounds i16, i16* %old, i32 4
  %arrayidx66.4 = getelementptr inbounds i16, i16* %new_s, i32 4
  %arrayidx64.5 = getelementptr inbounds i16, i16* %old, i32 5
  %arrayidx66.5 = getelementptr inbounds i16, i16* %new_s, i32 5
  %arrayidx64.6 = getelementptr inbounds i16, i16* %old, i32 6
  %arrayidx66.6 = getelementptr inbounds i16, i16* %new_s, i32 6
  %arrayidx64.7 = getelementptr inbounds i16, i16* %old, i32 7
  %arrayidx66.7 = getelementptr inbounds i16, i16* %new_s, i32 7
  br label %for.body

for.body:                                         ; preds = %for.cond60.preheader, %for.body.lr.ph
  %i.0140 = phi i32 [ 0, %for.body.lr.ph ], [ %inc74, %for.cond60.preheader ]
...
for.cond60.preheader:                             ; preds = %for.body29
  %2 = load i16, i16* %old, align 2, !tbaa !1
  %3 = load i16, i16* %new_s, align 2, !tbaa !1
  store i16 %3, i16* %old, align 2, !tbaa !1
  store i16 %2, i16* %new_s, align 2, !tbaa !1
  %4 = load i16, i16* %arrayidx64.1, align 2, !tbaa !1
  %5 = load i16, i16* %arrayidx66.1, align 2, !tbaa !1
  store i16 %5, i16* %arrayidx64.1, align 2, !tbaa !1
  store i16 %4, i16* %arrayidx66.1, align 2, !tbaa !1
  %6 = load i16, i16* %arrayidx64.2, align 2, !tbaa !1
  %7 = load i16, i16* %arrayidx66.2, align 2, !tbaa !1
  store i16 %7, i16* %arrayidx64.2, align 2, !tbaa !1
  store i16 %6, i16* %arrayidx66.2, align 2, !tbaa !1
  %8 = load i16, i16* %arrayidx64.3, align 2, !tbaa !1
  %9 = load i16, i16* %arrayidx66.3, align 2, !tbaa !1
  store i16 %9, i16* %arrayidx64.3, align 2, !tbaa !1
  store i16 %8, i16* %arrayidx66.3, align 2, !tbaa !1
  %10 = load i16, i16* %arrayidx64.4, align 2, !tbaa !1
  %11 = load i16, i16* %arrayidx66.4, align 2, !tbaa !1
  store i16 %11, i16* %arrayidx64.4, align 2, !tbaa !1
  store i16 %10, i16* %arrayidx66.4, align 2, !tbaa !1
  %12 = load i16, i16* %arrayidx64.5, align 2, !tbaa !1
  %13 = load i16, i16* %arrayidx66.5, align 2, !tbaa !1
  store i16 %13, i16* %arrayidx64.5, align 2, !tbaa !1
  store i16 %12, i16* %arrayidx66.5, align 2, !tbaa !1
  %14 = load i16, i16* %arrayidx64.6, align 2, !tbaa !1
  %15 = load i16, i16* %arrayidx66.6, align 2, !tbaa !1
  store i16 %15, i16* %arrayidx64.6, align 2, !tbaa !1
  store i16 %14, i16* %arrayidx66.6, align 2, !tbaa !1
  %16 = load i16, i16* %arrayidx64.7, align 2, !tbaa !1
  %17 = load i16, i16* %arrayidx66.7, align 2, !tbaa !1
  store i16 %17, i16* %arrayidx64.7, align 2, !tbaa !1
  store i16 %16, i16* %arrayidx66.7, align 2, !tbaa !1
  %inc74 = add nuw nsw i32 %i.0140, 1
  %exitcond145 = icmp eq i32 %inc74, %n
  br i1 %exitcond145, label %for.body79.preheader.loopexit, label %for.body

for.body29:                                       ; preds = %for.body29.for.body29_crit_edge, %for.body
  %18 = phi i16 [ %conv12, %for.body ], [ %.pre, %for.body29.for.body29_crit_edge ]
  %j.0137 = phi i32 [ 0, %for.body ], [ %inc, %for.body29.for.body29_crit_edge ]
  ...
  %19 = load i16, i16* %arrayidx37, align 2, !tbaa !1
  %conv38 = sext i16 %19 to i32
  %add39 = add nsw i32 %conv38, %conv31
  %20 = load i16, i16* %arrayidx42, align 2, !tbaa !1
  %conv43 = sext i16 %20 to i32
  %sub44 = sub nsw i32 %conv43, %conv31
  %cmp45 = icmp sgt i32 %sub44, %add39
  %cond = select i1 %cmp45, i32 %sub44, i32 %add39
  %conv47 = trunc i32 %cond to i16
  %arrayidx49 = getelementptr inbounds i16, i16* %new_s, i32 %j.0137
  store i16 %conv47, i16* %arrayidx49, align 2, !tbaa !1
  %21 = load i16, i16* %arrayidx50, align 2, !tbaa !1
  %shl = shl i16 %21, 1
  %conv53 = zext i1 %cmp45 to i16
  %or = or i16 %conv53, %shl
  store i16 %or, i16* %arrayidx50, align 2, !tbaa !1
  %22 = load i16, i16* %arrayidx37, align 2, !tbaa !1
  %conv38.1 = sext i16 %22 to i32
  %add39.1 = sub nsw i32 %conv38.1, %conv31
  %23 = load i16, i16* %arrayidx42, align 2, !tbaa !1
  %conv43.1 = sext i16 %23 to i32
  %sub44.1 = add nsw i32 %conv43.1, %conv31
  %cmp45.1 = icmp sgt i32 %sub44.1, %add39.1
  %cond.1 = select i1 %cmp45.1, i32 %sub44.1, i32 %add39.1
  %conv47.1 = trunc i32 %cond.1 to i16
  %add48.1 = add nuw nsw i32 %j.0137, 8
  %arrayidx49.1 = getelementptr inbounds i16, i16* %new_s, i32 %add48.1
  store i16 %conv47.1, i16* %arrayidx49.1, align 2, !tbaa !1
  %24 = load i16, i16* %arrayidx50, align 2, !tbaa !1
  %shl.1 = shl i16 %24, 1
  %conv53.1 = zext i1 %cmp45.1 to i16
  %or.1 = or i16 %conv53.1, %shl.1
  store i16 %or.1, i16* %arrayidx50, align 2, !tbaa !1
  %inc = add nuw nsw i32 %j.0137, 1
  %exitcond141 = icmp eq i32 %inc, 8
  br i1 %exitcond141, label %for.cond60.preheader, label %for.body29.for.body29_crit_edge

for.body29.for.body29_crit_edge:                  ; preds = %for.body29
  %arrayidx30.phi.trans.insert = getelementptr inbounds i16, i16* %m, i32 %inc
  %.pre = load i16, i16* %arrayidx30.phi.trans.insert, align 2, !tbaa !1
  br label %for.body29

for.body79:                                       ; preds = %for.body79.preheader, %for.body79
  %c.0134 = phi i32 [ %inc83, %for.body79 ], [ 0, %for.body79.preheader ]
  %arrayidx80 = getelementptr inbounds i16, i16* %old, i32 %c.0134
  %25 = load i16, i16* %arrayidx80, align 2, !tbaa !1
