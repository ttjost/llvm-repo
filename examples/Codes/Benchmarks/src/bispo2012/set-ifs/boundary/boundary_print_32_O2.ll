...
entry:
  ...
  br i1 %cmp34, label %for.cond1.preheader.lr.ph, label %for.cond12.preheader
...
for.cond1.preheader:                              ; preds = %for.inc9, %for.cond1.preheader.lr.ph
  %i_data.addr.038 = phi i8* [ %i_data, %for.cond1.preheader.lr.ph ], [ %i_data.addr.1.lcssa, %for.inc9 ]
  %y.037 = phi i32 [ 0, %for.cond1.preheader.lr.ph ], [ %inc10, %for.inc9 ]
  %o_grey.addr.036 = phi i32* [ %o_grey, %for.cond1.preheader.lr.ph ], [ %o_grey.addr.1.lcssa, %for.inc9 ]
  %o_coord.addr.035 = phi i32* [ %o_coord, %for.cond1.preheader.lr.ph ], [ %o_coord.addr.1.lcssa, %for.inc9 ]
  br i1 %cmp227, label %for.body3.lr.ph, label %for.inc9

for.body3.lr.ph:                                  ; preds = %for.cond1.preheader
  %shl = shl i32 %y.037, 16
  br label %for.body3

for.cond12.preheader.loopexit:                    ; preds = %for.inc9
  %o_grey.addr.1.lcssa.lcssa = phi i32* [ %o_grey.addr.1.lcssa, %for.inc9 ]
  br label %for.cond12.preheader

for.cond12.preheader:                             ; preds = %for.cond12.preheader.loopexit, %entry
  %o_grey.addr.0.lcssa = phi i32* [ %o_grey, %entry ], [ %o_grey.addr.1.lcssa.lcssa, %for.cond12.preheader.loopexit ]
  br label %for.body15

for.body3:                                        ; preds = %for.inc, %for.body3.lr.ph
  %i_data.addr.131 = phi i8* [ %i_data.addr.038, %for.body3.lr.ph ], [ %incdec.ptr, %for.inc ]
  %x.030 = phi i32 [ 0, %for.body3.lr.ph ], [ %inc, %for.inc ]
  %o_grey.addr.129 = phi i32* [ %o_grey.addr.036, %for.body3.lr.ph ], [ %o_grey.addr.2, %for.inc ]
  %o_coord.addr.128 = phi i32* [ %o_coord.addr.035, %for.body3.lr.ph ], [ %o_coord.addr.2, %for.inc ]
  %incdec.ptr = getelementptr inbounds i8, i8* %i_data.addr.131, i32 1
  %0 = load i8, i8* %i_data.addr.131, align 1, !tbaa !1
  %cmp4 = icmp eq i8 %0, 0
  br i1 %cmp4, label %for.inc, label %if.then

if.then:                                          ; preds = %for.body3
  %conv = zext i8 %0 to i32
  %and6 = and i32 %x.030, 65535
  %or = or i32 %and6, %shl
  %incdec.ptr7 = getelementptr inbounds i32, i32* %o_coord.addr.128, i32 1
  store i32 %or, i32* %o_coord.addr.128, align 4, !tbaa !4
  %incdec.ptr8 = getelementptr inbounds i32, i32* %o_grey.addr.129, i32 1
  store i32 %conv, i32* %o_grey.addr.129, align 4, !tbaa !4
  br label %for.inc

for.inc:                                          ; preds = %for.body3, %if.then
  %o_coord.addr.2 = phi i32* [ %incdec.ptr7, %if.then ], [ %o_coord.addr.128, %for.body3 ]
  %o_grey.addr.2 = phi i32* [ %incdec.ptr8, %if.then ], [ %o_grey.addr.129, %for.body3 ]
  %inc = add nuw nsw i32 %x.030, 1
  %exitcond40 = icmp eq i32 %inc, %cols
  br i1 %exitcond40, label %for.cond1.for.inc9_crit_edge, label %for.body3

for.cond1.for.inc9_crit_edge:                     ; preds = %for.inc
  %o_grey.addr.2.lcssa = phi i32* [ %o_grey.addr.2, %for.inc ]
  %o_coord.addr.2.lcssa = phi i32* [ %o_coord.addr.2, %for.inc ]
  %scevgep = getelementptr i8, i8* %i_data.addr.038, i32 %cols
  br label %for.inc9

for.inc9:                                         ; preds = %for.cond1.for.inc9_crit_edge, %for.cond1.preheader
  %i_data.addr.1.lcssa = phi i8* [ %scevgep, %for.cond1.for.inc9_crit_edge ], [ %i_data.addr.038, %for.cond1.preheader ]
  %o_grey.addr.1.lcssa = phi i32* [ %o_grey.addr.2.lcssa, %for.cond1.for.inc9_crit_edge ], [ %o_grey.addr.036, %for.cond1.preheader ]
  %o_coord.addr.1.lcssa = phi i32* [ %o_coord.addr.2.lcssa, %for.cond1.for.inc9_crit_edge ], [ %o_coord.addr.035, %for.cond1.preheader ]
  %inc10 = add nuw nsw i32 %y.037, 1
  %exitcond41 = icmp eq i32 %inc10, %rows
  br i1 %exitcond41, label %for.cond12.preheader.loopexit, label %for.cond1.preheader
...
for.cond1.preheader.i:                            ; preds = %for.cond1.for.inc9_crit_edge.i, %entry
  %i_data.addr.038.i = phi i8* [ getelementptr inbounds ([10000 x i8], [10000 x i8]* @i_data, i32 0, i32 0), %entry ], [ %scevgep.i, %for.cond1.for.inc9_crit_edge.i ]
  %y.037.i = phi i32 [ 0, %entry ], [ %inc10.i, %for.cond1.for.inc9_crit_edge.i ]
  %o_grey.addr.036.i = phi i32* [ %arraydecay1, %entry ], [ %o_grey.addr.2.i.lcssa, %for.cond1.for.inc9_crit_edge.i ]
  %o_coord.addr.035.i = phi i32* [ %arraydecay, %entry ], [ %o_coord.addr.2.i.lcssa, %for.cond1.for.inc9_crit_edge.i ]
  %shl.i = shl i32 %y.037.i, 16
  br label %for.body3.i

for.body3.i:                                      ; preds = %for.inc.i, %for.cond1.preheader.i
  %i_data.addr.131.i = phi i8* [ %i_data.addr.038.i, %for.cond1.preheader.i ], [ %incdec.ptr.i, %for.inc.i ]
  %x.030.i = phi i32 [ 0, %for.cond1.preheader.i ], [ %inc.i, %for.inc.i ]
  %o_grey.addr.129.i = phi i32* [ %o_grey.addr.036.i, %for.cond1.preheader.i ], [ %o_grey.addr.2.i, %for.inc.i ]
  %o_coord.addr.128.i = phi i32* [ %o_coord.addr.035.i, %for.cond1.preheader.i ], [ %o_coord.addr.2.i, %for.inc.i ]
  %incdec.ptr.i = getelementptr inbounds i8, i8* %i_data.addr.131.i, i32 1
  %2 = load i8, i8* %i_data.addr.131.i, align 1, !tbaa !1
  %cmp4.i = icmp eq i8 %2, 0
  br i1 %cmp4.i, label %for.inc.i, label %if.then.i

if.then.i:                                        ; preds = %for.body3.i
  %conv.i = zext i8 %2 to i32
  %or.i = or i32 %x.030.i, %shl.i
  %incdec.ptr7.i = getelementptr inbounds i32, i32* %o_coord.addr.128.i, i32 1
  store i32 %or.i, i32* %o_coord.addr.128.i, align 4, !tbaa !4
  %incdec.ptr8.i = getelementptr inbounds i32, i32* %o_grey.addr.129.i, i32 1
  store i32 %conv.i, i32* %o_grey.addr.129.i, align 4, !tbaa !4
  br label %for.inc.i

for.inc.i:                                        ; preds = %if.then.i, %for.body3.i
  %o_coord.addr.2.i = phi i32* [ %incdec.ptr7.i, %if.then.i ], [ %o_coord.addr.128.i, %for.body3.i ]
  %o_grey.addr.2.i = phi i32* [ %incdec.ptr8.i, %if.then.i ], [ %o_grey.addr.129.i, %for.body3.i ]
  %inc.i = add nuw nsw i32 %x.030.i, 1
  %exitcond40.i = icmp eq i32 %inc.i, 100
  br i1 %exitcond40.i, label %for.cond1.for.inc9_crit_edge.i, label %for.body3.i

for.cond1.for.inc9_crit_edge.i:                   ; preds = %for.inc.i
  %o_grey.addr.2.i.lcssa = phi i32* [ %o_grey.addr.2.i, %for.inc.i ]
  %o_coord.addr.2.i.lcssa = phi i32* [ %o_coord.addr.2.i, %for.inc.i ]
  %scevgep.i = getelementptr i8, i8* %i_data.addr.038.i, i32 100
  %inc10.i = add nuw nsw i32 %y.037.i, 1
  %exitcond41.i = icmp eq i32 %inc10.i, 100
  br i1 %exitcond41.i, label %for.body15.i.preheader, label %for.cond1.preheader.i

for.body15.i.preheader:                           ; preds = %for.cond1.for.inc9_crit_edge.i
  %o_grey.addr.2.i.lcssa.lcssa = phi i32* [ %o_grey.addr.2.i.lcssa, %for.cond1.for.inc9_crit_edge.i ]
  br label %for.body15.i

for.body15.i:                                     ; preds = %for.body15.i.preheader, %for.body15.i
  %i.026.i = phi i32 [ %inc17.i, %for.body15.i ], [ 0, %for.body15.i.preheader ]
  %arrayidx.i = getelementptr inbounds i32, i32* %o_grey.addr.2.i.lcssa.lcssa, i32 %i.026.i
