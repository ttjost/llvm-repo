...
;;
	c0	sub $r0.20 = $r0.19, $r0.11
	c0	add $r0.21 = $r0.15, $r0.11
	c0	add $r0.19 = $r0.19, $r0.11
	c0	sub $r0.15 = $r0.15, $r0.11
;;
	c0	ldbu $r0.22 = 1[$r0.17]
;;
	c0	add $r0.23 = $r0.22, $r0.11
	c0	sub $r0.22 = $r0.22, $r0.11
	c0	ldbu $r0.24 = 3[$r0.17]
;;
	c0	sub $r0.25 = $r0.24, $r0.11
	c0	add $r0.24 = $r0.24, $r0.11
	c0	min $r0.23 = $r0.23, 255
;;
	c0	max $r0.25 = $r0.25, 0
	c0	max $r0.15 = $r0.15, 0
	c0	max $r0.22 = $r0.22, 0
;;
	c0	slct $r0.22 = $b0.0, $r0.23, $r0.22
	c0	min $r0.21 = $r0.21, 255
	c0	min $r0.19 = $r0.19, 255
	c0	min $r0.23 = $r0.24, 255
;;
	c0	slct $r0.15 = $b0.0, $r0.21, $r0.15
	c0	max $r0.20 = $r0.20, 0
;;
	c0	slct $r0.19 = $b0.0, $r0.19, $r0.20
	c0	slct $r0.20 = $b0.0, $r0.23, $r0.25
...
;;
	c0	stb 1[$r0.18] = $r0.22
;;
	c0	stb 0[$r0.18] = $r0.19
	c0	cmpne $b0.1 = $r0.16, 0
	c0	mov $r0.18 = $r0.21
	c0	mov $r0.15 = $r0.14
;;
	c0	br $b0.1, LBB0_6
...
;;
	c0	cmpgt $b0.1 = $r0.16, 255
;;
	c0	slct $r0.16 = $b0.1, $r0.15, $r0.16
	c0	goto LBB0_12
;;
LBB0_11::                               ## %if.else17
                                        ##   in Loop: Header=BB0_9 Depth=1
	c0	sub $r0.16 = $r0.16, $r0.11
;;
...
;;
	c0	sub $r0.21 = $r0.20, $r0.16
	c0	add $r0.22 = $r0.19, $r0.16
	c0	add $r0.20 = $r0.20, $r0.16
	c0	sub $r0.19 = $r0.19, $r0.16
;;
	c0	ldbu $r0.23 = 1[$r0.18]
;;
	c0	add $r0.24 = $r0.23, $r0.16
	c0	sub $r0.23 = $r0.23, $r0.16
	c0	ldbu $r0.18 = 0[$r0.18]
	c0	max $r0.21 = $r0.21, 0
;;
	c0	sub $r0.25 = $r0.18, $r0.16
	c0	add $r0.18 = $r0.18, $r0.16
	c0	min $r0.20 = $r0.20, 255
	c0	max $r0.19 = $r0.19, 0
;;
	c0	slct $r0.20 = $b0.0, $r0.20, $r0.21
	c0	min $r0.18 = $r0.18, 255
	c0	max $r0.21 = $r0.23, 0
	c0	max $r0.23 = $r0.25, 0
;;
	c0	slct $r0.18 = $b0.0, $r0.18, $r0.23
	c0	min $r0.23 = $r0.24, 255
	c0	min $r0.22 = $r0.22, 255
;;
	c0	slct $r0.21 = $b0.0, $r0.23, $r0.21
	c0	slct $r0.19 = $b0.0, $r0.22, $r0.19
	c0	add $r0.22 = $r0.57, $r0.17
	c0	add $r0.17 = $r0.17, 4
;;
	c0	stb 3[$r0.22] = $r0.19
;;
	c0	stb 2[$r0.22] = $r0.20
;;
	c0	stb 1[$r0.22] = $r0.21
;;
	c0	stb 0[$r0.22] = $r0.18
	c0	cmpne $b0.1 = $r0.17, 100
;;
	c0	br $b0.1, LBB1_2
;;
## BB#3:                                ## %change_brightness.exit
