...
while.end:                                        ; preds = %while.cond.while.end_crit_edge, %entry
  ...
  %h.0.lcssa = phi i32 [ %xor144, %while.cond.while.end_crit_edge ], [ %7, %entry ]
  %g.0.lcssa = phi i32 [ %xor140, %while.cond.while.end_crit_edge ], [ %6, %entry ]
  %f.0.lcssa = phi i32 [ %xor136, %while.cond.while.end_crit_edge ], [ %5, %entry ]
  %e.0.lcssa = phi i32 [ %xor132, %while.cond.while.end_crit_edge ], [ %4, %entry ]
  %d.0.lcssa = phi i32 [ %xor128, %while.cond.while.end_crit_edge ], [ %3, %entry ]
  %c.0.lcssa = phi i32 [ %add145, %while.cond.while.end_crit_edge ], [ %2, %entry ]
  %b.0.lcssa = phi i32 [ %add141, %while.cond.while.end_crit_edge ], [ %1, %entry ]
  %a.0.lcssa = phi i32 [ %add146, %while.cond.while.end_crit_edge ], [ %0, %entry ]
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %arrayidx = getelementptr inbounds [8 x i32], [8 x i32]* %estado, i32 0, i32 %i.03
  store i32 -1640531527, i32* %arrayidx, align 4, !tbaa !1
