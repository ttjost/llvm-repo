...
for.body:                                         ; preds = %entry, %for.body
  %largest.012 = phi i32 [ %cond, %for.body ], [ %1, %entry ]
  %i.011 = phi i32 [ %inc, %for.body ], [ 1, %entry ]
  %ap.cur2 = load i8*, i8** %vl, align 4
...
for.end:                                          ; preds = %for.body, %entry
  %largest.0.lcssa = phi i32 [ %1, %entry ], [ %cond, %for.body ]
...
entry:
  ...
  %call6 = tail call i32 (i32, ...)* @FindMax(i32 20, i32 702, i32 422, i32 631, i32 834, i32 892, i32 104, i32 772, i32 100, i32 101, i32 102, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12)
