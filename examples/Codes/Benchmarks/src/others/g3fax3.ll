...
vector.ph:                                        ; preds = %while.body.lr.ph
  ...
  br i1 %lcmp.mod, label %vector.body.prol.preheader, label %vector.ph.split
...
vector.body.prol:                                 ; preds = %vector.body.prol.preheader, %vector.body.prol
  ...
  %next.gep.prol = getelementptr i8, i8* %s, i32 %index.prol
  %5 = bitcast i8* %next.gep.prol to <16 x i8>*
  store <16 x i8> %broadcast.splat72, <16 x i8>* %5, align 1, !tbaa !2
  %next.gep.sum89.prol = or i32 %index.prol, 16
  %6 = getelementptr i8, i8* %s, i32 %next.gep.sum89.prol
  %7 = bitcast i8* %6 to <16 x i8>*
  store <16 x i8> %broadcast.splat72, <16 x i8>* %7, align 1, !tbaa !2
  %index.next.prol = add i32 %index.prol, 32
  %prol.iter.sub = sub i32 %prol.iter, 1
  %prol.iter.cmp = icmp ne i32 %prol.iter.sub, 0
  br i1 %prol.iter.cmp, label %vector.body.prol, label %vector.ph.split.loopexit, !llvm.loop !5
...
vector.ph.split:                                  ; preds = %vector.ph.split.loopexit, %vector.ph
  ...
  %8 = icmp ult i32 %3, 3
  br i1 %8, label %middle.block.loopexit, label %vector.ph.split.split

vector.ph.split.split:                            ; preds = %vector.ph.split
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph.split.split
  %index = phi i32 [ %index.unr, %vector.ph.split.split ], [ %index.next.3, %vector.body ]
  %next.gep = getelementptr i8, i8* %s, i32 %index
  %9 = bitcast i8* %next.gep to <16 x i8>*
  store <16 x i8> %broadcast.splat72, <16 x i8>* %9, align 1, !tbaa !2
  %next.gep.sum89 = or i32 %index, 16
  %10 = getelementptr i8, i8* %s, i32 %next.gep.sum89
  %11 = bitcast i8* %10 to <16 x i8>*
  store <16 x i8> %broadcast.splat72, <16 x i8>* %11, align 1, !tbaa !2
  %index.next = add i32 %index, 32
  %next.gep.1 = getelementptr i8, i8* %s, i32 %index.next
  %12 = bitcast i8* %next.gep.1 to <16 x i8>*
  store <16 x i8> %broadcast.splat72, <16 x i8>* %12, align 1, !tbaa !2
  %next.gep.sum89.1 = or i32 %index.next, 16
  %13 = getelementptr i8, i8* %s, i32 %next.gep.sum89.1
  %14 = bitcast i8* %13 to <16 x i8>*
  store <16 x i8> %broadcast.splat72, <16 x i8>* %14, align 1, !tbaa !2
  %index.next.1 = add i32 %index.next, 32
  %next.gep.2 = getelementptr i8, i8* %s, i32 %index.next.1
  %15 = bitcast i8* %next.gep.2 to <16 x i8>*
  store <16 x i8> %broadcast.splat72, <16 x i8>* %15, align 1, !tbaa !2
  %next.gep.sum89.2 = or i32 %index.next.1, 16
  %16 = getelementptr i8, i8* %s, i32 %next.gep.sum89.2
  %17 = bitcast i8* %16 to <16 x i8>*
  store <16 x i8> %broadcast.splat72, <16 x i8>* %17, align 1, !tbaa !2
  %index.next.2 = add i32 %index.next.1, 32
  %next.gep.3 = getelementptr i8, i8* %s, i32 %index.next.2
  %18 = bitcast i8* %next.gep.3 to <16 x i8>*
  store <16 x i8> %broadcast.splat72, <16 x i8>* %18, align 1, !tbaa !2
  %next.gep.sum89.3 = or i32 %index.next.2, 16
  %19 = getelementptr i8, i8* %s, i32 %next.gep.sum89.3
  %20 = bitcast i8* %19 to <16 x i8>*
  store <16 x i8> %broadcast.splat72, <16 x i8>* %20, align 1, !tbaa !2
  %index.next.3 = add i32 %index.next.2, 32
  %21 = icmp eq i32 %index.next.3, %n.vec
  br i1 %21, label %middle.block.loopexit.unr-lcssa, label %vector.body, !llvm.loop !7
...
while.body:                                       ; preds = %while.body.preheader, %while.body
  ...
  store i8 %conv, i8* %p.04, align 1, !tbaa !2
  %tobool = icmp eq i32 %dec, 0
  br i1 %tobool, label %while.end.loopexit, label %while.body, !llvm.loop !10
...
define i32 @getbit() #0 {
entry:
  %0 = load i32, i32* @bitsleft, align 4, !tbaa !12
  %dec = add nsw i32 %0, -1
  store i32 %dec, i32* @bitsleft, align 4, !tbaa !12
  %cmp = icmp slt i32 %0, 1
  br i1 %cmp, label %if.then, label %entry.if.end3_crit_edge

entry.if.end3_crit_edge:                          ; preds = %entry
  %.pre = load i32, i32* @lastbyte, align 4, !tbaa !12
  br label %if.end3

if.then:                                          ; preds = %entry
  %1 = load i8*, i8** @nextbyte, align 4, !tbaa !14
  %cmp1 = icmp ult i8* %1, getelementptr inbounds ([1792 x i8], [1792 x i8]* @fax, i32 1, i32 0)
  br i1 %cmp1, label %if.else, label %if.then2

if.then2:                                         ; preds = %if.then
  store i32 0, i32* @lastbyte, align 4, !tbaa !12
  store i1 true, i1* @eof, align 1
  br label %if.end3

if.else:                                          ; preds = %if.then
  %incdec.ptr = getelementptr inbounds i8, i8* %1, i32 1
  store i8* %incdec.ptr, i8** @nextbyte, align 4, !tbaa !14
  %2 = load i8, i8* %1, align 1, !tbaa !2
  %conv = zext i8 %2 to i32
  store i32 %conv, i32* @lastbyte, align 4, !tbaa !12
  store i32 7, i32* @bitsleft, align 4, !tbaa !12
  br label %if.end3
...
if.end3:                                          ; preds = %entry.if.end3_crit_edge, %if.then2, %if.else
  ...
  %and = and i32 %3, 1
  %shr = lshr i32 %3, 1
  store i32 %shr, i32* @lastbyte, align 4, !tbaa !12
  ret i32 %and
}
...
if.else.i:                                        ; preds = %if.then.i
  ...
  store i8* %incdec.ptr.i, i8** @nextbyte, align 4, !tbaa !14
  %2 = load i8, i8* %1, align 1, !tbaa !2
  %conv.i = zext i8 %2 to i32
  store i32 %conv.i, i32* @lastbyte, align 4, !tbaa !12
  store i32 7, i32* @bitsleft, align 4, !tbaa !12
  br label %getbit.exit
...
getbit.exit:                                      ; preds = %entry.if.end3_crit_edge.i, %if.else.i
  ...
  %and.i = and i32 %3, 1
  %shr.i = lshr i32 %3, 1
  store i32 %shr.i, i32* @lastbyte, align 4, !tbaa !12
...
while.cond:                                       ; preds = %while.cond.backedge, %while.cond.preheader
  ...
  store i32 %dec.i5, i32* @bitsleft, align 4, !tbaa !12
...
entry.if.end3_crit_edge.i8:                       ; preds = %while.cond
  %.pre.i7 = load i32, i32* @lastbyte, align 4, !tbaa !12
  br label %getbit.exit17

if.then.i10:                                      ; preds = %while.cond
  %5 = load i8*, i8** @nextbyte, align 4, !tbaa !14
...
if.else.i14:                                      ; preds = %if.then.i10
  ...
  store i8* %incdec.ptr.i12, i8** @nextbyte, align 4, !tbaa !14
  %6 = load i8, i8* %5, align 1, !tbaa !2
  %conv.i13 = zext i8 %6 to i32
  store i32 %conv.i13, i32* @lastbyte, align 4, !tbaa !12
  store i32 7, i32* @bitsleft, align 4, !tbaa !12
  br label %getbit.exit17
...
getbit.exit17:                                    ; preds = %entry.if.end3_crit_edge.i8, %if.else.i14
  ...
  store i32 %shr.i16, i32* @lastbyte, align 4, !tbaa !12
...
entry:
  %0 = load i32, i32* @sum, align 4, !tbaa !12
...
vector.body.prol:                                 ; preds = %vector.body.preheader
  %7 = bitcast i8* %rowbuf to <4 x i8>*
  %wide.load.prol = load <4 x i8>, <4 x i8>* %7, align 1, !tbaa !2
  %8 = getelementptr i8, i8* %rowbuf, i32 4
  %9 = bitcast i8* %8 to <4 x i8>*
  %wide.load26.prol = load <4 x i8>, <4 x i8>* %9, align 1, !tbaa !2
  %10 = zext <4 x i8> %wide.load.prol to <4 x i32>
  %11 = zext <4 x i8> %wide.load26.prol to <4 x i32>
  %12 = add <4 x i32> %10, %1
  br label %vector.body.preheader.split

vector.body.preheader.split:                      ; preds = %vector.body.prol, %vector.body.preheader
  %.lcssa39.unr = phi <4 x i32> [ zeroinitializer, %vector.body.preheader ], [ %11, %vector.body.prol ]
  %.lcssa.unr = phi <4 x i32> [ zeroinitializer, %vector.body.preheader ], [ %12, %vector.body.prol ]
  %index.unr = phi i32 [ 0, %vector.body.preheader ], [ 8, %vector.body.prol ]
  %vec.phi.unr = phi <4 x i32> [ %1, %vector.body.preheader ], [ %12, %vector.body.prol ]
  %vec.phi10.unr = phi <4 x i32> [ zeroinitializer, %vector.body.preheader ], [ %11, %vector.body.prol ]
  %13 = icmp ult i32 %5, 1
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader.split.split
  ...
  %vec.phi = phi <4 x i32> [ %vec.phi.unr, %vector.body.preheader.split.split ], [ %26, %vector.body ]
  %vec.phi10 = phi <4 x i32> [ %vec.phi10.unr, %vector.body.preheader.split.split ], [ %27, %vector.body ]
  %next.gep = getelementptr i8, i8* %rowbuf, i32 %index
  %14 = bitcast i8* %next.gep to <4 x i8>*
  %wide.load = load <4 x i8>, <4 x i8>* %14, align 1, !tbaa !2
  %next.gep.sum33 = or i32 %index, 4
  %15 = getelementptr i8, i8* %rowbuf, i32 %next.gep.sum33
  %16 = bitcast i8* %15 to <4 x i8>*
  %wide.load26 = load <4 x i8>, <4 x i8>* %16, align 1, !tbaa !2
  %17 = zext <4 x i8> %wide.load to <4 x i32>
  %18 = zext <4 x i8> %wide.load26 to <4 x i32>
  %19 = add <4 x i32> %17, %vec.phi
  %20 = add <4 x i32> %18, %vec.phi10
  %index.next = add i32 %index, 8
  %next.gep.1 = getelementptr i8, i8* %rowbuf, i32 %index.next
  %21 = bitcast i8* %next.gep.1 to <4 x i8>*
  %wide.load.1 = load <4 x i8>, <4 x i8>* %21, align 1, !tbaa !2
  %next.gep.sum33.1 = or i32 %index.next, 4
  %22 = getelementptr i8, i8* %rowbuf, i32 %next.gep.sum33.1
  %23 = bitcast i8* %22 to <4 x i8>*
  %wide.load26.1 = load <4 x i8>, <4 x i8>* %23, align 1, !tbaa !2
  %24 = zext <4 x i8> %wide.load.1 to <4 x i32>
  %25 = zext <4 x i8> %wide.load26.1 to <4 x i32>
  %26 = add <4 x i32> %24, %19
  %27 = add <4 x i32> %25, %20
  %index.next.1 = add i32 %index.next, 8
  %28 = icmp eq i32 %index.next.1, %n.vec
  br i1 %28, label %middle.block.loopexit.unr-lcssa, label %vector.body, !llvm.loop !16

middle.block.loopexit.unr-lcssa:                  ; preds = %vector.body
  %.lcssa41 = phi <4 x i32> [ %27, %vector.body ]
  %.lcssa40 = phi <4 x i32> [ %26, %vector.body ]
  br label %middle.block.loopexit

middle.block.loopexit:                            ; preds = %vector.body.preheader.split, %middle.block.loopexit.unr-lcssa
  %.lcssa39 = phi <4 x i32> [ %.lcssa39.unr, %vector.body.preheader.split ], [ %.lcssa41, %middle.block.loopexit.unr-lcssa ]
  %.lcssa = phi <4 x i32> [ %.lcssa.unr, %vector.body.preheader.split ], [ %.lcssa40, %middle.block.loopexit.unr-lcssa ]
  br label %middle.block
...
middle.block:                                     ; preds = %middle.block.loopexit, %overflow.checked
  ...
  %rdx.vec.exit.phi29 = phi <4 x i32> [ zeroinitializer, %overflow.checked ], [ %.lcssa39, %middle.block.loopexit ]
  ...
  %29 = extractelement <4 x i32> %bin.rdx32, i32 0
...
for.body.preheader38:                             ; preds = %middle.block, %for.body.preheader
  %sm.07.ph = phi i32 [ %0, %for.body.preheader ], [ %29, %middle.block ]
...
for.end:                                          ; preds = %for.end.loopexit, %middle.block, %entry
  %sm.0.lcssa = phi i32 [ %0, %entry ], [ %29, %middle.block ], [ %add.lcssa, %for.end.loopexit ]
  store i32 %sm.0.lcssa, i32* @sum, align 4, !tbaa !12
  ret void
}
...
entry:
  ...
  store i32 0, i32* @sum, align 4, !tbaa !12
  store i32 0, i32* @lastbyte, align 4, !tbaa !12
  store i32 0, i32* @bitsleft, align 4, !tbaa !12
  store i8* getelementptr inbounds ([1792 x i8], [1792 x i8]* @fax, i32 0, i32 0), i8** @nextbyte, align 4, !tbaa !14
...
for.body.i:                                       ; preds = %getbit.exit.i, %for.cond.outer.for.cond.outer.split_crit_edge.i
  ...
  store i32 %dec.i.i, i32* @bitsleft, align 4, !tbaa !12
...
if.else.i.i:                                      ; preds = %if.then.i.i
  ...
  store i8* %incdec.ptr.i.i, i8** @nextbyte, align 4, !tbaa !14
  %6 = load i8, i8* %4, align 1, !tbaa !2
  %conv.i.i = zext i8 %6 to i32
  store i32 %conv.i.i, i32* @lastbyte, align 4, !tbaa !12
  store i32 7, i32* @bitsleft, align 4, !tbaa !12
...
getbit.exit.i:                                    ; preds = %for.body.i, %if.else.i.i
  ...
  store i32 %shr.i.i, i32* @lastbyte, align 4, !tbaa !12
...
while.cond.i:                                     ; preds = %while.cond.i.outer, %getbit.exit17.i
  ...
  store i32 %dec.i5.i, i32* @bitsleft, align 4, !tbaa !12
...
if.else.i14.i:                                    ; preds = %if.then.i10.i
  ...
  store i8* %incdec.ptr.i12.i, i8** @nextbyte, align 4, !tbaa !14
  %11 = load i8, i8* %9, align 1, !tbaa !2
  %conv.i13.i = zext i8 %11 to i32
  store i32 %conv.i13.i, i32* @lastbyte, align 4, !tbaa !12
  store i32 7, i32* @bitsleft, align 4, !tbaa !12
...
getbit.exit17.i:                                  ; preds = %while.cond.i, %if.else.i14.i
  ...
  store i32 %shr.i16.i, i32* @lastbyte, align 4, !tbaa !12
...
for.body:                                         ; preds = %for.body.preheader, %middle.block
  %15 = phi i32 [ %115, %middle.block ], [ 0, %for.body.preheader ]
  ...
  store i32 %dec.i268, i32* @bitsleft, align 4, !tbaa !12
...
if.else.i277:                                     ; preds = %if.then.i273
  ...
  store i8* %incdec.ptr.i275, i8** @nextbyte, align 4, !tbaa !14
  %19 = load i8, i8* %16, align 1, !tbaa !2
  %conv.i276 = zext i8 %19 to i32
  store i32 %conv.i276, i32* @lastbyte, align 4, !tbaa !12
  store i32 7, i32* @bitsleft, align 4, !tbaa !12
  br label %getbit.exit280
...
getbit.exit280:                                   ; preds = %if.then2.i274, %for.body, %if.else.i277
  ...
  store i32 %shr.i279, i32* @lastbyte, align 4, !tbaa !12
  %and.i278 = shl i32 %22, 1
  %conv1 = and i32 %and.i278, 2
  %dec.i255 = add nsw i32 %21, -1
  store i32 %dec.i255, i32* @bitsleft, align 4, !tbaa !12
...
if.else.i264:                                     ; preds = %if.then.i260
  ...
  store i8* %incdec.ptr.i262, i8** @nextbyte, align 4, !tbaa !14
  %23 = load i8, i8* %20, align 1, !tbaa !2
  %conv.i263 = zext i8 %23 to i32
  store i32 %conv.i263, i32* @lastbyte, align 4, !tbaa !12
  store i32 7, i32* @bitsleft, align 4, !tbaa !12
  br label %getbit.exit267
...
getbit.exit267:                                   ; preds = %if.then2.i261, %getbit.exit280, %if.else.i264
  ...
  store i32 %shr.i266, i32* @lastbyte, align 4, !tbaa !12
  %add = or i32 %and.i265, %conv1
  %conv4 = shl nuw nsw i32 %add, 1
  %dec.i242 = add nsw i32 %25, -1
  store i32 %dec.i242, i32* @bitsleft, align 4, !tbaa !12
...
if.else.i251:                                     ; preds = %if.then.i247
  ...
  store i8* %incdec.ptr.i249, i8** @nextbyte, align 4, !tbaa !14
  %27 = load i8, i8* %24, align 1, !tbaa !2
  %conv.i250 = zext i8 %27 to i32
  store i32 %conv.i250, i32* @lastbyte, align 4, !tbaa !12
  store i32 7, i32* @bitsleft, align 4, !tbaa !12
  br label %getbit.exit254
...
getbit.exit254:                                   ; preds = %getbit.exit267, %if.then2.i248, %if.else.i251
  ...
  store i32 %shr.i253, i32* @lastbyte, align 4, !tbaa !12
...
for.body12:                                       ; preds = %for.cond9
  ...
  store i32 %dec.i229, i32* @bitsleft, align 4, !tbaa !12
...
if.else.i238:                                     ; preds = %if.then.i234
  ...
  store i8* %incdec.ptr.i236, i8** @nextbyte, align 4, !tbaa !14
  %35 = load i8, i8* %33, align 1, !tbaa !2
  %conv.i237 = zext i8 %35 to i32
  store i32 %conv.i237, i32* @lastbyte, align 4, !tbaa !12
  store i32 7, i32* @bitsleft, align 4, !tbaa !12
  br label %getbit.exit241
...
for.body.i199:                                    ; preds = %getbit.exit.i212, %for.cond.outer.for.cond.outer.split_crit_edge.i196
  ...
  store i32 %dec.i.i197, i32* @bitsleft, align 4, !tbaa !12
...
if.else.i.i207:                                   ; preds = %if.then.i.i203
  ...
  store i8* %incdec.ptr.i.i205, i8** @nextbyte, align 4, !tbaa !14
  %46 = load i8, i8* %45, align 1, !tbaa !2
  %conv.i.i206 = zext i8 %46 to i32
  store i32 %conv.i.i206, i32* @lastbyte, align 4, !tbaa !12
  store i32 7, i32* @bitsleft, align 4, !tbaa !12
...
getbit.exit.i212:                                 ; preds = %for.body.i199, %if.else.i.i207
  ...
  store i32 %shr.i.i210, i32* @lastbyte, align 4, !tbaa !12
...
while.cond.i215:                                  ; preds = %while.cond.i215.outer, %getbit.exit17.i227
  ...
  store i32 %dec.i5.i213, i32* @bitsleft, align 4, !tbaa !12
...
if.else.i14.i223:                                 ; preds = %if.then.i10.i219
  ...
  store i8* %incdec.ptr.i12.i221, i8** @nextbyte, align 4, !tbaa !14
  %51 = load i8, i8* %49, align 1, !tbaa !2
  %conv.i13.i222 = zext i8 %51 to i32
  store i32 %conv.i13.i222, i32* @lastbyte, align 4, !tbaa !12
  store i32 7, i32* @bitsleft, align 4, !tbaa !12
...
getbit.exit17.i227:                               ; preds = %while.cond.i215, %if.else.i14.i223
  ...
  store i32 %shr.i16.i225, i32* @lastbyte, align 4, !tbaa !12
...
for.body.i161:                                    ; preds = %getbit.exit.i174, %for.cond.outer.for.cond.outer.split_crit_edge.i158
  ...
  store i32 %dec.i.i159, i32* @bitsleft, align 4, !tbaa !12
...
if.else.i.i169:                                   ; preds = %if.then.i.i165
  ...
  store i8* %incdec.ptr.i.i167, i8** @nextbyte, align 4, !tbaa !14
  %73 = load i8, i8* %72, align 1, !tbaa !2
  %conv.i.i168 = zext i8 %73 to i32
  store i32 %conv.i.i168, i32* @lastbyte, align 4, !tbaa !12
  store i32 7, i32* @bitsleft, align 4, !tbaa !12
...
getbit.exit.i174:                                 ; preds = %for.body.i161, %if.else.i.i169
  ...
  store i32 %shr.i.i172, i32* @lastbyte, align 4, !tbaa !12
...
while.cond.i177:                                  ; preds = %while.cond.i177.outer, %getbit.exit17.i189
  ...
  store i32 %dec.i5.i175, i32* @bitsleft, align 4, !tbaa !12
...
if.else.i14.i185:                                 ; preds = %if.then.i10.i181
  ...
  store i8* %incdec.ptr.i12.i183, i8** @nextbyte, align 4, !tbaa !14
  %78 = load i8, i8* %76, align 1, !tbaa !2
  %conv.i13.i184 = zext i8 %78 to i32
  store i32 %conv.i13.i184, i32* @lastbyte, align 4, !tbaa !12
  store i32 7, i32* @bitsleft, align 4, !tbaa !12
...
getbit.exit17.i189:                               ; preds = %while.cond.i177, %if.else.i14.i185
  ...
  store i32 %shr.i16.i187, i32* @lastbyte, align 4, !tbaa !12
...
if.end67:                                         ; preds = %if.end64, %if.end43
  ...
  store i32 %dec.i140, i32* @bitsleft, align 4, !tbaa !12
...
if.else.i149:                                     ; preds = %if.then.i145
  ...
  store i8* %incdec.ptr.i147, i8** @nextbyte, align 4, !tbaa !14
  %84 = load i8, i8* %83, align 1, !tbaa !2
  %conv.i148 = zext i8 %84 to i32
  store i32 %conv.i148, i32* @lastbyte, align 4, !tbaa !12
  store i32 7, i32* @bitsleft, align 4, !tbaa !12
  br label %getbit.exit152
...
getbit.exit152:                                   ; preds = %if.end67, %if.then2.i146, %if.else.i149
  ...
  store i32 %shr.i151, i32* @lastbyte, align 4, !tbaa !12
...
if.else73:                                        ; preds = %getbit.exit152
  ...
  store i32 %dec.i127, i32* @bitsleft, align 4, !tbaa !12
...
if.else.i136:                                     ; preds = %if.then.i132
  ...
  store i8* %incdec.ptr.i134, i8** @nextbyte, align 4, !tbaa !14
  %88 = load i8, i8* %85, align 1, !tbaa !2
  %conv.i135 = zext i8 %88 to i32
  store i32 %conv.i135, i32* @lastbyte, align 4, !tbaa !12
  store i32 7, i32* @bitsleft, align 4, !tbaa !12
  br label %getbit.exit139
...
getbit.exit139:                                   ; preds = %if.else73, %if.then2.i133, %if.else.i136
  ...
  store i32 %shr.i138, i32* @lastbyte, align 4, !tbaa !12
...
if.else.i:                                        ; preds = %if.then.i
  ...
  store i8* %incdec.ptr.i125, i8** @nextbyte, align 4, !tbaa !14
  %92 = load i8, i8* %90, align 1, !tbaa !2
  %conv.i126 = zext i8 %92 to i32
  store i32 %conv.i126, i32* @lastbyte, align 4, !tbaa !12
  store i32 7, i32* @bitsleft, align 4, !tbaa !12
  br label %getbit.exit
...
vector.body:                                      ; preds = %vector.body, %overflow.checked
  %index = phi i32 [ 0, %overflow.checked ], [ %index.next.1, %vector.body ]
  %vec.phi = phi <4 x i32> [ %99, %overflow.checked ], [ %112, %vector.body ]
  %vec.phi510 = phi <4 x i32> [ zeroinitializer, %overflow.checked ], [ %113, %vector.body ]
  %next.gep = getelementptr [1728 x i8], [1728 x i8]* @rowbuf, i32 0, i32 %index
  %100 = bitcast i8* %next.gep to <4 x i8>*
  %wide.load = load <4 x i8>, <4 x i8>* %100, align 1, !tbaa !2
  ...
  %wide.load526 = load <4 x i8>, <4 x i8>* %102, align 1, !tbaa !2
  ...
  %next.gep.1 = getelementptr [1728 x i8], [1728 x i8]* @rowbuf, i32 0, i32 %index.next
  %107 = bitcast i8* %next.gep.1 to <4 x i8>*
  %wide.load.1 = load <4 x i8>, <4 x i8>* %107, align 1, !tbaa !2
  %next.gep.sum531.1 = or i32 %index.next, 4
  %108 = getelementptr [1728 x i8], [1728 x i8]* @rowbuf, i32 0, i32 %next.gep.sum531.1
  %109 = bitcast i8* %108 to <4 x i8>*
  %wide.load526.1 = load <4 x i8>, <4 x i8>* %109, align 1, !tbaa !2
  %110 = zext <4 x i8> %wide.load.1 to <4 x i32>
  %111 = zext <4 x i8> %wide.load526.1 to <4 x i32>
  %112 = add <4 x i32> %110, %105
  %113 = add <4 x i32> %111, %106
  %index.next.1 = add nuw nsw i32 %index.next, 8
  %114 = icmp eq i32 %index.next.1, 1728
  br i1 %114, label %middle.block, label %vector.body, !llvm.loop !18

middle.block:                                     ; preds = %vector.body
  %.lcssa660 = phi <4 x i32> [ %113, %vector.body ]
  %.lcssa659 = phi <4 x i32> [ %112, %vector.body ]
  ...
  %115 = extractelement <4 x i32> %bin.rdx530, i32 0
  store i32 %115, i32* @sum, align 4, !tbaa !12
  br i1 %.b120, label %for.end90, label %for.body

for.end90:                                        ; preds = %middle.block
  %.lcssa661 = phi i32 [ %115, %middle.block ]
