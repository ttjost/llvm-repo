...
.comment ""
.comment "-dir /home/jost/Dropbox/Universidade/Mestrado/vex-3.43 -S -o var_arg_v2.s"
.sversion 3.43
.rta 2
.section .bss
.align 32
...
;;								## 0
	...
	c0    stw 0x1c[$r0.1] = $l0.0  ## spill ## t5
;;								## 1
...
;;								## 4
	c0    stw 0x10[$r0.1] = $r0.2   ## bblock 0, line 23, t6, 100(SI32)
;;								## 5
	c0    stw 0x14[$r0.1] = $r0.11   ## bblock 0, line 23, t6, 101(SI32)
;;								## 6
.call FindMax, caller, arg($r0.1 + 16, 12; $r0.3:s32,$r0.4:s32,$r0.5:s32,$r0.6:s32,$r0.7:s32,$r0.8:s32,$r0.9:s32,$r0.10:s32,0:s32,4:s32,8:s32), ret($r0.3:s32)
	c0    stw 0x18[$r0.1] = $r0.12   ## bblock 0, line 23, t6, 102(SI32)
...
.call printf, caller, arg($r0.3:u32,$r0.4:s32), ret($r0.3:s32)
	c0    call $l0.0 = printf   ## bblock 1, line 24,  raddr(printf)(P32),  addr(_?1STRINGVAR.1)(P32),  t0
	c0    mov $r0.3 = (_?1STRINGPACKET.1 + 0)   ## addr(_?1STRINGVAR.1)(P32)
	c0    mov $r0.4 = $r0.3   ## t0
;;								## 8
	c0    mov $r0.3 = $r0.0   ## 0(SI32)
	c0    ldw $l0.0 = 0x1c[$r0.1]  ## restore ## t5
	      xnop 3
;;								## 12
.return ret($r0.3:s32)
	c0    return $r0.1 = $r0.1, (0x20), $l0.0   ## bblock 2, line 25,  t6,  ?2.2?2auto_size(I32),  t5
;;								## 13
.endp
.section .bss
.section .data
