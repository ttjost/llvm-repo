...
for.body49:                                       ; preds = %for.body49.lr.ph, %if.end73
  ...
  %84 = load i8, i8* %arrayidx54, align 1, !tbaa !5
  %idxprom55 = zext i8 %84 to i32
...
if.then52:                                        ; preds = %for.body49
  ...
  %85 = load i8, i8* %arrayidx56, align 1, !tbaa !5
  %conv57 = zext i8 %85 to i32
...
if.end73:                                         ; preds = %if.else63, %if.then52
  ...
  %86 = load i16, i16* %arrayidx75, align 2, !tbaa !1
  %conv80 = shl i16 %cword.1132, 8
  %xor82 = xor i16 %86, %conv80
  %inc85 = add i16 %j.1131, 1
  %conv46 = zext i16 %inc85 to i32
  %cmp47 = icmp ugt i32 %conv46, %len
  br i1 %cmp47, label %for.end86.loopexit, label %for.body49

for.end86.loopexit:                               ; preds = %if.end73
  %xor82.lcssa = phi i16 [ %xor82, %if.end73 ]
  br label %for.end86

for.end86:                                        ; preds = %for.end86.loopexit, %for.cond45.preheader
  %cword.1.lcssa = phi i16 [ %cword.1.ph, %for.cond45.preheader ], [ %xor82.lcssa, %for.end86.loopexit ]
...
if.else90:                                        ; preds = %for.end86
  ...
  %87 = load i8, i8* %arrayidx95, align 1, !tbaa !5
  %conv96 = zext i8 %87 to i16
  ...
  %88 = load i8, i8* %arrayidx101, align 1, !tbaa !5
  %conv102 = zext i8 %88 to i16
