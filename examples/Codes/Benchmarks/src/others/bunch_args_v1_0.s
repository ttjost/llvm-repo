...
;;
	c0	divs $r0.7, $b0.1 = $r0.7, $r0.2, $b0.1
	c0	addcg $r0.9, $b0.2 = $r0.4, $r0.4, $b0.2
	c0	ldw $r0.4 = 44[$r0.1]
;;
	c0	divs $r0.7, $b0.2 = $r0.7, $r0.2, $b0.2
...
;;
	c0	divs $r0.7, $b0.1 = $r0.7, $r0.2, $b0.1
	c0	addcg $r0.12, $b0.2 = $r0.11, $r0.11, $b0.2
;;
	c0	divs $r0.7, $b0.2 = $r0.7, $r0.2, $b0.2
...
;;
	c0	divs $r0.2, $b0.1 = $r0.7, $r0.2, $b0.1
	c0	addcg $r0.7, $b0.2 = $r0.11, $r0.11, $b0.2
;;
	c0	addcg $r0.11, $b0.1 = $r0.7, $r0.7, $b0.1
	c0	cmpge $r0.2 = $r0.2, $r0.0
	c0	mov $r0.57 = .str1
;;
	c0	orc $r0.7 = $r0.11, $r0.0
;;
	c0	sh1add $r0.2 = $r0.7, $r0.2
;;
	c0	sub $r0.7 = $r0.0, $r0.2
