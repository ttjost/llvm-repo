...
.call getbit, caller, arg($r0.3:u32, $r0.4:u32, $r0.5:u32, $r0.6:u32, $r0.7:u32, $r0.8:u32, $r0.9:u32, $r0.10:u32), ret()
	...
	c0	call $l0.0 = getbit
;;
	c0	mov $r0.11 = maxcode_dc
	c0	mov $r0.58 = 1
;;
	c0	ldw $r0.12 = 4[$r0.11]
	c0	add $r0.60 = $r0.11, 8
;;
;;
	c0	cmple $b0.0 = $r0.3, $r0.12
	c0	mov $r0.59 = $r0.3
;;
;;
	c0	br $b0.0, LBB1_2
...
;;
	...
	c0	sh1add $r0.59 = $r0.59, $r0.3
	c0	add $r0.60 = $r0.60, 4
	c0	add $r0.58 = $r0.58, 1
;;
;;
	c0	cmpgt $b0.0 = $r0.59, $r0.11
;;
;;
	c0	br $b0.0, LBB1_1
;;
LBB1_2::                                ## %while.end
	c0	mov $r0.11 = valptr_dc
;;
	c0	add $r0.11 = $r0.11, $r0.58
	c0	mov $r0.12 = mincode_dc
;;
	c0	sh2add $r0.12 = $r0.58, $r0.12
	c0	ldbu $r0.11 = 0[$r0.11]
	c0	mov $r0.13 = val_dc_lum
;;
	c0	mov $r0.58 = 0
	c0	ldw $r0.12 = 0[$r0.12]
;;
...
LBB1_4::                                ## %for.body
                                        ## =>This Inner Loop Header: Depth=1
.call getbit, caller, arg($r0.3:u32, $r0.4:u32, $r0.5:u32, $r0.6:u32, $r0.7:u32, $r0.8:u32, $r0.9:u32, $r0.10:u32), ret()
	c0	ldw $r0.61 = 0[$r0.57]
	c0	call $l0.0 = getbit
;;
	c0	add $r0.60 = $r0.60, -1
;;
	c0	sh1add $r0.11 = $r0.61, $r0.3
;;
...
;;
	c0	br $b0.0, LBB1_9
;;
## BB#6:                                ## %while.body18.lr.ph
	c0	mov $r0.12 = -1
;;
	c0	shl $r0.13 = $r0.12, $r0.59
;;
	c0	sub $r0.12 = $r0.58, $r0.13
...
;;
	c0	br $b0.0, LBB1_7
;;
## BB#8:                                ## %while.cond15.while.end22_crit_edge
	c0	stw 0[$r0.57] = $r0.11
;;
LBB1_9::                                ## %while.end22
	c0	ldw $l0.0 = 24[$r0.1]
...
.section .text 
.proc 
.entry caller, sp=$r0.1, rl=$l0.0, asize=-352, arg() ## @huff_ac_dec
huff_ac_dec::
## BB#0:                                ## %entry
	c0	add $r0.1 = $r0.1, -352
;;
	c0	stw 348[$r0.1] = $r0.57
;;
	c0	stw 344[$r0.1] = $r0.58
;;
	c0	stw 340[$r0.1] = $r0.59
;;
	c0	stw 336[$r0.1] = $r0.60
;;
	c0	stw 332[$r0.1] = $r0.61
;;
	c0	stw 328[$r0.1] = $r0.62
;;
	c0	stw 324[$r0.1] = $r0.63
;;
	c0	stw 320[$r0.1] = $l0.0
	c0	mov $r0.11 = $r0.3
;;
	c0	stw 40[$r0.1] = $r0.11
	c0	mov $r0.63 = 0
	c0	mov $r0.11 = maxcode_ac
;;
...
;;
	...
	c0	sh1add $r0.60 = $r0.60, $r0.3
	c0	add $r0.63 = $r0.63, 4
	c0	add $r0.58 = $r0.58, 1
;;
;;
	c0	cmpgt $b0.0 = $r0.60, $r0.11
;;
;;
	c0	br $b0.0, LBB2_4
;;
...
;;
	c0	brf $b0.0, LBB2_6
;;
## BB#2:                                ## %while.cond.loopexit134
                                        ##   in Loop: Header=BB2_3 Depth=1
	c0	add $r0.58 = $r0.62, 16
	c0	sh2add $r0.3 = $r0.62, $r0.59
	c0	mov $r0.4 = $r0.63
	c0	ldw $r0.5 = 36[$r0.1]
;;
;;
...
## BB#7:                                ## %for.cond.preheader
                                        ##   in Loop: Header=BB2_3 Depth=1
	c0	and $r0.14 = $r0.11, 15
	c0	and $r0.12 = $r0.11, 240
;;
...
;;
	c0	br $b0.0, LBB2_9
;;
## BB#8:                                ## %for.cond.for.cond20.preheader_crit_edge
                                        ##   in Loop: Header=BB2_3 Depth=1
...
;;
	...
	c0	mov $r0.57 = $r0.14
;;
	c0	add $r0.58 = $r0.62, $r0.11
	c0	and $r0.5 = $r0.12, 60
	c0	sh2add $r0.3 = $r0.62, $r0.59
	c0	mov $r0.4 = $r0.63
;;
.call memset, caller, arg($r0.3:u32, $r0.4:u32, $r0.5:u32, $r0.6:u32, $r0.7:u32, $r0.8:u32, $r0.9:u32, $r0.10:u32), ret()
...
;;
	c0	shl $r0.11 = $r0.61, $r0.11
;;
	c0	cmpge $b0.0 = $r0.60, $r0.11
;;
;;
	c0	br $b0.0, LBB2_15
;;
## BB#13:                               ## %while.body35.lr.ph
                                        ##   in Loop: Header=BB2_3 Depth=1
...
;;
	c0	sub $r0.11 = $r0.63, $r0.12
	c0	add $r0.12 = $r0.12, 1
;;
LBB2_14::                               ## %while.body35
                                        ##   Parent Loop BB2_3 Depth=1
                                        ## =>  This Inner Loop Header: Depth=2
	c0	add $r0.60 = $r0.60, $r0.12
;;
	c0	add $r0.13 = $r0.11, $r0.60
;;
	c0	add $r0.13 = $r0.13, -1
;;
...
LBB2_15::                               ## %while.end39
                                        ##   in Loop: Header=BB2_3 Depth=1
	c0	add $r0.11 = $r0.62, 1
	c0	sh2add $r0.12 = $r0.62, $r0.59
;;
	c0	stw 0[$r0.12] = $r0.60
	c0	mov $r0.62 = $r0.11
;;
LBB2_16::                               ## %while.cond.backedge
                                        ##   in Loop: Header=BB2_3 Depth=1
	c0	cmplt $b0.0 = $r0.62, 63
;;
;;
	c0	br $b0.0, LBB2_3
;;
...
;;
	c0	brf $b0.0, LBB2_18
;;
## BB#1:                                ## %for.cond53.while.cond.loopexit_crit_edge
	c0	add $r0.59 = $r0.1, 64
...
;;
	...
	c0	br $b0.0, LBB2_18
;;
## BB#19:                               ## %for.body79.preheader
	c0	add $r0.13 = $r0.1, 64
	c0	mov $r0.12 = 31
;;
...
;;
;;
	c0	sub $r0.15 = $r0.14, $r0.15
	c0	cmpne $b0.0 = $r0.12, 0
;;
	c0	sh1add $r0.15 = $r0.15, $r0.57
;;
...
;;
;;
	c0	sth 126[$r0.57] = $r0.11
;;
	c0	ldw $l0.0 = 320[$r0.1]
;;
	c0	ldw $r0.63 = 324[$r0.1]
;;
	c0	ldw $r0.62 = 328[$r0.1]
;;
	c0	ldw $r0.61 = 332[$r0.1]
;;
	c0	ldw $r0.60 = 336[$r0.1]
;;
	c0	ldw $r0.59 = 340[$r0.1]
;;
	c0	ldw $r0.58 = 344[$r0.1]
;;
.return ret($r0.3:s32)
	c0	ldw $r0.57 = 348[$r0.1]
	c0	return $r0.1 = $r0.1, 352, $l0.0
;;
.endp
...
LBB4_1::                                ## %for.body
                                        ## =>This Inner Loop Header: Depth=1
	c0	add $r0.60 = $r0.11, 16
	c0	add $r0.3 = $r0.57, $r0.11
	c0	mov $r0.4 = $r0.59
;;
...
LBB6_3::                                ## %for.body18
                                        ## =>This Inner Loop Header: Depth=1
	c0	add $r0.59 = $r0.12, 128
	c0	add $r0.3 = $r0.57, $r0.12
;;
...
;;
;;
	c0	shl $r0.12 = $r0.14, $r0.13
	c0	shl $r0.13 = $r0.14, $r0.15
...
LBB6_9::                                ## %for.body48
	...
	c0	ldh $r0.23 = 0[$r0.21]
	c0	add $r0.22 = $r0.22, -1
;;
;;
	c0	add $r0.16 = $r0.16, $r0.23
	c0	add $r0.21 = $r0.21, 2
	c0	cmpne $b0.1 = $r0.22, 0
;;
	c0	add $r0.16 = $r0.16, 64
;;
	c0	br $b0.1, LBB6_9
;;
## BB#10:                               ## %for.inc59
                                        ##   in Loop: Header=BB6_8 Depth=3
	c0	add $r0.20 = $r0.20, 64
	c0	add $r0.19 = $r0.19, 128
;;
	c0	cmplt $b0.1 = $r0.20, $r0.13
;;
;;
	c0	br $b0.1, LBB6_8
;;
