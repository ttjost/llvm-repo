...
entry:
  ...
  store i32 %and.i, i32* @parity, align 4, !tbaa !2
...
if.then.i:                                        ; preds = %while.body.i
  ...
  %xor14.i = xor i8 %3, %2
  store i8 %xor14.i, i8* @s1, align 1, !tbaa !6
  %arrayidx4.i = getelementptr inbounds [31 x i8], [31 x i8]* @alpha3, i32 0, i32 %i.017.i
  %4 = load i8, i8* %arrayidx4.i, align 1, !tbaa !6
  %xor715.i = xor i8 %4, %1
  store i8 %xor715.i, i8* @s3, align 1, !tbaa !6
  %inc.i = add i32 %0, 1
  store i32 %inc.i, i32* @parity, align 4, !tbaa !2
  br label %if.end.i
...
find_syndromes.exit:                              ; preds = %if.end.i
  ...
  store i32 %and9.i, i32* @parity, align 4, !tbaa !2
...
if.then8:                                         ; preds = %if.else
  ...
  store i32 %xor.i57, i32* @hexword, align 4, !tbaa !2
...
if.else9:                                         ; preds = %if.else
  ...
  %22 = load i8, i8* %arrayidx14.i, align 1, !tbaa !6
  %xor.i59 = xor i8 %22, 1
...
if.else16:                                        ; preds = %if.else9
  ...
  %25 = load i8, i8* %arrayidx11, align 1, !tbaa !6
  %add = add i8 %25, %10
  ...
  %33 = load i8, i8* %arrayidx29, align 1, !tbaa !6
  ...
  %34 = load i8, i8* %arrayidx33, align 1, !tbaa !6
  %inc.i49 = add i8 %34, 1
  %conv.i = sext i8 %inc.i49 to i32
  %shl.i = shl i32 1, %conv.i
  %xor.i = xor i32 %shl.i, %xor.i53
  store i32 %xor.i, i32* @hexword, align 4, !tbaa !2
...
if.then:                                          ; preds = %while.body
  ...
  %5 = load i8, i8* %arrayidx4, align 1, !tbaa !6
  %xor715 = xor i8 %2, %5
...
while.body:                                       ; preds = %while.body.backedge, %entry
  ...
  %1 = load i32, i32* %dptr.addr.053, align 4, !tbaa !2
...
while.body4:                                      ; preds = %while.body, %if.else
  ...
  %2 = load i8, i8* %arrayidx.i, align 1, !tbaa !6
  ...
  %3 = load i8, i8* %arrayidx.1.i, align 1, !tbaa !6
  ...
  %4 = load i8, i8* %arrayidx.2.i, align 1, !tbaa !6
  ...
  %5 = load i8, i8* %arrayidx.3.i, align 1, !tbaa !6
...
if.end:                                           ; preds = %while.body4
  ...
  %6 = load i8, i8* %arrayidx.i27, align 1, !tbaa !6
  ...
  %7 = load i8, i8* %arrayidx.1.i31, align 1, !tbaa !6
  ...
  %8 = load i8, i8* %arrayidx.2.i36, align 1, !tbaa !6
  ...
  %9 = load i8, i8* %arrayidx.3.i40, align 1, !tbaa !6
...
if.end:                                           ; preds = %entry
  ...
  %3 = load i8, i8* %arrayidx.i48, align 1, !tbaa !6
  ...
  %4 = load i8, i8* %arrayidx.1.i52, align 1, !tbaa !6
  ...
  %5 = load i8, i8* %arrayidx.2.i57, align 1, !tbaa !6
...
if.then3:                                         ; preds = %entry, %if.end
  ...
  %6 = load i32, i32* @error_code, align 4, !tbaa !2
...
if.then8:                                         ; preds = %if.then6
  ...
  %7 = load i8, i8* %arrayidx.i30, align 1, !tbaa !6
  ...
  %8 = load i8, i8* %arrayidx.1.i34, align 1, !tbaa !6
  ...
  %9 = load i8, i8* %arrayidx.2.i39, align 1, !tbaa !6
...
if.else.us:                                       ; preds = %if.then.us
  ...
  store i8 %conv.us, i8* %arrayidx9.us, align 1, !tbaa !6
...
if.then6.us:                                      ; preds = %if.then.us
  ...
  store i8 %add21.us, i8* %arrayidx.us, align 1, !tbaa !6
  br label %if.then.us.1
...
if.else.us.1:                                     ; preds = %if.then.us.1
  ...
  store i8 %conv.us.1, i8* %arrayidx9.us.1, align 1, !tbaa !6
...
if.then6.us.1:                                    ; preds = %if.then.us.1
  ...
  store i8 %add21.us.1, i8* %arrayidx.us.1, align 1, !tbaa !6
  br label %if.then.us.2
...
if.else.us.2:                                     ; preds = %if.then.us.2
  ...
  store i8 %conv.us.2, i8* %arrayidx9.us.2, align 1, !tbaa !6
...
if.then6.us.2:                                    ; preds = %if.then.us.2
  ...
  store i8 %add21.us.2, i8* %arrayidx.us.2, align 1, !tbaa !6
  br label %if.then.us.3
...
if.else.us.3:                                     ; preds = %if.then.us.3
  ...
  store i8 %conv.us.3, i8* %arrayidx9.us.3, align 1, !tbaa !6
...
if.then6.us.3:                                    ; preds = %if.then.us.3
  ...
  store i8 %add21.us.3, i8* %arrayidx.us.3, align 1, !tbaa !6
  br label %if.then.us.4
...
if.else.us.4:                                     ; preds = %if.then.us.4
  ...
  store i8 %conv.us.4, i8* %arrayidx9.us.4, align 1, !tbaa !6
  br label %while.end
...
if.then6.us.4:                                    ; preds = %if.then.us.4
  ...
  store i8 %add21.us.4, i8* %arrayidx.us.4, align 1, !tbaa !6
  br label %while.end
}
...
if.end20.us.2:                                    ; preds = %while.cond.preheader
  ...
  store i8 %conv16.us, i8* %arrayidx17.us, align 1, !tbaa !6
  ...
  store i8 %conv16.us.1, i8* %arrayidx17.us.1, align 1, !tbaa !6
  ...
  store i8 %conv16.us.2, i8* %arrayidx17.us.2, align 1, !tbaa !6
  br label %while.end
}
...
if.then.lr.ph:                                    ; preds = %while.body.outer
  ...
  %idxprom.i = and i32 %xor.i, 255
  %arrayidx.i = getelementptr inbounds [256 x i8], [256 x i8]* @err_tab, i32 0, i32 %idxprom.i
  %1 = load i8, i8* %arrayidx.i, align 1, !tbaa !6
  %conv1.i = zext i8 %1 to i32
  %shr.i = lshr i32 %xor.i, 8
  %idxprom.1.i = and i32 %shr.i, 255
  %arrayidx.1.i = getelementptr inbounds [256 x i8], [256 x i8]* @err_tab, i32 0, i32 %idxprom.1.i
  %2 = load i8, i8* %arrayidx.1.i, align 1, !tbaa !6
  %conv1.1.i = zext i8 %2 to i32
  %add.1.i = add nuw nsw i32 %conv1.1.i, %conv1.i
  %shr.1.i = lshr i32 %xor.i, 16
  %idxprom.2.i = and i32 %shr.1.i, 255
  %arrayidx.2.i = getelementptr inbounds [256 x i8], [256 x i8]* @err_tab, i32 0, i32 %idxprom.2.i
  %3 = load i8, i8* %arrayidx.2.i, align 1, !tbaa !6
  %conv1.2.i = zext i8 %3 to i32
  %add.2.i = add nuw nsw i32 %add.1.i, %conv1.2.i
  %shr.2.i = lshr i32 %xor.i, 24
  %arrayidx.3.i = getelementptr inbounds [256 x i8], [256 x i8]* @err_tab, i32 0, i32 %shr.2.i
  %4 = load i8, i8* %arrayidx.3.i, align 1, !tbaa !6
...
while.body.backedge:                              ; preds = %if.then.lr.ph, %if.else5
  ...
  %5 = load i32, i32* %incdec.ptr107, align 4, !tbaa !2
  br label %if.else7
...
if.then24:                                        ; preds = %if.else17
  ...
  %11 = load i8, i8* %arrayidx.i64, align 1, !tbaa !6
  ...
  %12 = load i8, i8* %arrayidx.1.i68, align 1, !tbaa !6
  ...
  %13 = load i8, i8* %arrayidx.2.i73, align 1, !tbaa !6
...
if.end30:                                         ; preds = %if.then24
  ...
  %14 = load i8, i8* %arrayidx.i82, align 1, !tbaa !6
  ...
  %15 = load i8, i8* %arrayidx.1.i86, align 1, !tbaa !6
  ...
  %16 = load i8, i8* %arrayidx.2.i91, align 1, !tbaa !6
...
if.end34:                                         ; preds = %if.end30, %if.else17
  ...
  %17 = load i32, i32* @func, align 4, !tbaa !2
...
sw.bb37:                                          ; preds = %if.end34
  %18 = load i32, i32* @alpha_count, align 4, !tbaa !2
...
if.then3.i:                                       ; preds = %if.then.i
  ...
  %19 = load i8, i8* %arrayidx.i61, align 1, !tbaa !6
...
if.end.i:                                         ; preds = %if.then3.i, %if.then.i
  ...
  store i8 %storemerge39.i, i8* %arrayidx.i61, align 1, !tbaa !6
...
if.end20.us.2.i:                                  ; preds = %while.cond.preheader.i
  ...
  store i8 %conv16.us.i, i8* %arrayidx17.us.i, align 1, !tbaa !6
  ...
  store i8 %conv16.us.1.i, i8* %arrayidx17.us.1.i, align 1, !tbaa !6
  ...
  store i8 %conv16.us.2.i, i8* %arrayidx17.us.2.i, align 1, !tbaa !6
  br label %alpha_proc.exit
...
alpha_proc.exit:                                  ; preds = %if.end20.2.i, %if.end20.us.2.i
  ...
  store i32 %storemerge.i, i32* @alpha_count, align 4, !tbaa !2
  br label %if.end39
...
if.then2.1:                                       ; preds = %for.inc
  ...
  %1 = load i32, i32* @func, align 4, !tbaa !2
...
attributes #0 = { nounwind "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="yonah" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #1 = { nounwind readonly "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="yonah" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #2 = { nounwind readnone "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="yonah" "unsafe-fp-math"="false" "use-soft-float"="false" }
