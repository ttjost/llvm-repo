...
entry:
  tail call void @fast_idct_8(i16* %data, i32 1)
  %add.ptr.1 = getelementptr inbounds i16, i16* %data, i32 8
  tail call void @fast_idct_8(i16* %add.ptr.1, i32 1)
  %add.ptr.2 = getelementptr inbounds i16, i16* %data, i32 16
  tail call void @fast_idct_8(i16* %add.ptr.2, i32 1)
  %add.ptr.3 = getelementptr inbounds i16, i16* %data, i32 24
  tail call void @fast_idct_8(i16* %add.ptr.3, i32 1)
  %add.ptr.4 = getelementptr inbounds i16, i16* %data, i32 32
  tail call void @fast_idct_8(i16* %add.ptr.4, i32 1)
  %add.ptr.5 = getelementptr inbounds i16, i16* %data, i32 40
  tail call void @fast_idct_8(i16* %add.ptr.5, i32 1)
  %add.ptr.6 = getelementptr inbounds i16, i16* %data, i32 48
  tail call void @fast_idct_8(i16* %add.ptr.6, i32 1)
  %add.ptr.7 = getelementptr inbounds i16, i16* %data, i32 56
  tail call void @fast_idct_8(i16* %add.ptr.7, i32 1)
  tail call void @fast_idct_8(i16* %data, i32 8)
  %add.ptr4.1 = getelementptr inbounds i16, i16* %data, i32 1
  tail call void @fast_idct_8(i16* %add.ptr4.1, i32 8)
  %add.ptr4.2 = getelementptr inbounds i16, i16* %data, i32 2
  tail call void @fast_idct_8(i16* %add.ptr4.2, i32 8)
  %add.ptr4.3 = getelementptr inbounds i16, i16* %data, i32 3
  tail call void @fast_idct_8(i16* %add.ptr4.3, i32 8)
  %add.ptr4.4 = getelementptr inbounds i16, i16* %data, i32 4
  tail call void @fast_idct_8(i16* %add.ptr4.4, i32 8)
  %add.ptr4.5 = getelementptr inbounds i16, i16* %data, i32 5
  tail call void @fast_idct_8(i16* %add.ptr4.5, i32 8)
  %add.ptr4.6 = getelementptr inbounds i16, i16* %data, i32 6
  tail call void @fast_idct_8(i16* %add.ptr4.6, i32 8)
  %add.ptr4.7 = getelementptr inbounds i16, i16* %data, i32 7
  tail call void @fast_idct_8(i16* %add.ptr4.7, i32 8)
  ret void
}
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %exitcond113 = icmp eq i32 %inc, 600
  br i1 %exitcond113, label %for.body9.preheader, label %for.body

for.body9.preheader:                              ; preds = %for.body
  br label %for.body9

for.body9:                                        ; preds = %for.body9.preheader, %for.body9
  %i.1108 = phi i32 [ %inc13, %for.body9 ], [ 0, %for.body9.preheader ]
  ...
  %exitcond112 = icmp eq i32 %inc13, 600
  br i1 %exitcond112, label %for.body18.preheader, label %for.body9

for.body18.preheader:                             ; preds = %for.body9
  %wide.load123 = load <8 x i8>, <8 x i8>* bitcast ([64 x i8]* @qtbl_lum to <8 x i8>*), align 1, !tbaa !7
  %1 = zext <8 x i8> %wide.load123 to <8 x i16>
  %wide.load123.1 = load <8 x i8>, <8 x i8>* bitcast (i8* getelementptr inbounds ([64 x i8], [64 x i8]* @qtbl_lum, i32 0, i32 8) to <8 x i8>*), align 1, !tbaa !7
  %2 = zext <8 x i8> %wide.load123.1 to <8 x i16>
  %wide.load123.2 = load <8 x i8>, <8 x i8>* bitcast (i8* getelementptr inbounds ([64 x i8], [64 x i8]* @qtbl_lum, i32 0, i32 16) to <8 x i8>*), align 1, !tbaa !7
  %3 = zext <8 x i8> %wide.load123.2 to <8 x i16>
  %wide.load123.3 = load <8 x i8>, <8 x i8>* bitcast (i8* getelementptr inbounds ([64 x i8], [64 x i8]* @qtbl_lum, i32 0, i32 24) to <8 x i8>*), align 1, !tbaa !7
  %4 = zext <8 x i8> %wide.load123.3 to <8 x i16>
  %wide.load123.4 = load <8 x i8>, <8 x i8>* bitcast (i8* getelementptr inbounds ([64 x i8], [64 x i8]* @qtbl_lum, i32 0, i32 32) to <8 x i8>*), align 1, !tbaa !7
  %5 = zext <8 x i8> %wide.load123.4 to <8 x i16>
  %wide.load123.5 = load <8 x i8>, <8 x i8>* bitcast (i8* getelementptr inbounds ([64 x i8], [64 x i8]* @qtbl_lum, i32 0, i32 40) to <8 x i8>*), align 1, !tbaa !7
  %6 = zext <8 x i8> %wide.load123.5 to <8 x i16>
  %wide.load123.6 = load <8 x i8>, <8 x i8>* bitcast (i8* getelementptr inbounds ([64 x i8], [64 x i8]* @qtbl_lum, i32 0, i32 48) to <8 x i8>*), align 1, !tbaa !7
  %7 = zext <8 x i8> %wide.load123.6 to <8 x i16>
  %wide.load123.7 = load <8 x i8>, <8 x i8>* bitcast (i8* getelementptr inbounds ([64 x i8], [64 x i8]* @qtbl_lum, i32 0, i32 56) to <8 x i8>*), align 1, !tbaa !7
  %8 = zext <8 x i8> %wide.load123.7 to <8 x i16>
  br label %for.body18

for.body18:                                       ; preds = %for.body18.preheader, %vector.body
  %i.2107 = phi i32 [ %inc21, %vector.body ], [ 0, %for.body18.preheader ]
  %mul19 = shl i32 %i.2107, 6
  br label %vector.body
...
vector.body:                                      ; preds = %for.body18
  ...
  %exitcond111 = icmp eq i32 %inc21, 600
  br i1 %exitcond111, label %for.body26.preheader, label %for.body18
...
for.body26:                                       ; preds = %for.body26.preheader, %for.body26
  %i.3106 = phi i32 [ %inc30, %for.body26 ], [ 0, %for.body26.preheader ]
...
for.cond36.preheader:                             ; preds = %for.cond32.preheader, %for.inc65
  %sum.0105 = phi i32 [ 0, %for.cond32.preheader ], [ %sum.2.lcssa.lcssa, %for.inc65 ]
...
for.cond45.preheader:                             ; preds = %for.cond45.preheader.lr.ph, %for.cond45.preheader
  %sum.2101 = phi i32 [ %sum.1103, %for.cond45.preheader.lr.ph ], [ %add55.7, %for.cond45.preheader ]
  %k.0100 = phi i32 [ 0, %for.cond45.preheader.lr.ph ], [ %add60, %for.cond45.preheader ]
  %add50 = add i32 %add49, %k.0100
  %arrayidx52 = getelementptr inbounds [38400 x i16], [38400 x i16]* @dct_data, i32 0, i32 %add50
  %49 = load i16, i16* %arrayidx52, align 2, !tbaa !8
  %conv53 = sext i16 %49 to i32
  %add54 = add i32 %sum.2101, 64
  %add55 = add i32 %add54, %conv53
  %add51.1114 = or i32 %add50, 1
  %arrayidx52.1 = getelementptr inbounds [38400 x i16], [38400 x i16]* @dct_data, i32 0, i32 %add51.1114
  %50 = load i16, i16* %arrayidx52.1, align 2, !tbaa !8
  %conv53.1 = sext i16 %50 to i32
  %add54.1 = add i32 %add55, 64
  %add55.1 = add i32 %add54.1, %conv53.1
  %add51.2115 = or i32 %add50, 2
  %arrayidx52.2 = getelementptr inbounds [38400 x i16], [38400 x i16]* @dct_data, i32 0, i32 %add51.2115
  %51 = load i16, i16* %arrayidx52.2, align 2, !tbaa !8
  %conv53.2 = sext i16 %51 to i32
  %add54.2 = add i32 %add55.1, 64
  %add55.2 = add i32 %add54.2, %conv53.2
  %add51.3116 = or i32 %add50, 3
  %arrayidx52.3 = getelementptr inbounds [38400 x i16], [38400 x i16]* @dct_data, i32 0, i32 %add51.3116
  %52 = load i16, i16* %arrayidx52.3, align 2, !tbaa !8
  %conv53.3 = sext i16 %52 to i32
  %add54.3 = add i32 %add55.2, 64
  %add55.3 = add i32 %add54.3, %conv53.3
  %add51.4117 = or i32 %add50, 4
  %arrayidx52.4 = getelementptr inbounds [38400 x i16], [38400 x i16]* @dct_data, i32 0, i32 %add51.4117
  %53 = load i16, i16* %arrayidx52.4, align 2, !tbaa !8
  %conv53.4 = sext i16 %53 to i32
  %add54.4 = add i32 %add55.3, 64
  %add55.4 = add i32 %add54.4, %conv53.4
  %add51.5118 = or i32 %add50, 5
  %arrayidx52.5 = getelementptr inbounds [38400 x i16], [38400 x i16]* @dct_data, i32 0, i32 %add51.5118
  %54 = load i16, i16* %arrayidx52.5, align 2, !tbaa !8
  %conv53.5 = sext i16 %54 to i32
  %add54.5 = add i32 %add55.4, 64
  %add55.5 = add i32 %add54.5, %conv53.5
  %add51.6119 = or i32 %add50, 6
  %arrayidx52.6 = getelementptr inbounds [38400 x i16], [38400 x i16]* @dct_data, i32 0, i32 %add51.6119
  %55 = load i16, i16* %arrayidx52.6, align 2, !tbaa !8
  %conv53.6 = sext i16 %55 to i32
  %add54.6 = add i32 %add55.5, 64
  %add55.6 = add i32 %add54.6, %conv53.6
  %add51.7120 = or i32 %add50, 7
  %arrayidx52.7 = getelementptr inbounds [38400 x i16], [38400 x i16]* @dct_data, i32 0, i32 %add51.7120
  %56 = load i16, i16* %arrayidx52.7, align 2, !tbaa !8
  %conv53.7 = sext i16 %56 to i32
  %add54.7 = add i32 %add55.6, 64
  %add55.7 = add i32 %add54.7, %conv53.7
  %add60 = add nuw nsw i32 %k.0100, 64
  %cmp42 = icmp slt i32 %add60, %mul41
  br i1 %cmp42, label %for.cond45.preheader, label %for.inc62.loopexit

for.inc62.loopexit:                               ; preds = %for.cond45.preheader
  %add55.7.lcssa = phi i32 [ %add55.7, %for.cond45.preheader ]
  br label %for.inc62

for.inc62:                                        ; preds = %for.inc62.loopexit, %for.cond40.preheader
  %sum.2.lcssa = phi i32 [ %sum.1103, %for.cond40.preheader ], [ %add55.7.lcssa, %for.inc62.loopexit ]
...
for.inc65:                                        ; preds = %for.inc62
  %sum.2.lcssa.lcssa = phi i32 [ %sum.2.lcssa, %for.inc62 ]
...
for.end68:                                        ; preds = %for.inc65
  %sum.2.lcssa.lcssa.lcssa = phi i32 [ %sum.2.lcssa.lcssa, %for.inc65 ]
  %cmp69 = icmp eq i32 %sum.2.lcssa.lcssa.lcssa, 2598822
