...
LBB1_10::                               ## %if.end73
	...
	c0	mov $r0.13 = 8
	c0	and $r0.15 = $r0.11, 65280
;;
	c0	mov $r0.16 = icrc.icrctb
	c0	shru $r0.15 = $r0.15, $r0.13
	c0	ldbu $r0.12 = 0[$r0.12]
;;
	c0	shl $r0.11 = $r0.11, $r0.13
;;
	c0	xor $r0.12 = $r0.12, $r0.15
	c0	add $r0.14 = $r0.14, 1
;;
	c0	sh1add $r0.13 = $r0.12, $r0.16
	c0	zxth $r0.12 = $r0.14
;;
	c0	cmpleu $b0.0 = $r0.12, $r0.5
...
;;
	c0	ldbu $r0.12 = 0[$r0.12]
	c0	mov $r0.15 = 8
	c0	and $r0.16 = $r0.11, 65280
;;
	c0	mov $r0.17 = icrc.icrctb
;;
	c0	add $r0.12 = $r0.14, $r0.12
	c0	shru $r0.14 = $r0.16, $r0.15
;;
	c0	ldbu $r0.12 = 0[$r0.12]
...
;;
;;
	c0	xor $r0.14 = $r0.12, $r0.14
	c0	zxth $r0.12 = $r0.13
;;
	c0	sh1add $r0.14 = $r0.14, $r0.17
	c0	cmpgtu $b0.0 = $r0.12, $r0.5
;;
