...
.comment ""
.comment "-dir /home/jost/Dropbox/Universidade/Mestrado/vex-3.43 -S -o var_arg_v4.s"
.sversion 3.43
.rta 2
.section .bss
.align 32
...
;;								## 0
	c0    stw 0x44[$r0.1] = $l0.0  ## spill ## t7
...
;;								## 4
	...
	c0    mov $r0.12 = 102   ## 102(SI32)
	c0    mov $r0.11 = 101   ## 101(SI32)
	c0    mov $r0.2 = 100   ## 100(SI32)
;;								## 5
	c0    stw 0x10[$r0.1] = $r0.2   ## bblock 1, line 24, t8, 100(SI32)
	c0    mov $r0.9 = 104   ## 104(SI32)
	c0    mov $r0.4 = 702   ## 702(SI32)
;;								## 6
	c0    mov $r0.5 = 422   ## 422(SI32)
...
;;								## 7
	...
	c0    mov $r0.8 = 892   ## 892(SI32)
;;								## 8
	c0    stw 0x14[$r0.1] = $r0.11   ## bblock 1, line 24, t8, 101(SI32)
	c0    mov $r0.10 = 772   ## 772(SI32)
;;								## 9
.call FindMax, caller, arg($r0.1 + 16, 12; $r0.3:s32,$r0.4:s32,$r0.5:s32,$r0.6:s32,$r0.7:s32,$r0.8:s32,$r0.9:s32,$r0.10:s32,0:s32,4:s32,8:s32), ret($r0.3:s32)
	c0    stw 0x18[$r0.1] = $r0.12   ## bblock 1, line 24, t8, 102(SI32)
	c0    call $l0.0 = FindMax   ## bblock 1, line 24,  raddr(FindMax)(P32),  10(SI32),  702(SI32),  422(SI32),  631(SI32),  834(SI32),  892(SI32),  104(SI32),  772(SI32)
;;								## 10
	c0    mov $r0.13 = 3   ## 3(SI32)
	c0    mov $r0.12 = 102   ## 102(SI32)
	c0    mov $r0.11 = 101   ## 101(SI32)
	c0    mov $r0.2 = 100   ## 100(SI32)
;;								## 11
	c0    mov $r0.16 = 6   ## 6(SI32)
	c0    mov $r0.15 = 5   ## 5(SI32)
	c0    mov $r0.14 = 4   ## 4(SI32)
	c0    mov $r0.17 = 7   ## 7(SI32)
;;								## 12
	c0    mov $r0.21 = 11   ## 11(SI32)
	c0    mov $r0.19 = 9   ## 9(SI32)
	c0    mov $r0.18 = 8   ## 8(SI32)
	c0    mov $r0.20 = 10   ## 10(SI32)
;;								## 13
	c0    stw 0x10[$r0.1] = $r0.2   ## bblock 2, line 25, t8, 100(SI32)
	c0    mov $r0.3 = 20   ## 20(SI32)
	c0    mov $r0.22 = 12   ## 12(SI32)
	c0    mov $r0.9 = 104   ## 104(SI32)
;;								## 14
	c0    mov $r0.4 = 702   ## 702(SI32)
	c0    mov $r0.5 = 422   ## 422(SI32)
...
;;								## 16
	...
	c0    mov $r0.10 = 772   ## 772(SI32)
;;								## 17
	c0    stw 0x14[$r0.1] = $r0.11   ## bblock 2, line 25, t8, 101(SI32)
;;								## 18
	c0    stw 0x18[$r0.1] = $r0.12   ## bblock 2, line 25, t8, 102(SI32)
;;								## 19
	c0    stw 0x1c[$r0.1] = $r0.13   ## bblock 2, line 25, t8, 3(SI32)
;;								## 20
	c0    stw 0x20[$r0.1] = $r0.14   ## bblock 2, line 25, t8, 4(SI32)
;;								## 21
	c0    stw 0x24[$r0.1] = $r0.15   ## bblock 2, line 25, t8, 5(SI32)
;;								## 22
	c0    stw 0x28[$r0.1] = $r0.16   ## bblock 2, line 25, t8, 6(SI32)
;;								## 23
	c0    stw 0x2c[$r0.1] = $r0.17   ## bblock 2, line 25, t8, 7(SI32)
;;								## 24
	c0    stw 0x30[$r0.1] = $r0.18   ## bblock 2, line 25, t8, 8(SI32)
;;								## 25
	c0    stw 0x34[$r0.1] = $r0.19   ## bblock 2, line 25, t8, 9(SI32)
;;								## 26
	c0    stw 0x38[$r0.1] = $r0.20   ## bblock 2, line 25, t8, 10(SI32)
;;								## 27
	c0    stw 0x3c[$r0.1] = $r0.21   ## bblock 2, line 25, t8, 11(SI32)
;;								## 28
.call FindMax, caller, arg($r0.1 + 16, 52; $r0.3:s32,$r0.4:s32,$r0.5:s32,$r0.6:s32,$r0.7:s32,$r0.8:s32,$r0.9:s32,$r0.10:s32,0:s32,4:s32,8:s32,12:s32,16:s32,20:s32,24:s32,28:s32,32:s32,36:s32,40:s32,44:s32,48:s32), ret($r0.3:s32)
	c0    stw 0x40[$r0.1] = $r0.22   ## bblock 2, line 25, t8, 12(SI32)
	c0    call $l0.0 = FindMax   ## bblock 2, line 25,  raddr(FindMax)(P32),  20(SI32),  702(SI32),  422(SI32),  631(SI32),  834(SI32),  892(SI32),  104(SI32),  772(SI32)
;;								## 29
.call printf, caller, arg($r0.3:u32,$r0.4:s32), ret($r0.3:s32)
	c0    call $l0.0 = printf   ## bblock 3, line 26,  raddr(printf)(P32),  addr(_?1STRINGVAR.1)(P32),  t2
	c0    mov $r0.3 = (_?1STRINGPACKET.1 + 0)   ## addr(_?1STRINGVAR.1)(P32)
	c0    mov $r0.4 = $r0.3   ## t2
;;								## 30
	c0    mov $r0.3 = $r0.0   ## 0(SI32)
	c0    ldw $l0.0 = 0x44[$r0.1]  ## restore ## t7
	      xnop 3
;;								## 34
.return ret($r0.3:s32)
	c0    return $r0.1 = $r0.1, (0x60), $l0.0   ## bblock 4, line 27,  t8,  ?2.2?2auto_size(I32),  t7
;;								## 35
.endp
.section .bss
.section .data
