...
entry:
  ...
  %call = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i32 0, i32 0), i32 %13, i32 %14)
...
if.then:                                          ; preds = %entry
  %17 = load i32, i32* %res1, align 4
  store i32 %17, i32* %retval
  br label %return

if.end:                                           ; preds = %entry
  %18 = load i32, i32* %res2, align 4
...
entry:
  ...
  %call1 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str1, i32 0, i32 0), i32 %call)
  ...
  %call3 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str1, i32 0, i32 0), i32 %call2)
  ret i32 0
}
