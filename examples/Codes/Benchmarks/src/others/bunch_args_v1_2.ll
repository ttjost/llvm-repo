...
entry:
  ...
  %call.i = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i32 0, i32 0), i32 %0, i32 %1, i32 %2, i32 %3, i32 %4) #1
  %call9.i = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str1, i32 0, i32 0), i32 %0, i32 %1, i32 %5, i32 %6, i32 %7, i32 %8, i32 %9, i32 %10) #1
  %cmp.i = icmp sgt i32 %add1.i, %add8.i
  %add1.add8.i = select i1 %cmp.i, i32 %add1.i, i32 %add8.i
  %call1 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str2, i32 0, i32 0), i32 %add1.add8.i) #1
  ...
  %call.i14 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i32 0, i32 0), i32 %11, i32 %12, i32 %13, i32 %14, i32 %15) #1
  %call9.i15 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str1, i32 0, i32 0), i32 %11, i32 %12, i32 %16, i32 %17, i32 %18, i32 %19, i32 %20, i32 %21) #1
  %cmp.i16 = icmp sgt i32 %add1.i7, %add8.i13
  %add1.add8.i17 = select i1 %cmp.i16, i32 %add1.i7, i32 %add8.i13
  %call3 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str2, i32 0, i32 0), i32 %add1.add8.i17) #1
  ret i32 0
}
