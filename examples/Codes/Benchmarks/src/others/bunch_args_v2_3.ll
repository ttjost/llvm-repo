...
entry:
  ...
  %call.i = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i32 0, i32 0), i32 %add1.i, i32 %add9.i) #1
  %cmp.i = icmp sgt i32 %add1.i, %add9.i
  %add1.add9.i = select i1 %cmp.i, i32 %add1.i, i32 %add9.i
  %call1 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str1, i32 0, i32 0), i32 %add1.add9.i) #1
  ...
  %call.i16 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i32 0, i32 0), i32 %add1.i7, i32 %add9.i15) #1
  %cmp.i17 = icmp sgt i32 %add1.i7, %add9.i15
  %add1.add9.i18 = select i1 %cmp.i17, i32 %add1.i7, i32 %add9.i15
  %call3 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str1, i32 0, i32 0), i32 %add1.add9.i18) #1
  ret i32 0
}
