...
;;
	c0	goto LBB1_2
;;
LBB1_5:                                 ## %getbit.exit.thread
                                        ##   in Loop: Header=BB1_2 Depth=1
	c0	stb 0[$r0.15] = $r0.16
;;
	c0	stw 0[$r0.14] = $r0.18
;;
LBB1_1:                                 ## %select.unfold
                                        ##   in Loop: Header=BB1_2 Depth=1
...
;;
	...
	c0	mov $r0.26 = nextbyte
;;
	c0	stw 16[$r0.1] = $r0.26
;;
	c0	stw 0[$r0.26] = $r0.63
...
;;
	...
	c0	mov $r0.15 = $r0.11
;;
LBB3_2:                                 ## %for.cond.outer.for.cond.outer.split_crit_edge.i
...
;;
	c0	goto LBB3_2
;;
LBB3_10:                                ## %getbit.exit17.thread.i
...
;;
	...
	c0	goto LBB3_27
;;
LBB3_26:                                ## %if.else.i251
                                        ##   in Loop: Header=BB3_15 Depth=1
	c0	add $r0.14 = $r0.63, 1
	c0	mov $r0.11 = 7
;;
	c0	stw 0[$r0.26] = $r0.14
;;
...
;;
	...
	c0	goto LBB3_86
;;
LBB3_37:                                ## %for.cond.outer.for.cond.outer.split_crit_edge.i196
                                        ##   Parent Loop BB3_15 Depth=1
                                        ## =>  This Loop Header: Depth=2
                                        ##       Child Loop BB3_38 Depth 3
	c0	mov $r0.12 = $r0.61
;;
LBB3_38:                                ## %for.body.i199
                                        ##   Parent Loop BB3_15 Depth=1
...
;;
	c0	goto LBB3_38
;;
LBB3_40:                                ## %getbit.exit.thread.i204
...
;;
	c0	goto LBB3_37
;;
LBB3_59:                                ## %for.cond.outer.for.cond.outer.split_crit_edge.i158
                                        ##   Parent Loop BB3_15 Depth=1
                                        ## =>  This Loop Header: Depth=2
                                        ##       Child Loop BB3_60 Depth 3
	c0	mov $r0.12 = $r0.61
;;
LBB3_60:                                ## %for.body.i161
                                        ##   Parent Loop BB3_15 Depth=1
...
;;
	c0	goto LBB3_60
;;
LBB3_62:                                ## %getbit.exit.thread.i166
...
;;
	c0	goto LBB3_59
;;
LBB3_45:                                ## %getbit.exit17.thread.i220
...
;;
	...
	c0	mov $r0.61 = $r0.11
;;
LBB3_46:                                ## %while.cond.i215.outer
                                        ##   Parent Loop BB3_15 Depth=1
                                        ## =>  This Loop Header: Depth=2
                                        ##       Child Loop BB3_43 Depth 3
	c0	goto LBB3_43
;;
LBB3_43:                                ## %while.cond.i215
                                        ##   Parent Loop BB3_15 Depth=1
...
;;
	c0	goto LBB3_86
;;
LBB3_67:                                ## %getbit.exit17.thread.i182
...
;;
	...
	c0	mov $r0.61 = $r0.11
;;
LBB3_68:                                ## %while.cond.i177.outer
                                        ##   Parent Loop BB3_15 Depth=1
                                        ## =>  This Loop Header: Depth=2
                                        ##       Child Loop BB3_65 Depth 3
	c0	goto LBB3_65
;;
LBB3_65:                                ## %while.cond.i177
                                        ##   Parent Loop BB3_15 Depth=1
...
;;
	...
	c0	mtb $b0.0 = $r0.12
;;
	c0	add $r0.58 = $r0.15, $r0.14
;;
	c0	stw 0[$r0.25] = $r0.58
	c0	mov $r0.20 = $r0.13
	c0	br $b0.0, LBB3_15
;;
## BB#89:                               ## %for.end90
