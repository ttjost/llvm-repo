...
entry:
  store i32 %datain, i32* @hexword, align 4, !tbaa !1
  store i8 0, i8* @s1, align 1, !tbaa !5
  store i8 0, i8* @s3, align 1, !tbaa !5
  %and.i = and i32 %datain, 1
  store i32 %and.i, i32* @parity, align 4, !tbaa !1
...
if.then.i:                                        ; preds = %while.body.i
  ...
  %3 = load i8, i8* %arrayidx.i, align 1, !tbaa !5
  %xor14.i = xor i8 %3, %2
  store i8 %xor14.i, i8* @s1, align 1, !tbaa !5
  %arrayidx4.i = getelementptr inbounds [31 x i8], [31 x i8]* @alpha3, i32 0, i32 %i.017.i
  %4 = load i8, i8* %arrayidx4.i, align 1, !tbaa !5
  %xor715.i = xor i8 %4, %1
  store i8 %xor715.i, i8* @s3, align 1, !tbaa !5
  %inc.i = add i32 %0, 1
  store i32 %inc.i, i32* @parity, align 4, !tbaa !1
  br label %if.end.i
...
if.then8:                                         ; preds = %if.else
  ...
  store i32 %xor.i57, i32* @hexword, align 4, !tbaa !1
  store i32 1, i32* @error_code, align 4, !tbaa !1
  br label %if.end38
...
if.else9:                                         ; preds = %if.else
  ...
  %22 = load i8, i8* %arrayidx14.i, align 1, !tbaa !5
  %xor.i59 = xor i8 %22, 1
...
if.else16:                                        ; preds = %if.else9
  ...
  %33 = load i8, i8* %arrayidx29, align 1, !tbaa !5
...
entry:
  store i8 0, i8* @s1, align 1, !tbaa !5
  store i8 0, i8* @s3, align 1, !tbaa !5
  %0 = load i32, i32* @hexword, align 4, !tbaa !1
  %and = and i32 %0, 1
  store i32 %and, i32* @parity, align 4, !tbaa !1
  br label %while.body
...
if.then:                                          ; preds = %while.body
  ...
  %xor14 = xor i8 %3, %4
  store i8 %xor14, i8* @s1, align 1, !tbaa !5
  %arrayidx4 = getelementptr inbounds [31 x i8], [31 x i8]* @alpha3, i32 0, i32 %i.017
  %5 = load i8, i8* %arrayidx4, align 1, !tbaa !5
  %xor715 = xor i8 %2, %5
  store i8 %xor715, i8* @s3, align 1, !tbaa !5
  %inc = add i32 %1, 1
  store i32 %inc, i32* @parity, align 4, !tbaa !1
  br label %if.end
...
while.end:                                        ; preds = %if.end
  ...
  store i32 %and9, i32* @parity, align 4, !tbaa !1
  ret void
}
...
entry:
  %0 = load i8, i8* @s1, align 1, !tbaa !5
  ...
  %2 = load i8, i8* @s3, align 1, !tbaa !5
  ...
  %14 = load i8, i8* %arrayidx14, align 1, !tbaa !5
  %xor = xor i8 %14, 1
  ret i8 %xor
}
...
entry:
  ...
  %shl = shl i32 1, %conv
  %xor = xor i32 %0, %shl
  store i32 %xor, i32* @hexword, align 4, !tbaa !1
  ret void
}
...
entry:
  ...
  %1 = load i8, i8* %arrayidx.1, align 1, !tbaa !5
  ...
  %2 = load i8, i8* %arrayidx.2, align 1, !tbaa !5
  ...
  %3 = load i8, i8* %arrayidx.3, align 1, !tbaa !5
...
entry:
  ...
  %0 = load i32, i32* %dptr, align 4, !tbaa !1
  br label %while.body
...
while.body:                                       ; preds = %while.body.backedge, %entry
  ...
  %1 = load i32, i32* %dptr.addr.053, align 4, !tbaa !1
...
while.body4:                                      ; preds = %while.body, %if.else
  ...
  %2 = load i8, i8* %arrayidx.i, align 1, !tbaa !5
  ...
  %3 = load i8, i8* %arrayidx.1.i, align 1, !tbaa !5
  ...
  %4 = load i8, i8* %arrayidx.2.i, align 1, !tbaa !5
  ...
  %5 = load i8, i8* %arrayidx.3.i, align 1, !tbaa !5
...
if.end:                                           ; preds = %while.body4
  ...
  %6 = load i8, i8* %arrayidx.i27, align 1, !tbaa !5
  ...
  %7 = load i8, i8* %arrayidx.1.i31, align 1, !tbaa !5
  ...
  %8 = load i8, i8* %arrayidx.2.i36, align 1, !tbaa !5
  ...
  %9 = load i8, i8* %arrayidx.3.i40, align 1, !tbaa !5
...
if.end:                                           ; preds = %entry
  ...
  %3 = load i8, i8* %arrayidx.i48, align 1, !tbaa !5
  ...
  %4 = load i8, i8* %arrayidx.1.i52, align 1, !tbaa !5
  ...
  %5 = load i8, i8* %arrayidx.2.i57, align 1, !tbaa !5
...
if.then3:                                         ; preds = %entry, %if.end
  ...
  %6 = load i32, i32* @error_code, align 4, !tbaa !1
...
if.then8:                                         ; preds = %if.then6
  ...
  %7 = load i8, i8* %arrayidx.i30, align 1, !tbaa !5
  ...
  %8 = load i8, i8* %arrayidx.1.i34, align 1, !tbaa !5
  ...
  %9 = load i8, i8* %arrayidx.2.i39, align 1, !tbaa !5
...
if.then13:                                        ; preds = %if.end11
  ...
  store i32 %conv, i32* @func, align 4, !tbaa !1
  br label %return
...
entry:
  %0 = load i32, i32* @error_code, align 4, !tbaa !1
  %cmp1 = icmp slt i32 %0, 3
  %shr.tr = trunc i32 %codeword to i8
  %conv = and i8 %shr.tr, 15
  br i1 %cmp1, label %if.then, label %if.else10.4
...
if.then6:                                         ; preds = %if.then
  ...
  store i8 %add21, i8* %arrayidx, align 1, !tbaa !5
  br label %if.then.1

if.else:                                          ; preds = %if.then
  %arrayidx9 = getelementptr inbounds [256 x i8], [256 x i8]* @msg, i32 0, i32 %i
  store i8 %conv, i8* %arrayidx9, align 1, !tbaa !5
  br label %if.then.1

if.then.1:                                        ; preds = %if.then6, %if.else
  %inc25 = add nsw i32 %i, 1
  %shr.126 = lshr i32 %codeword, 4
  %shr.tr.127 = trunc i32 %shr.126 to i8
  %conv.128 = and i8 %shr.tr.127, 15
  %cmp4.1 = icmp ult i8 %conv.128, 10
  br i1 %cmp4.1, label %if.then6.1, label %if.else.1

if.else.1:                                        ; preds = %if.then.1
  %arrayidx9.1 = getelementptr inbounds [256 x i8], [256 x i8]* @msg, i32 0, i32 %inc25
  store i8 %conv.128, i8* %arrayidx9.1, align 1, !tbaa !5
  br label %if.then.2

if.then6.1:                                       ; preds = %if.then.1
  %add21.1 = or i8 %conv.128, 48
  %arrayidx.1 = getelementptr inbounds [256 x i8], [256 x i8]* @msg, i32 0, i32 %inc25
  store i8 %add21.1, i8* %arrayidx.1, align 1, !tbaa !5
  br label %if.then.2

if.then.2:                                        ; preds = %if.then6.1, %if.else.1
  %inc.131 = add nsw i32 %i, 2
  %shr.232 = lshr i32 %codeword, 8
  %shr.tr.233 = trunc i32 %shr.232 to i8
  %conv.234 = and i8 %shr.tr.233, 15
  %cmp4.2 = icmp ult i8 %conv.234, 10
  br i1 %cmp4.2, label %if.then6.2, label %if.else.2

if.else.2:                                        ; preds = %if.then.2
  %arrayidx9.2 = getelementptr inbounds [256 x i8], [256 x i8]* @msg, i32 0, i32 %inc.131
  store i8 %conv.234, i8* %arrayidx9.2, align 1, !tbaa !5
  br label %if.then.3

if.then6.2:                                       ; preds = %if.then.2
  %add21.2 = or i8 %conv.234, 48
  %arrayidx.2 = getelementptr inbounds [256 x i8], [256 x i8]* @msg, i32 0, i32 %inc.131
  store i8 %add21.2, i8* %arrayidx.2, align 1, !tbaa !5
  br label %if.then.3

if.then.3:                                        ; preds = %if.then6.2, %if.else.2
  %inc.237 = add nsw i32 %i, 3
  %shr.338 = lshr i32 %codeword, 12
  %shr.tr.339 = trunc i32 %shr.338 to i8
  %conv.340 = and i8 %shr.tr.339, 15
  %cmp4.3 = icmp ult i8 %conv.340, 10
  br i1 %cmp4.3, label %if.then6.3, label %if.else.3

if.else.3:                                        ; preds = %if.then.3
  %arrayidx9.3 = getelementptr inbounds [256 x i8], [256 x i8]* @msg, i32 0, i32 %inc.237
  store i8 %conv.340, i8* %arrayidx9.3, align 1, !tbaa !5
  br label %if.then.4

if.then6.3:                                       ; preds = %if.then.3
  %add21.3 = or i8 %conv.340, 48
  %arrayidx.3 = getelementptr inbounds [256 x i8], [256 x i8]* @msg, i32 0, i32 %inc.237
  store i8 %add21.3, i8* %arrayidx.3, align 1, !tbaa !5
  br label %if.then.4

if.else10.4:                                      ; preds = %entry
  %arrayidx11 = getelementptr inbounds [256 x i8], [256 x i8]* @msg, i32 0, i32 %i
  store i8 -128, i8* %arrayidx11, align 1, !tbaa !5
  %inc = add nsw i32 %i, 1
  %arrayidx11.1 = getelementptr inbounds [256 x i8], [256 x i8]* @msg, i32 0, i32 %inc
  store i8 -128, i8* %arrayidx11.1, align 1, !tbaa !5
  %inc.1 = add nsw i32 %i, 2
  %arrayidx11.2 = getelementptr inbounds [256 x i8], [256 x i8]* @msg, i32 0, i32 %inc.1
  store i8 -128, i8* %arrayidx11.2, align 1, !tbaa !5
  %inc.2 = add nsw i32 %i, 3
  %arrayidx11.3 = getelementptr inbounds [256 x i8], [256 x i8]* @msg, i32 0, i32 %inc.2
  store i8 -128, i8* %arrayidx11.3, align 1, !tbaa !5
  %inc.3 = add nsw i32 %i, 4
  %arrayidx11.4 = getelementptr inbounds [256 x i8], [256 x i8]* @msg, i32 0, i32 %inc.3
  store i8 -128, i8* %arrayidx11.4, align 1, !tbaa !5
  br label %if.end12.4

if.then.4:                                        ; preds = %if.then6.3, %if.else.3
  %inc.343 = add nsw i32 %i, 4
  %shr.444 = lshr i32 %codeword, 16
  %shr.tr.445 = trunc i32 %shr.444 to i8
  %conv.446 = and i8 %shr.tr.445, 15
  %cmp4.4 = icmp ult i8 %conv.446, 10
  br i1 %cmp4.4, label %if.then6.4, label %if.else.4

if.else.4:                                        ; preds = %if.then.4
  %arrayidx9.4 = getelementptr inbounds [256 x i8], [256 x i8]* @msg, i32 0, i32 %inc.343
  store i8 %conv.446, i8* %arrayidx9.4, align 1, !tbaa !5
  br label %if.end12.4

if.then6.4:                                       ; preds = %if.then.4
  %add21.4 = or i8 %conv.446, 48
  %arrayidx.4 = getelementptr inbounds [256 x i8], [256 x i8]* @msg, i32 0, i32 %inc.343
  store i8 %add21.4, i8* %arrayidx.4, align 1, !tbaa !5
  br label %if.end12.4

if.end12.4:                                       ; preds = %if.then6.4, %if.else.4, %if.else10.4
  %1 = add i32 %i, 5
  ret i32 %1
}
...
entry:
  %0 = load i32, i32* @alpha_count, align 4, !tbaa !1
  %cmp = icmp sgt i32 %0, 0
  %1 = load i32, i32* @error_code, align 4, !tbaa !1
...
if.end:                                           ; preds = %if.then, %if.then3
  ...
  store i8 %storemerge39, i8* %arrayidx, align 1, !tbaa !5
  %inc = add nsw i32 %i, 1
...
while.cond.preheader:                             ; preds = %entry, %if.end
  ...
  br i1 %cmp12, label %if.then14.2, label %if.else18.2

if.else18.2:                                      ; preds = %while.cond.preheader
  %3 = getelementptr inbounds [256 x i8], [256 x i8]* @msg, i32 0, i32 %i.addr.0.ph
  store i8 -128, i8* %3, align 1
  %inc21 = add nsw i32 %i.addr.0.ph, 1
  %4 = getelementptr inbounds [256 x i8], [256 x i8]* @msg, i32 0, i32 %inc21
  store i8 -128, i8* %4, align 1
  br label %if.end20.2

if.then14.2:                                      ; preds = %while.cond.preheader
  %shr = lshr i32 %codeword, %char_shift.0.ph
  %shr.tr = trunc i32 %shr to i8
  %conv16 = and i8 %shr.tr, 127
  %5 = getelementptr inbounds [256 x i8], [256 x i8]* @msg, i32 0, i32 %i.addr.0.ph
  store i8 %conv16, i8* %5, align 1
  %inc2144 = add nsw i32 %i.addr.0.ph, 1
  %add = add nsw i32 %char_shift.0.ph, 7
  %shr.1 = lshr i32 %codeword, %add
  %shr.tr.1 = trunc i32 %shr.1 to i8
  %conv16.1 = and i8 %shr.tr.1, 127
  %6 = getelementptr inbounds [256 x i8], [256 x i8]* @msg, i32 0, i32 %inc2144
  store i8 %conv16.1, i8* %6, align 1
  %add.1 = add nsw i32 %char_shift.0.ph, 14
  %shr.2 = lshr i32 %codeword, %add.1
  %shr.tr.2 = trunc i32 %shr.2 to i8
  %conv16.2 = and i8 %shr.tr.2, 127
  br label %if.end20.2

if.end20.2:                                       ; preds = %if.then14.2, %if.else18.2
  %.sink43 = phi i8 [ %conv16.2, %if.then14.2 ], [ -128, %if.else18.2 ]
  %inc21.148 = add nsw i32 %i.addr.0.ph, 2
  %7 = getelementptr inbounds [256 x i8], [256 x i8]* @msg, i32 0, i32 %inc21.148
  store i8 %.sink43, i8* %7, align 1
  %8 = add i32 %i.addr.0.ph, 2
  %cmp23 = icmp eq i32 %0, 6
  %inc27 = add nsw i32 %0, 1
  %storemerge = select i1 %cmp23, i32 0, i32 %inc27
  store i32 %storemerge, i32* @alpha_count, align 4, !tbaa !1
  ret i32 %8
}
...
while.body.outer:                                 ; preds = %if.end39, %entry
  ...
  %incdec.ptr111 = getelementptr inbounds i32, i32* %dptr.addr.0.ph, i32 1
  %0 = load i32, i32* %dptr.addr.0.ph, align 4, !tbaa !1
  %cmp112 = icmp eq i32 %word_count.0.ph, 16
  br i1 %cmp112, label %if.then.lr.ph, label %if.else7

if.then.lr.ph:                                    ; preds = %while.body.outer
  %xor.i = xor i32 %0, 1045145627
  %idxprom.i = and i32 %xor.i, 255
  %arrayidx.i = getelementptr inbounds [256 x i8], [256 x i8]* @err_tab, i32 0, i32 %idxprom.i
  %1 = load i8, i8* %arrayidx.i, align 1, !tbaa !5
  %conv1.i = zext i8 %1 to i32
  %shr.i = lshr i32 %xor.i, 8
  %idxprom.1.i = and i32 %shr.i, 255
  %arrayidx.1.i = getelementptr inbounds [256 x i8], [256 x i8]* @err_tab, i32 0, i32 %idxprom.1.i
  %2 = load i8, i8* %arrayidx.1.i, align 1, !tbaa !5
  %conv1.1.i = zext i8 %2 to i32
  %add.1.i = add nuw nsw i32 %conv1.1.i, %conv1.i
  %shr.1.i = lshr i32 %xor.i, 16
  %idxprom.2.i = and i32 %shr.1.i, 255
  %arrayidx.2.i = getelementptr inbounds [256 x i8], [256 x i8]* @err_tab, i32 0, i32 %idxprom.2.i
  %3 = load i8, i8* %arrayidx.2.i, align 1, !tbaa !5
  %conv1.2.i = zext i8 %3 to i32
  %add.2.i = add nuw nsw i32 %add.1.i, %conv1.2.i
  %shr.2.i = lshr i32 %xor.i, 24
  %arrayidx.3.i = getelementptr inbounds [256 x i8], [256 x i8]* @err_tab, i32 0, i32 %shr.2.i
  %4 = load i8, i8* %arrayidx.3.i, align 1, !tbaa !5
...
while.body.backedge:                              ; preds = %if.then.lr.ph, %if.else5
  ...
  %5 = load i32, i32* %incdec.ptr111, align 4, !tbaa !1
  br label %if.else7
...
if.else7:                                         ; preds = %while.body.backedge, %while.body.outer
  ...
  %incdec.ptr.lcssa = phi i32* [ %incdec.ptr, %while.body.backedge ], [ %incdec.ptr111, %while.body.outer ]
...
if.then24:                                        ; preds = %if.else17
  ...
  %xor.i66 = xor i32 %shr, 173902
  %idxprom.i67 = and i32 %xor.i66, 255
  %arrayidx.i68 = getelementptr inbounds [256 x i8], [256 x i8]* @err_tab, i32 0, i32 %idxprom.i67
  %11 = load i8, i8* %arrayidx.i68, align 1, !tbaa !5
  %conv1.i69 = zext i8 %11 to i32
  %shr.i70 = lshr i32 %xor.i66, 8
  %idxprom.1.i71 = and i32 %shr.i70, 255
  %arrayidx.1.i72 = getelementptr inbounds [256 x i8], [256 x i8]* @err_tab, i32 0, i32 %idxprom.1.i71
  %12 = load i8, i8* %arrayidx.1.i72, align 1, !tbaa !5
  %conv1.1.i73 = zext i8 %12 to i32
  %add.1.i74 = add nuw nsw i32 %conv1.i69, %conv1.1.i73
  %shr.1.i75 = lshr i32 %xor.i66, 16
  %arrayidx.2.i77 = getelementptr inbounds [256 x i8], [256 x i8]* @err_tab, i32 0, i32 %shr.1.i75
  %13 = load i8, i8* %arrayidx.2.i77, align 1, !tbaa !5
  %conv1.2.i78 = zext i8 %13 to i32
  %add.3.i83 = sub nsw i32 0, %add.1.i74
  %tobool26 = icmp eq i32 %conv1.2.i78, %add.3.i83
  br i1 %tobool26, label %return, label %if.end30

if.end30:                                         ; preds = %if.then24
  %xor.i84 = xor i32 %shr, 119386
  %idxprom.i85 = and i32 %xor.i84, 255
  %arrayidx.i86 = getelementptr inbounds [256 x i8], [256 x i8]* @err_tab, i32 0, i32 %idxprom.i85
  %14 = load i8, i8* %arrayidx.i86, align 1, !tbaa !5
  %conv1.i87 = zext i8 %14 to i32
  %shr.i88 = lshr i32 %xor.i84, 8
  %idxprom.1.i89 = and i32 %shr.i88, 255
  %arrayidx.1.i90 = getelementptr inbounds [256 x i8], [256 x i8]* @err_tab, i32 0, i32 %idxprom.1.i89
  %15 = load i8, i8* %arrayidx.1.i90, align 1, !tbaa !5
  %conv1.1.i91 = zext i8 %15 to i32
  %add.1.i92 = add nuw nsw i32 %conv1.i87, %conv1.1.i91
  %shr.1.i93 = lshr i32 %xor.i84, 16
  %arrayidx.2.i95 = getelementptr inbounds [256 x i8], [256 x i8]* @err_tab, i32 0, i32 %shr.1.i93
  %16 = load i8, i8* %arrayidx.2.i95, align 1, !tbaa !5
  %conv1.2.i96 = zext i8 %16 to i32
  %add.3.i101 = sub nsw i32 0, %add.1.i92
  %cmp31 = icmp eq i32 %conv1.2.i96, %add.3.i101
...
if.end34:                                         ; preds = %if.end30, %if.else17
  ...
  %17 = load i32, i32* @func, align 4, !tbaa !1
...
sw.bb37:                                          ; preds = %if.end34
  %18 = load i32, i32* @alpha_count, align 4, !tbaa !1
...
if.then3.i:                                       ; preds = %if.then.i
  ...
  %19 = load i8, i8* %arrayidx.i61, align 1, !tbaa !5
...
if.end.i:                                         ; preds = %if.then3.i, %if.then.i
  ...
  store i8 %storemerge39.i, i8* %arrayidx.i61, align 1, !tbaa !5
...
while.cond.preheader.i:                           ; preds = %if.end.i, %sw.bb37
  ...
  br i1 %cmp23, label %if.then14.2.i, label %if.else18.2.i

if.else18.2.i:                                    ; preds = %while.cond.preheader.i
  %20 = getelementptr inbounds [256 x i8], [256 x i8]* @msg, i32 0, i32 %i.addr.0.ph.i
  store i8 -128, i8* %20, align 1
  %inc21.i = add nsw i32 %i.addr.0.ph.i, 1
  %21 = getelementptr inbounds [256 x i8], [256 x i8]* @msg, i32 0, i32 %inc21.i
  store i8 -128, i8* %21, align 1
  br label %alpha_proc.exit

if.then14.2.i:                                    ; preds = %while.cond.preheader.i
  %shr.i62 = lshr i32 %and, %char_shift.0.ph.i
  %shr.tr.i = trunc i32 %shr.i62 to i8
  %conv16.i = and i8 %shr.tr.i, 127
  %22 = getelementptr inbounds [256 x i8], [256 x i8]* @msg, i32 0, i32 %i.addr.0.ph.i
  store i8 %conv16.i, i8* %22, align 1
  %inc2144.i = add nsw i32 %i.addr.0.ph.i, 1
  %add.i = add nsw i32 %char_shift.0.ph.i, 7
  %shr.1.i63 = lshr i32 %and, %add.i
  %shr.tr.1.i = trunc i32 %shr.1.i63 to i8
  %conv16.1.i = and i8 %shr.tr.1.i, 127
  %23 = getelementptr inbounds [256 x i8], [256 x i8]* @msg, i32 0, i32 %inc2144.i
  store i8 %conv16.1.i, i8* %23, align 1
  %add.1.i64 = add nsw i32 %char_shift.0.ph.i, 14
  %shr.2.i65 = lshr i32 %and, %add.1.i64
  %shr.tr.2.i = trunc i32 %shr.2.i65 to i8
  %conv16.2.i = and i8 %shr.tr.2.i, 127
  br label %alpha_proc.exit

alpha_proc.exit:                                  ; preds = %if.else18.2.i, %if.then14.2.i
  %.sink43.i = phi i8 [ %conv16.2.i, %if.then14.2.i ], [ -128, %if.else18.2.i ]
  %inc21.148.i = add i32 %i.addr.0.ph.i, 2
  %24 = getelementptr inbounds [256 x i8], [256 x i8]* @msg, i32 0, i32 %inc21.148.i
  store i8 %.sink43.i, i8* %24, align 1
  %cmp23.i = icmp eq i32 %18, 6
  %inc27.i = add nsw i32 %18, 1
  %storemerge.i = select i1 %cmp23.i, i32 0, i32 %inc27.i
  store i32 %storemerge.i, i32* @alpha_count, align 4, !tbaa !1
  br label %if.end39

if.end39:                                         ; preds = %if.then11, %sw.bb, %alpha_proc.exit, %if.then8
  %i.1 = phi i32 [ %i.0.ph, %if.then8 ], [ %inc21.148.i, %alpha_proc.exit ], [ %call36, %sw.bb ], [ %i.0.ph, %if.then11 ]
...
define i32 @main() #0 {
entry:
  store i32 0, i32* @alpha_count, align 4, !tbaa !1
...
if.then2:                                         ; preds = %entry
  ...
  %0 = load i32, i32* @func, align 4, !tbaa !1
...
return:                                           ; preds = %entry, %if.then2, %for.inc, %if.then2.1, %for.inc.1
  %retval.0 = phi i32 [ %.24, %for.inc.1 ], [ 15, %if.then2.1 ], [ 15, %for.inc ], [ 15, %if.then2 ], [ 15, %entry ]
  ret i32 %retval.0

if.then2.1:                                       ; preds = %for.inc
  %call4.1 = tail call i32 @msg_proc(i32* %call.1)
  %1 = load i32, i32* @func, align 4, !tbaa !1
  switch i32 %1, label %return [
    i32 3, label %for.inc.1
    i32 0, label %for.inc.1
  ]

for.inc.1:                                        ; preds = %if.then2.1, %if.then2.1
  %call15 = tail call i32 @strncmp(i8* getelementptr inbounds ([256 x i8], [256 x i8]* @msg, i32 0, i32 0), i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str, i32 0, i32 0), i32 27) #3
...
; Function Attrs: nounwind readonly
declare i32 @strncmp(i8* nocapture, i8* nocapture, i32) #1
