...
.comment ""
.comment "-dir /home/jost/Dropbox/Universidade/Mestrado/vex-3.43 -S -o var_arg_hp.s"
.sversion 3.43
.rta 2
.section .bss
.align 32
...
;;								## 2
.call FindMax, caller, arg($r0.3:s32,$r0.4:s32,$r0.5:s32,$r0.6:s32,$r0.7:s32), ret($r0.3:s32)
	c0    call $l0.0 = FindMax   ## bblock 0, line 23,  raddr(FindMax)(P32),  4(SI32),  702(SI32),  422(SI32),  631(SI32),  834(SI32)
...
;;								## 8
.return ret($r0.3:s32)
	c0    return $r0.1 = $r0.1, (0x20), $l0.0   ## bblock 2, line 31,  t6,  ?2.2?2auto_size(I32),  t5
;;								## 9
.endp
.section .bss
.section .data
