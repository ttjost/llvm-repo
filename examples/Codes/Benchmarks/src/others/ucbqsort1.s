...
;;
	...
	c0	ldb $r0.15 = 0[$r0.62]
;;
	c0	stb 0[$r0.62] = $r0.13
...
;;
	...
	c0	br $b0.0, LBB2_9
;;
LBB2_7::                                ## %for.cond21.preheader
	c0	ldw $r0.62 = 0[$r0.58]
;;
	c0	ldw $r0.11 = 28[$r0.1]
;;
;;
	c0	cmpge $b0.0 = $r0.62, $r0.11
;;
;;
	c0	br $b0.0, LBB2_18
;;
## BB#8:                                ## %while.cond.preheader.lr.ph
	c0	add $r0.11 = $r0.57, $r0.62
;;
...
;;
;;
	c0	sub $r0.11 = $r0.12, $r0.60
;;
	c0	add $r0.11 = $r0.61, $r0.11
;;
	c0	cmpne $b0.0 = $r0.11, $r0.57
;;
;;
	c0	brf $b0.0, LBB2_13
;;
...
;;
;;
	c0	sub $r0.15 = $r0.16, $r0.14
;;
	c0	cmpgeu $b0.0 = $r0.15, $r0.11
	c0	mov $r0.14 = $r0.16
;;
;;
	c0	br $b0.0, LBB2_16
...
.section .text 
.proc 
.entry caller, sp=$r0.1, rl=$l0.0, asize=-64, arg() ## @qst
qst::
## BB#0:                                ## %entry
	c0	add $r0.1 = $r0.1, -64
;;
...
;;
	...
	c0	mtb $b0.0 = $r0.14
	c0	ldw $r0.17 = 28[$r0.1]
;;
;;
	c0	stw 28[$r0.1] = $r0.17
	c0	mtb $b0.1 = $r0.17
;;
;;
...
;;
;;
	c0	slct $r0.58 = $b0.0, $r0.63, $r0.60
	c0	ldw $r0.12 = 0[$r0.57]
;;
;;
	c0	sub $r0.59 = $r0.62, $r0.12
	c0	mov $r0.3 = $r0.58
;;
	c0	mov $r0.4 = $r0.59
;;
...
## BB#3:                                ## %if.then8
                                        ##   in Loop: Header=BB3_1 Depth=1
	c0	cmpeq $b0.0 = $r0.58, $r0.63
	c0	ldw $r0.11 = 0[$r0.61]
;;
;;
	c0	slct $r0.58 = $b0.0, $r0.60, $r0.63
;;
	c0	mov $r0.3 = $r0.58
	c0	mov $r0.4 = $r0.59
;;
...
;;
;;
	c0	slct $r0.58 = $b0.0, $r0.59, $r0.58
;;
LBB3_4::                                ## %if.end18
                                        ##   in Loop: Header=BB3_1 Depth=1
	c0	cmpeq $b0.0 = $r0.58, $r0.60
	c0	mov $r0.18 = $r0.62
;;
;;
	c0	br $b0.0, LBB3_7
...
;;
;;
	c0	sub $r0.58 = $r0.18, $r0.11
	c0	mov $r0.59 = $r0.18
	c0	mov $r0.11 = $r0.63
;;
LBB3_8::                                ## %while.cond.outer
                                        ##   Parent Loop BB3_1 Depth=1
                                        ## =>  This Loop Header: Depth=2
                                        ##       Child Loop BB3_9 Depth 3
                                        ##       Child Loop BB3_12 Depth 3
                                        ##       Child Loop BB3_19 Depth 3
	c0	cmpgeu $b0.0 = $r0.11, $r0.60
	c0	mov $r0.62 = $r0.11
;;
;;
	c0	br $b0.0, LBB3_10
...
;;
	c0	cmpltu $b0.0 = $r0.62, $r0.60
;;
;;
	c0	br $b0.0, LBB3_9
;;
LBB3_10::                               ## %while.cond32.preheader
                                        ##   in Loop: Header=BB3_8 Depth=2
	c0	cmpgtu $b0.0 = $r0.58, $r0.60
;;
;;
	c0	brf $b0.0, LBB3_16
;;
LBB3_12::                               ## %while.body34
                                        ##   Parent Loop BB3_1 Depth=1
                                        ##     Parent Loop BB3_8 Depth=2
                                        ## =>    This Inner Loop Header: Depth=3
	c0	ldw $r0.11 = 0[$r0.61]
...
LBB3_20::                               ## %for.end
	...
	c0	sub $r0.58 = $r0.60, $r0.63
	c0	mov $r0.13 = $r0.59
;;
	c0	sub $r0.59 = $r0.13, $r0.62
	c0	ldw $r0.11 = 24[$r0.1]
;;
;;
	c0	ldw $r0.11 = 0[$r0.11]
	c0	cmpgt $b0.0 = $r0.58, $r0.59
;;
;;
	c0	brf $b0.0, LBB3_21
;;
