...
;;
	c0	slct $r0.2 = $b0.0, $r0.2, $r0.4
;;
	c0	add $r0.4 = $r0.9, $r0.2
	c0	add $r0.2 = $r0.6, $r0.2
;;
	c0	max $r0.4 = $r0.2, $r0.4
;;
...
;;
	...
	c0	divs $r0.3, $b0.1 = $r0.3, $r0.2, $b0.1
	c0	addcg $r0.6, $b0.0 = $r0.9, $r0.9, $b0.0
;;
	c0	divs $r0.3, $b0.0 = $r0.3, $r0.2, $b0.0
...
;;
	c0	ldw $r0.8 = 0[$r0.8]
	c0	divs $r0.3, $b0.0 = $r0.3, $r0.2, $b0.0
	c0	addcg $r0.10, $b0.1 = $r0.6, $r0.6, $b0.1
;;
;;
	c0	mpylu $r0.6 = $r0.9, $r0.8
	c0	mpyhs $r0.8 = $r0.9, $r0.8
	c0	divs $r0.3, $b0.1 = $r0.3, $r0.2, $b0.1
	c0	addcg $r0.9, $b0.0 = $r0.10, $r0.10, $b0.0
;;
	c0	ldw $r0.10 = 32[$r0.1]
;;
;;
	c0	ldw $r0.10 = 0[$r0.10]
	c0	divs $r0.3, $b0.2 = $r0.3, $r0.2, $b0.0
	c0	addcg $r0.11, $b0.1 = $r0.9, $r0.9, $b0.1
	c0	cmpeq $b0.0 = $r0.4, $r0.7
;;
;;
	c0	add $r0.4 = $r0.5, $r0.10
	c0	divs $r0.3, $b0.1 = $r0.3, $r0.2, $b0.1
	c0	addcg $r0.5, $b0.2 = $r0.11, $r0.11, $b0.2
;;
...
;;
	c0	divs $r0.3, $b0.1 = $r0.3, $r0.2, $b0.1
	c0	addcg $r0.9, $b0.2 = $r0.7, $r0.7, $b0.2
;;
	c0	divs $r0.3, $b0.2 = $r0.3, $r0.2, $b0.2
	c0	addcg $r0.7, $b0.1 = $r0.9, $r0.9, $b0.1
	c0	add $r0.6 = $r0.6, $r0.8
	c0	add $r0.4 = $r0.4, $r0.5
;;
	c0	divs $r0.3, $b0.1 = $r0.3, $r0.2, $b0.1
	c0	addcg $r0.5, $b0.2 = $r0.7, $r0.7, $b0.2
;;
	c0	divs $r0.3, $b0.2 = $r0.3, $r0.2, $b0.2
	c0	addcg $r0.7, $b0.1 = $r0.5, $r0.5, $b0.1
	c0	ldw $r0.5 = 0[$r0.61]
...
;;
	...
	c0	divs $r0.3, $b0.1 = $r0.3, $r0.2, $b0.1
	c0	addcg $r0.6, $b0.2 = $r0.9, $r0.9, $b0.2
;;
	c0	divs $r0.3, $b0.2 = $r0.3, $r0.2, $b0.2
	c0	addcg $r0.7, $b0.1 = $r0.6, $r0.6, $b0.1
;;
	c0	divs $r0.3, $b0.1 = $r0.3, $r0.2, $b0.1
	c0	addcg $r0.6, $b0.2 = $r0.7, $r0.7, $b0.2
;;
	c0	divs $r0.3, $b0.2 = $r0.3, $r0.2, $b0.2
	c0	addcg $r0.7, $b0.1 = $r0.6, $r0.6, $b0.1
;;
