...
;;                                      ## 4-byte Folded Spill
	c0	add $r0.12 = $r0.0, -1374389535
;;
	c0	stw 76[$r0.1] = $r0.12
;;                                      ## 4-byte Folded Spill
	c0	mov $r0.12 = 1374389535
;;
	c0	stw 72[$r0.1] = $r0.12
;;                                      ## 4-byte Folded Spill
	c0	cmplt $r0.12 = $r0.0, 1374389535
;;
	c0	stw 92[$r0.1] = $r0.12
;;                                      ## 4-byte Folded Spill
	c0	add $r0.11 = $r0.11, 2796
;;
...
;;
	c0	add $r0.12 = $r0.58, 4
;;
	c0	mpylu $r0.14 = $r0.13, $r0.11
;;
...
;;
	c0	mtb $b0.0 = $r0.14
;;
	c0	slct $r0.13 = $b0.0, $r0.11, $r0.13
;;
	c0	ldw $r0.19 = 92[$r0.1]
;;                                      ## 4-byte Folded Reload
	c0	stw 92[$r0.1] = $r0.19
;;                                      ## 4-byte Folded Spill
	c0	mtb $b0.0 = $r0.19
;;
	c0	ldw $r0.15 = 76[$r0.1]
;;                                      ## 4-byte Folded Reload
	c0	ldw $r0.16 = 72[$r0.1]
;;                                      ## 4-byte Folded Reload
	c0	slct $r0.15 = $b0.0, $r0.16, $r0.15
;;
	c0	cmplt $b0.1 = $r0.59, 35
;;
	c0	mpyllu $r0.16 = $r0.13, $r0.15
;;
	c0	mpylhu $r0.17 = $r0.13, $r0.15
;;
	c0	ldw $r0.20 = 88[$r0.1]
;;                                      ## 4-byte Folded Reload
	c0	stw 88[$r0.1] = $r0.20
;;                                      ## 4-byte Folded Spill
	c0	cmpeq $b0.0 = $r0.61, $r0.20
;;
	c0	shru $r0.16 = $r0.16, 16
;;
	c0	mpyhhu $r0.13 = $r0.13, $r0.15
;;
...
;;
	c0	zxth $r0.15 = $r0.15
;;
	c0	ldw $r0.18 = 80[$r0.1]
;;                                      ## 4-byte Folded Reload
	c0	slct $r0.16 = $b0.0, $r0.18, $r0.16
;;
	c0	add $r0.15 = $r0.17, $r0.15
;;
	c0	add $r0.59 = $r0.16, $r0.59
;;
	c0	shru $r0.15 = $r0.15, 16
;;
	c0	add $r0.16 = $r0.61, 4
;;
	c0	add $r0.57 = $r0.57, 1
;;
	c0	add $r0.13 = $r0.13, $r0.15
;;
	c0	slct $r0.61 = $b0.0, $r0.20, $r0.16
;;
	c0	orc $r0.15 = $r0.13, $r0.0
;;
	c0	mtb $b0.1 = $r0.14
;;
	c0	slct $r0.13 = $b0.1, $r0.13, $r0.15
;;
	c0	orc $r0.14 = $r0.13, $r0.0
;;
	c0	slct $r0.58 = $b0.0, $r0.12, $r0.58
;;
	c0	mtb $b0.0 = $r0.19
;;
	c0	slct $r0.12 = $b0.0, $r0.13, $r0.14
;;
...
;;
	c0	cmpne $b0.0 = $r0.57, 700
;;
	c0	mfb $r0.14 = $b0.0
;;
	c0	stw 84[$r0.1] = $r0.14
;;
	c0	add $r0.62 = $r0.60, 4
;;
	c0	add $r0.63 = $r0.13, $r0.12
;;
	c0	ldw $r0.3 = 56[$r0.1]
;;                                      ## 4-byte Folded Reload
	c0	mov $r0.4 = $r0.11
...
;;
	c0	addcg $r0.14, $b0.1 = $r0.15, $r0.15, $b0.1
;;
	c0	divs $r0.13, $b0.4 = $r0.13, $r0.63, $b0.1
;;
	c0	addcg $r0.15, $b0.2 = $r0.14, $r0.14, $b0.2
;;
	c0	ldw $r0.14 = 36[$r0.1]
;;                                      ## 4-byte Folded Reload
	c0	cmpeq $b0.1 = $r0.61, $r0.14
;;
	c0	divs $r0.13, $b0.2 = $r0.13, $r0.63, $b0.2
;;
	c0	addcg $r0.14, $b0.4 = $r0.15, $r0.15, $b0.4
;;
	c0	divs $r0.13, $b0.4 = $r0.13, $r0.63, $b0.4
;;
	c0	addcg $r0.15, $b0.2 = $r0.14, $r0.14, $b0.2
;;
	c0	mfb $r0.14 = $b0.3
;;
	c0	divs $r0.13, $b0.2 = $r0.13, $r0.63, $b0.2
;;
	c0	addcg $r0.16, $b0.3 = $r0.15, $r0.15, $b0.4
;;
	c0	divs $r0.13, $b0.3 = $r0.13, $r0.63, $b0.3
;;
	c0	addcg $r0.15, $b0.2 = $r0.16, $r0.16, $b0.2
;;
	c0	divs $r0.13, $b0.2 = $r0.13, $r0.63, $b0.2
;;
	c0	addcg $r0.16, $b0.3 = $r0.15, $r0.15, $b0.3
;;
	c0	ldw $r0.15 = 28[$r0.1]
;;                                      ## 4-byte Folded Reload
	c0	slct $r0.14 = $b0.1, $r0.15, $r0.14
;;
	c0	divs $r0.13, $b0.3 = $r0.13, $r0.63, $b0.3
;;
	c0	addcg $r0.15, $b0.2 = $r0.16, $r0.16, $b0.2
...
;;
	c0	addcg $r0.14, $b0.2 = $r0.15, $r0.15, $b0.3
;;
	c0	cmpge $r0.13 = $r0.13, $r0.0
;;
	c0	orc $r0.14 = $r0.14, $r0.0
;;
	c0	add $r0.15 = $r0.61, 4
;;
	c0	sh1add $r0.13 = $r0.14, $r0.13
;;
	c0	slct $r0.61 = $b0.1, $r0.61, $r0.15
;;
...
;;
	c0	slct $r0.57 = $b0.1, $r0.11, $r0.57
;;
	c0	ldw $r0.3 = 24[$r0.1]
;;                                      ## 4-byte Folded Reload
	c0	mov $r0.4 = $r0.12
