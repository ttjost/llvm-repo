...
@.str = private unnamed_addr constant [4 x i8] c"-3\0A\00", align 1
@.str1 = private unnamed_addr constant [4 x i8] c"-2\0A\00", align 1
@.str2 = private unnamed_addr constant [5 x i8] c"666\0A\00", align 1
@.str3 = private unnamed_addr constant [4 x i8] c"-1\0A\00", align 1
...
if.then13:                                        ; preds = %lor.lhs.false9, %if.end
  %call14 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str1, i32 0, i32 0))
...
for.body19:                                       ; preds = %for.cond16
  ...
  %arrayidx21 = getelementptr inbounds [10 x i16], [10 x i16]* @pcmdata_2_ref, i32 0, i32 %9
...
if.then25:                                        ; preds = %for.body19
  %call26 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str2, i32 0, i32 0))
...
for.end30:                                        ; preds = %for.cond16
  %call31 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str3, i32 0, i32 0))
