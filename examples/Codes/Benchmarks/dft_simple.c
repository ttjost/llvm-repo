...
void sum_rot_block_row(ufp27p5_t powers[4][24])
{
    ...
    //{   /* Initialize accumulators */
     ...
     // for(i = 0; i < 24; i++) {
	      ...
	      fp_cospart += mulfp15p17(itofp15p17(rowsums[0]), dft_waves_cos[0]);		
	      fp_sinpart += mulfp15p17(itofp15p17(rowsums[0]), dft_waves_sin[0]);

		printf("%d    %d\n", fp_cospart, fp_sinpart);
//	  }
	  /* Power is the sum of the squared cos and sin components */
	 powers[0][0] = mulfp27p5(fp_cospart>>12, fp_cospart>>12) + mulfp27p5(fp_sinpart>>12, fp_sinpart>>12); /* FIXED-POINT */  
  //  }
}
