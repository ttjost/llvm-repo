...
define i32 @mul(i32 signext %a, i32 signext %b) #0 {
entry:
...
entry:
  ...
  %call = call i32 @mul(i32 signext 2, i32 signext 3)
  %call1 = call i32 @mul(i32 signext 2, i32 signext 3)
