...
; Function Attrs: nounwind
define internal void @x264_pixel_sad_x4_16x16(i8* %fenc, i8* %pix0, i8* %pix1, i8* %pix2, i8* %pix3, i32 signext %i_stride, i32* %scores) #1 {
entry:
  ...
  %call = call i32 @x264_pixel_sad_16x16(i8* %0, i32 signext 16, i8* %1, i32 signext %2)
  ...
  %call1 = call i32 @x264_pixel_sad_16x16(i8* %4, i32 signext 16, i8* %5, i32 signext %6)
  ...
  %call3 = call i32 @x264_pixel_sad_16x16(i8* %8, i32 signext 16, i8* %9, i32 signext %10)
  ...
  %call5 = call i32 @x264_pixel_sad_16x16(i8* %12, i32 signext 16, i8* %13, i32 signext %14)
...
; Function Attrs: nounwind
define internal i32 @x264_pixel_sad_16x16(i8* %pix1, i32 signext %i_stride_pix1, i8* %pix2, i32 signext %i_stride_pix2) #1 {
entry:
  %pix1.addr = alloca i8*, align 4
...
for.body3:                                        ; preds = %for.cond1
  ...
  %call = call i32 @abs(i32 signext %sub) #3
...
attributes #0 = { nounwind readnone "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="mips32r2" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #1 = { nounwind "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="mips32r2" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #2 = { "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="mips32r2" "unsafe-fp-math"="false" "use-soft-float"="false" }
