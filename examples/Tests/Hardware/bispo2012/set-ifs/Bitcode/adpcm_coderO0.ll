...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [513 x i32], [513 x i32]* @outres, i32 0, i32 %1
  %2 = load i32, i32* %arrayidx, align 4
  %3 = load i32, i32* %i, align 4
  %arrayidx1 = getelementptr inbounds [513 x i8], [513 x i8]* %outdata, i32 0, i32 %3
  %4 = load i8, i8* %arrayidx1, align 1
  %conv = sext i8 %4 to i32
  %cmp2 = icmp ne i32 %2, %conv
