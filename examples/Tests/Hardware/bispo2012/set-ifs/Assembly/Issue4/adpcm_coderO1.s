...
LBB0_3::                                ## %if.end16
                                        ##   in Loop: Header=BB0_1 Depth=1
	c0	shr $r0.32 = $r0.26, $r0.15
;;
	c0	cmpge $b0.0 = $r0.31, $r0.32
	c0	or $r0.26 = $r0.30, $r0.29
;;
;;
	c0	mfb $r0.29 = $b0.0
	c0	cmplt $b0.0 = $r0.31, $r0.32
;;
	c0	or $r0.26 = $r0.26, $r0.29
;;
	c0	sh2add $r0.29 = $r0.26, $r0.16
	c0	slct $r0.30 = $b0.0, $r0.11, $r0.32
;;
	c0	ldw $r0.29 = 0[$r0.29]
	c0	add $r0.28 = $r0.30, $r0.28
	c0	cmplt $b0.0 = $r0.27, 0
;;
	c0	sub $r0.27 = $r0.11, $r0.28
;;
	c0	add $r0.23 = $r0.29, $r0.23
	c0	slct $r0.27 = $b0.0, $r0.27, $r0.28
;;
...
LBB0_5::                                ## %if.else52
                                        ##   in Loop: Header=BB0_1 Depth=1
	c0	and $r0.26 = $r0.26, 15
	c0	add $r0.27 = $r0.22, 1
	c0	add $r0.22 = $r0.4, $r0.22
;;
	c0	or $r0.26 = $r0.26, $r0.20
;;
	c0	stb 0[$r0.22] = $r0.26
	c0	mov $r0.22 = $r0.27
;;
LBB0_6::                                ## %if.end57
                                        ##   in Loop: Header=BB0_1 Depth=1
	c0	slct $r0.25 = $b0.1, $r0.18, $r0.25
	c0	ldw $r0.26 = 0[$r0.24]
...
;;
	c0	stw 548[$r0.1] = $r0.59
;;
	c0	stw 544[$r0.1] = $l0.0
	c0	mov $r0.58 = outres
;;
	c0	mov $r0.57 = 0
...
;;
LBB1_2::                                ## %if.then
	c0	add $r0.11 = $r0.57, 10
;;
LBB1_4::                                ## %cleanup
	c0	mov $r0.3 = $r0.11
	c0	ldw $l0.0 = 544[$r0.1]
;;
	c0	ldw $r0.59 = 548[$r0.1]
;;
