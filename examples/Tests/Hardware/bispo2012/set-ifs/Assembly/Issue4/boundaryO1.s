...
;;
	c0	stw 80032[$r0.1] = $r0.60
;;
	c0	stw 80028[$r0.1] = $l0.0
	c0	mov $r0.59 = o_coord_ref
;;
	c0	mov $r0.57 = 0
	c0	add $r0.60 = $r0.1, 40028
...
;;
LBB1_2::                                ## %if.then
	c0	add $r0.12 = $r0.12, 10
	c0	goto LBB1_7
;;
LBB1_5::                                ## %if.then10
	c0	add $r0.12 = $r0.57, 10
;;
LBB1_7::                                ## %cleanup
	c0	mov $r0.3 = $r0.12
	c0	ldw $l0.0 = 80028[$r0.1]
;;
	c0	ldw $r0.60 = 80032[$r0.1]
;;
