...
.section .text 
.proc 
.entry caller, sp=$r0.1, rl=$l0.0, asize=-0, arg() ## @IMG_boundary_c
IMG_boundary_c::
## BB#0:                                ## %entry
...
## BB#3:                                ## %for.body3.lr.ph
	...
	c0	shl $r0.17 = $r0.14, $r0.12
	c0	mov $r0.18 = $r0.11
;;
LBB0_4::                                ## %for.body3
                                        ##   Parent Loop BB0_2 Depth=1
                                        ## =>  This Inner Loop Header: Depth=2
	c0	add $r0.19 = $r0.13, $r0.18
;;
...
## BB#5:                                ## %if.then
	...
	c0	zxth $r0.20 = $r0.18
;;
	c0	or $r0.20 = $r0.20, $r0.17
	c0	add $r0.21 = $r0.16, 4
	c0	add $r0.22 = $r0.15, 4
;;
	c0	stw 0[$r0.16] = $r0.20
;;
	c0	stw 0[$r0.15] = $r0.19
	c0	mov $r0.16 = $r0.21
	c0	mov $r0.15 = $r0.22
;;
LBB0_6::                                ## %for.inc
...
;;
	c0	cmpne $b0.1 = $r0.5, $r0.18
;;
;;
	c0	br $b0.1, LBB0_4
;;
## BB#7:                                ## %for.cond1.for.inc9_crit_edge
                                        ##   in Loop: Header=BB0_2 Depth=1
	c0	add $r0.13 = $r0.13, $r0.5
;;
LBB0_8::                                ## %for.inc9
                                        ##   in Loop: Header=BB0_2 Depth=1
	c0	add $r0.14 = $r0.14, 1
;;
	c0	cmpne $b0.1 = $r0.14, $r0.4
;;
;;
	c0	br $b0.1, LBB0_2
;;
...
.section .text 
.proc 
.entry caller, sp=$r0.1, rl=$l0.0, asize=-80032, arg() ## @main
main::
## BB#0:                                ## %entry
	c0	add $r0.1 = $r0.1, -80032
;;
	c0	add $r0.11 = $r0.1, 40016
...
LBB1_1::                                ## %for.cond1.preheader.i
	...
	c0	shl $r0.19 = $r0.17, $r0.16
	c0	mov $r0.20 = $r0.12
;;
LBB1_2::                                ## %for.body3.i
                                        ##   Parent Loop BB1_1 Depth=1
                                        ## =>  This Inner Loop Header: Depth=2
	c0	add $r0.21 = $r0.14, $r0.20
;;
...
## BB#3:                                ## %if.then.i
	...
	c0	or $r0.22 = $r0.20, $r0.19
	c0	add $r0.23 = $r0.18, 4
	c0	add $r0.24 = $r0.15, 4
;;
	c0	stw 0[$r0.18] = $r0.22
;;
...
;;
	c0	cmpne $b0.0 = $r0.20, 100
;;
;;
	c0	br $b0.0, LBB1_2
;;
## BB#5:                                ## %for.cond1.for.inc9_crit_edge.i
                                        ##   in Loop: Header=BB1_1 Depth=1
	c0	add $r0.17 = $r0.17, 1
	c0	add $r0.14 = $r0.14, 100
;;
	c0	cmpne $b0.0 = $r0.17, 100
;;
;;
	c0	br $b0.0, LBB1_1
;;
...
## BB#8:                                ## %for.inc
	...
	c0	mov $r0.14 = 0
;;
	c0	mov $r0.15 = o_grey_ref
	c0	cmplt $b0.0 = $r0.12, 9968
;;
...
;;
LBB1_7::                                ## %if.then
	c0	add $r0.11 = $r0.12, 10
	c0	goto LBB1_12
;;
LBB1_10::                               ## %if.then10
	c0	add $r0.11 = $r0.14, 10
;;
LBB1_12::                               ## %cleanup
.return ret($r0.3:s32)
	c0	mov $r0.3 = $r0.11
	c0	return $r0.1 = $r0.1, 80032, $l0.0
;;
.endp
