...
;;
	c0	stw 1048[$r0.1] = $r0.58
;;
	c0	stw 1044[$r0.1] = $l0.0
	c0	mov $r0.57 = 0
...
;;
	c0	mov $r0.12 = outdata_ref
	c0	mov $r0.11 = -1
;;
LBB1_1::                                ## %for.body
                                        ## =>This Inner Loop Header: Depth=1
	c0	add $r0.13 = $r0.58, $r0.57
	c0	add $r0.14 = $r0.12, $r0.57
;;
...
LBB1_4::                                ## %cleanup
	c0	mov $r0.3 = $r0.11
	c0	ldw $l0.0 = 1044[$r0.1]
;;
	c0	ldw $r0.58 = 1048[$r0.1]
;;
