...
LBB0_9::                                ## %vector.body
	...
	c0	ldw $r0.29 = 8[$r0.26]
	c0	ldw $r0.30 = -8[$r0.27]
	c0	ldw $r0.31 = -4[$r0.27]
	c0	ldw $r0.32 = 4[$r0.26]
;;
	c0	mpyhs $r0.33 = $r0.30, $r0.32
	c0	mpylu $r0.30 = $r0.30, $r0.32
	c0	ldw $r0.32 = 0[$r0.26]
	c0	ldw $r0.34 = 12[$r0.26]
;;
	c0	mpylu $r0.35 = $r0.31, $r0.32
	c0	mpyhs $r0.31 = $r0.31, $r0.32
	c0	add $r0.30 = $r0.30, $r0.33
	c0	ldw $r0.32 = 4[$r0.27]
;;
	c0	add $r0.31 = $r0.35, $r0.31
	c0	ldw $r0.33 = -8[$r0.26]
	c0	ldw $r0.35 = -16[$r0.27]
	c0	ldw $r0.36 = -16[$r0.26]
;;
	c0	mpylu $r0.37 = $r0.32, $r0.33
	c0	mpylu $r0.38 = $r0.35, $r0.34
	c0	ldw $r0.39 = 12[$r0.27]
	c0	ldw $r0.40 = -12[$r0.26]
;;
	c0	mpyhs $r0.34 = $r0.35, $r0.34
	c0	mpyhs $r0.32 = $r0.32, $r0.33
	c0	ldw $r0.33 = 8[$r0.27]
	c0	ldw $r0.35 = -4[$r0.26]
;;
	c0	mpylu $r0.41 = $r0.39, $r0.36
	c0	mpylu $r0.42 = $r0.33, $r0.40
	c0	add $r0.32 = $r0.37, $r0.32
	c0	add $r0.34 = $r0.38, $r0.34
;;
	c0	mpyhs $r0.33 = $r0.33, $r0.40
	c0	mpyhs $r0.36 = $r0.39, $r0.36
	c0	ldw $r0.37 = -12[$r0.27]
	c0	ldw $r0.38 = 0[$r0.27]
;;
	c0	mpylu $r0.39 = $r0.37, $r0.29
	c0	mpylu $r0.40 = $r0.38, $r0.35
	c0	add $r0.33 = $r0.42, $r0.33
	c0	add $r0.36 = $r0.41, $r0.36
;;
	c0	mpyhs $r0.35 = $r0.38, $r0.35
	c0	mpyhs $r0.29 = $r0.37, $r0.29
;;
	c0	add $r0.29 = $r0.39, $r0.29
	c0	add $r0.35 = $r0.40, $r0.35
	c0	add $r0.23 = $r0.30, $r0.23
	c0	add $r0.19 = $r0.33, $r0.19
;;
	c0	add $r0.22 = $r0.31, $r0.22
	c0	add $r0.18 = $r0.36, $r0.18
	c0	add $r0.24 = $r0.29, $r0.24
	c0	add $r0.20 = $r0.32, $r0.20
;;
	c0	add $r0.25 = $r0.34, $r0.25
	c0	add $r0.21 = $r0.35, $r0.21
	c0	add $r0.27 = $r0.27, -32
	c0	add $r0.26 = $r0.26, 32
;;
	c0	add $r0.28 = $r0.28, -8
;;
	c0	cmpne $b0.2 = $r0.28, 0
	c0	mov $r0.29 = $r0.12
;;
	c0	br $b0.2, LBB0_9
;;
...
;;
	...
	c0	ldw $r0.14 = 60[$r0.27]
	c0	ldw $r0.15 = 0[$r0.27]
;;
	c0	ldw $r0.16 = 48[$r0.27]
	c0	ldw $r0.17 = 36[$r0.27]
	c0	ldw $r0.18 = 44[$r0.27]
	c0	ldw $r0.19 = 40[$r0.27]
;;
	c0	ldw $r0.20 = 32[$r0.27]
	c0	ldw $r0.21 = 20[$r0.27]
	c0	ldw $r0.22 = 28[$r0.27]
	c0	ldw $r0.23 = 24[$r0.27]
;;
	c0	ldw $r0.24 = 16[$r0.27]
	c0	ldw $r0.25 = 8[$r0.27]
	c0	ldw $r0.26 = 12[$r0.27]
...
;;
	c0	mpyhs $r0.31 = $r0.30, $r0.15
	c0	mpylu $r0.30 = $r0.30, $r0.15
	c0	ldw $r0.32 = 72[$r0.29]
;;
	c0	mpylu $r0.33 = $r0.32, $r0.27
	c0	mpyhs $r0.34 = $r0.32, $r0.15
	c0	add $r0.30 = $r0.30, $r0.31
;;
	c0	mpylu $r0.31 = $r0.32, $r0.15
	c0	mpyhs $r0.32 = $r0.32, $r0.27
;;
	c0	add $r0.31 = $r0.31, $r0.34
	c0	add $r0.32 = $r0.33, $r0.32
	c0	ldw $r0.33 = 68[$r0.29]
;;
	c0	mpyhs $r0.34 = $r0.33, $r0.27
	c0	mpylu $r0.35 = $r0.33, $r0.15
	c0	add $r0.30 = $r0.32, $r0.30
;;
	c0	mpyhs $r0.32 = $r0.33, $r0.15
	c0	mpylu $r0.36 = $r0.33, $r0.27
;;
	c0	mpylu $r0.37 = $r0.33, $r0.25
	c0	add $r0.32 = $r0.35, $r0.32
	c0	add $r0.34 = $r0.36, $r0.34
	c0	mpyhs $r0.33 = $r0.33, $r0.25
;;
	c0	add $r0.31 = $r0.34, $r0.31
	c0	add $r0.33 = $r0.37, $r0.33
	c0	ldw $r0.34 = 60[$r0.29]
	c0	ldw $r0.35 = 64[$r0.29]
;;
	c0	mpylu $r0.36 = $r0.34, $r0.27
	c0	mpylu $r0.37 = $r0.35, $r0.15
	c0	add $r0.30 = $r0.33, $r0.30
;;
	c0	mpyhs $r0.33 = $r0.35, $r0.15
	c0	mpyhs $r0.38 = $r0.35, $r0.27
;;
	c0	mpylu $r0.39 = $r0.35, $r0.27
	c0	mpyhs $r0.40 = $r0.34, $r0.27
	c0	add $r0.33 = $r0.37, $r0.33
;;
	c0	mpylu $r0.37 = $r0.35, $r0.25
	c0	add $r0.36 = $r0.36, $r0.40
	c0	mpyhs $r0.40 = $r0.35, $r0.25
	c0	add $r0.38 = $r0.39, $r0.38
;;
	c0	mpylu $r0.39 = $r0.34, $r0.25
	c0	mpyhs $r0.41 = $r0.34, $r0.25
	c0	add $r0.33 = $r0.36, $r0.33
	c0	add $r0.32 = $r0.38, $r0.32
;;
	c0	mpylu $r0.36 = $r0.34, $r0.26
	c0	add $r0.38 = $r0.39, $r0.41
	c0	mpyhs $r0.39 = $r0.34, $r0.26
	c0	add $r0.37 = $r0.37, $r0.40
;;
	c0	mpyhs $r0.40 = $r0.35, $r0.26
	c0	mpylu $r0.35 = $r0.35, $r0.26
	c0	add $r0.32 = $r0.38, $r0.32
	c0	add $r0.36 = $r0.36, $r0.39
;;
	c0	mpylu $r0.38 = $r0.34, $r0.24
	c0	add $r0.31 = $r0.37, $r0.31
	c0	mpyhs $r0.34 = $r0.34, $r0.24
	c0	add $r0.35 = $r0.35, $r0.40
;;
	c0	add $r0.31 = $r0.36, $r0.31
	c0	add $r0.30 = $r0.35, $r0.30
	c0	add $r0.34 = $r0.38, $r0.34
	c0	ldw $r0.35 = 56[$r0.29]
;;
	c0	mpylu $r0.36 = $r0.35, $r0.25
	c0	mpyhs $r0.37 = $r0.35, $r0.25
	c0	add $r0.30 = $r0.34, $r0.30
;;
	c0	add $r0.34 = $r0.36, $r0.37
	c0	mpylu $r0.36 = $r0.35, $r0.26
	c0	mpyhs $r0.37 = $r0.35, $r0.26
;;
	c0	add $r0.33 = $r0.34, $r0.33
	c0	mpylu $r0.34 = $r0.35, $r0.24
	c0	add $r0.36 = $r0.36, $r0.37
	c0	mpyhs $r0.37 = $r0.35, $r0.24
;;
	c0	add $r0.32 = $r0.36, $r0.32
	c0	add $r0.34 = $r0.34, $r0.37
	c0	mpyhs $r0.36 = $r0.35, $r0.21
	c0	mpylu $r0.35 = $r0.35, $r0.21
;;
	c0	add $r0.31 = $r0.34, $r0.31
	c0	ldw $r0.34 = 52[$r0.29]
;;
	c0	mpylu $r0.37 = $r0.34, $r0.26
	c0	mpyhs $r0.38 = $r0.34, $r0.26
	c0	add $r0.35 = $r0.35, $r0.36
;;
	c0	add $r0.36 = $r0.37, $r0.38
	c0	mpylu $r0.37 = $r0.34, $r0.24
	c0	mpyhs $r0.38 = $r0.34, $r0.24
	c0	add $r0.30 = $r0.35, $r0.30
;;
	c0	add $r0.35 = $r0.37, $r0.38
	c0	add $r0.33 = $r0.36, $r0.33
	c0	mpyhs $r0.36 = $r0.34, $r0.21
	c0	mpylu $r0.37 = $r0.34, $r0.21
;;
	c0	add $r0.32 = $r0.35, $r0.32
	c0	add $r0.35 = $r0.37, $r0.36
;;
	c0	add $r0.31 = $r0.35, $r0.31
	c0	mpyhs $r0.35 = $r0.34, $r0.23
	c0	mpylu $r0.34 = $r0.34, $r0.23
	c0	ldw $r0.36 = 48[$r0.29]
;;
	c0	mpylu $r0.37 = $r0.36, $r0.24
	c0	mpyhs $r0.38 = $r0.36, $r0.24
	c0	add $r0.34 = $r0.34, $r0.35
;;
	c0	add $r0.35 = $r0.37, $r0.38
	c0	mpyhs $r0.37 = $r0.36, $r0.21
	c0	mpylu $r0.38 = $r0.36, $r0.21
	c0	add $r0.30 = $r0.34, $r0.30
;;
	c0	mpylu $r0.34 = $r0.36, $r0.23
...
;;
	c0	add $r0.31 = $r0.34, $r0.31
	c0	mpyhs $r0.34 = $r0.36, $r0.22
	c0	mpylu $r0.35 = $r0.36, $r0.22
...
;;
	c0	mpyhs $r0.35 = $r0.36, $r0.23
	c0	add $r0.37 = $r0.37, $r0.38
	c0	mpylu $r0.38 = $r0.36, $r0.23
	c0	add $r0.30 = $r0.34, $r0.30
;;
	c0	mpylu $r0.34 = $r0.36, $r0.22
	c0	add $r0.33 = $r0.37, $r0.33
	c0	mpyhs $r0.37 = $r0.36, $r0.22
...
;;
	c0	add $r0.31 = $r0.34, $r0.31
	c0	mpyhs $r0.34 = $r0.36, $r0.20
	c0	mpylu $r0.35 = $r0.36, $r0.20
...
;;
	c0	add $r0.35 = $r0.37, $r0.38
	c0	mpyhs $r0.37 = $r0.36, $r0.20
	c0	mpylu $r0.38 = $r0.36, $r0.20
	c0	add $r0.30 = $r0.34, $r0.30
;;
	c0	mpylu $r0.34 = $r0.36, $r0.17
	c0	add $r0.37 = $r0.38, $r0.37
...
;;
	...
	c0	mpylu $r0.38 = $r0.36, $r0.17
	c0	add $r0.30 = $r0.34, $r0.30
;;
	c0	mpylu $r0.34 = $r0.36, $r0.19
	c0	add $r0.37 = $r0.38, $r0.37
...
;;
	...
	c0	add $r0.34 = $r0.35, $r0.34
;;
	c0	mpyhs $r0.35 = $r0.36, $r0.19
	c0	add $r0.37 = $r0.37, $r0.38
	c0	mpylu $r0.38 = $r0.36, $r0.19
	c0	add $r0.30 = $r0.34, $r0.30
;;
	c0	mpylu $r0.34 = $r0.36, $r0.18
	c0	add $r0.33 = $r0.37, $r0.33
	c0	mpyhs $r0.37 = $r0.36, $r0.18
	c0	add $r0.35 = $r0.38, $r0.35
;;
	c0	add $r0.34 = $r0.34, $r0.37
	c0	add $r0.32 = $r0.35, $r0.32
...
;;
	...
	c0	add $r0.34 = $r0.35, $r0.34
;;
	c0	mpyhs $r0.35 = $r0.36, $r0.18
	c0	add $r0.37 = $r0.37, $r0.38
	c0	mpylu $r0.38 = $r0.36, $r0.18
	c0	add $r0.30 = $r0.34, $r0.30
;;
	c0	mpylu $r0.34 = $r0.36, $r0.16
	c0	add $r0.33 = $r0.37, $r0.33
	c0	mpyhs $r0.37 = $r0.36, $r0.16
	c0	add $r0.35 = $r0.38, $r0.35
;;
	c0	add $r0.34 = $r0.34, $r0.37
	c0	add $r0.32 = $r0.35, $r0.32
	c0	mpyhs $r0.35 = $r0.36, $r0.13
	c0	mpylu $r0.36 = $r0.36, $r0.13
;;
	c0	add $r0.31 = $r0.34, $r0.31
	c0	ldw $r0.34 = 20[$r0.29]
;;
	c0	mpylu $r0.37 = $r0.34, $r0.18
	c0	mpyhs $r0.38 = $r0.34, $r0.18
	c0	add $r0.35 = $r0.36, $r0.35
;;
	c0	mpylu $r0.36 = $r0.34, $r0.16
	c0	add $r0.37 = $r0.37, $r0.38
	c0	mpyhs $r0.38 = $r0.34, $r0.16
	c0	add $r0.30 = $r0.35, $r0.30
;;
	c0	add $r0.35 = $r0.36, $r0.38
	c0	add $r0.33 = $r0.37, $r0.33
	c0	mpyhs $r0.36 = $r0.34, $r0.13
	c0	mpylu $r0.37 = $r0.34, $r0.13
;;
	c0	add $r0.32 = $r0.35, $r0.32
	c0	add $r0.35 = $r0.37, $r0.36
	c0	mpyhs $r0.36 = $r0.34, $r0.12
	c0	mpylu $r0.34 = $r0.34, $r0.12
;;
	c0	add $r0.31 = $r0.35, $r0.31
	c0	ldw $r0.35 = 4[$r0.29]
	c0	add $r0.34 = $r0.34, $r0.36
;;
	c0	mpylu $r0.36 = $r0.35, $r0.14
	c0	mpyhs $r0.35 = $r0.35, $r0.14
	c0	ldw $r0.37 = 8[$r0.29]
;;
	c0	mpylu $r0.38 = $r0.37, $r0.12
	c0	mpyhs $r0.39 = $r0.37, $r0.12
	c0	add $r0.35 = $r0.36, $r0.35
	c0	ldw $r0.36 = 12[$r0.29]
;;
	c0	mpylu $r0.40 = $r0.36, $r0.13
	c0	mpyhs $r0.41 = $r0.36, $r0.13
	c0	add $r0.38 = $r0.38, $r0.39
	c0	add $r0.30 = $r0.34, $r0.30
;;
	c0	add $r0.34 = $r0.40, $r0.41
	c0	mpyhs $r0.39 = $r0.36, $r0.12
	c0	mpylu $r0.40 = $r0.36, $r0.12
	c0	ldw $r0.41 = 16[$r0.29]
;;
	c0	mpylu $r0.29 = $r0.41, $r0.16
	c0	mpyhs $r0.42 = $r0.41, $r0.16
	c0	add $r0.39 = $r0.40, $r0.39
;;
	c0	add $r0.40 = $r0.29, $r0.42
	c0	mpyhs $r0.42 = $r0.41, $r0.13
	c0	mpylu $r0.43 = $r0.41, $r0.13
;;
	c0	mov $r0.29 = y
	c0	add $r0.42 = $r0.43, $r0.42
	c0	add $r0.33 = $r0.40, $r0.33
;;
	c0	mpyhs $r0.40 = $r0.41, $r0.12
	c0	mpylu $r0.43 = $r0.41, $r0.12
;;
	c0	mpylu $r0.44 = $r0.36, $r0.14
	c0	add $r0.40 = $r0.43, $r0.40
	c0	mpyhs $r0.36 = $r0.36, $r0.14
	c0	add $r0.32 = $r0.42, $r0.32
;;
	c0	mpylu $r0.42 = $r0.37, $r0.14
	c0	mpyhs $r0.43 = $r0.41, $r0.14
	c0	add $r0.33 = $r0.34, $r0.33
	c0	add $r0.31 = $r0.40, $r0.31
;;
	c0	mpyhs $r0.34 = $r0.37, $r0.14
	c0	mpylu $r0.37 = $r0.41, $r0.14
	c0	add $r0.33 = $r0.38, $r0.33
	c0	add $r0.32 = $r0.39, $r0.32
;;
	c0	add $r0.37 = $r0.37, $r0.43
	c0	add $r0.34 = $r0.42, $r0.34
	c0	add $r0.36 = $r0.44, $r0.36
	c0	add $r0.33 = $r0.35, $r0.33
;;
	c0	add $r0.35 = $r0.37, $r0.30
	c0	add $r0.31 = $r0.36, $r0.31
	c0	add $r0.32 = $r0.34, $r0.32
	c0	add $r0.34 = $r0.29, $r0.28
;;
	c0	add $r0.28 = $r0.28, 16
	c0	mov $r0.30 = y_ref
	c0	stw 12[$r0.34] = $r0.35
;;
	c0	stw 8[$r0.34] = $r0.31
	c0	stw 4[$r0.34] = $r0.32
	c0	stw 0[$r0.34] = $r0.33
;;
...
LBB1_2::                                ## %for.body
                                        ## =>This Inner Loop Header: Depth=1
	c0	ldw $r0.12 = 0[$r0.30]
	c0	ldw $r0.13 = 0[$r0.29]
;;
