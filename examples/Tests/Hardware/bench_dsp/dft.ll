...
@.str = private unnamed_addr constant [30 x i8] c"Failed to complete: %d != %d\0A\00", align 1
...
entry:
  ...
  %shr.i60 = lshr i32 %mul3, 16
  %shl9.i62 = shl i32 %mul3, 16
  %add.i50 = add i32 %shl9.i62, %mul
  %cmp.i51 = icmp ult i32 %add.i50, %mul
  %cmp8.i52 = icmp ult i32 %add.i50, %shl9.i62
  %or.cond.i53 = or i1 %cmp.i51, %cmp8.i52
  %z2.0.i54 = zext i1 %or.cond.i53 to i32
  %shr.i = lshr i32 %mul4, 16
  %shl9.i = shl i32 %mul4, 16
  %add.i37 = add i32 %add.i50, %shl9.i
  %cmp.i38 = icmp ult i32 %add.i37, %add.i50
  %cmp8.i39 = icmp ult i32 %add.i37, %shl9.i
  %or.cond.i40 = or i1 %cmp.i38, %cmp8.i39
  %z2.0.i41 = zext i1 %or.cond.i40 to i32
  %add10.i56 = add i32 %shr.i60, %mul5
  %add9.i42 = add i32 %add10.i56, %shr.i
  %add10.i43 = add i32 %add9.i42, %z2.0.i54
  %add9.i = add i32 %add10.i43, %z2.0.i41
  %tmp24.sroa.2.0.insert.ext = zext i32 %add.i37 to i64
  %tmp24.sroa.2.0.insert.shift = shl nuw i64 %tmp24.sroa.2.0.insert.ext, 32
  %tmp24.sroa.0.0.insert.ext = zext i32 %add9.i to i64
  %tmp24.sroa.0.0.insert.insert = or i64 %tmp24.sroa.0.0.insert.ext, %tmp24.sroa.2.0.insert.shift
  %0 = bitcast %struct.int_64_t* %agg.result to i64*
  store i64 %tmp24.sroa.0.0.insert.insert, i64* %0, align 4
  ret void
}
...
entry:
  ...
  %shr.i60.i = lshr i32 %mul3.i, 16
  %shl9.i62.i = shl i32 %mul3.i, 16
  %add.i50.i = add i32 %shl9.i62.i, %mul.i
  %cmp.i51.i = icmp ult i32 %add.i50.i, %mul.i
  %cmp8.i52.i = icmp ult i32 %add.i50.i, %shl9.i62.i
  %or.cond.i53.i = or i1 %cmp.i51.i, %cmp8.i52.i
  %z2.0.i54.i = zext i1 %or.cond.i53.i to i32
  %shr.i.i = lshr i32 %mul4.i, 16
  %shl9.i.i = shl i32 %mul4.i, 16
  %add.i37.i = add i32 %add.i50.i, %shl9.i.i
  %cmp.i38.i = icmp ult i32 %add.i37.i, %add.i50.i
  %cmp8.i39.i = icmp ult i32 %add.i37.i, %shl9.i.i
  %or.cond.i40.i = or i1 %cmp.i38.i, %cmp8.i39.i
  %z2.0.i41.i = zext i1 %or.cond.i40.i to i32
  %add10.i56.i = add i32 %shr.i60.i, %mul5.i
  %add9.i42.i = add i32 %add10.i56.i, %shr.i.i
  %add10.i43.i = add i32 %add9.i42.i, %z2.0.i54.i
  %add9.i.i = add i32 %add10.i43.i, %z2.0.i41.i
  %tobool = icmp slt i32 %v1.lobit16, 0
  br i1 %tobool, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %neg.i = xor i32 %add.i37.i, -1
  %neg4.i = xor i32 %add9.i.i, -1
  %add.i.i = sub i32 0, %add.i37.i
  %cmp.i.i = icmp ult i32 %add.i.i, %neg.i
  %cmp8.i.i = icmp eq i32 %add.i37.i, 0
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %product.sroa.4.0 = phi i32 [ %add.i.i, %if.then ], [ %add.i37.i, %entry ]
...
middle.block:                                     ; preds = %vector.body
  ...
  %shr.i60.i.i124 = lshr i32 %mul3.i.i121, 16
  %shl9.i62.i.i125 = shl i32 %mul3.i.i121, 16
  %add.i50.i.i126 = add i32 %shl9.i62.i.i125, %mul.i.i120
  %cmp.i51.i.i127 = icmp ult i32 %add.i50.i.i126, %mul.i.i120
  %cmp8.i52.i.i128 = icmp ult i32 %add.i50.i.i126, %shl9.i62.i.i125
  %or.cond.i53.i.i129 = or i1 %cmp.i51.i.i127, %cmp8.i52.i.i128
  %z2.0.i54.i.i130 = zext i1 %or.cond.i53.i.i129 to i32
  %add.i37.i.i133 = add i32 %add.i50.i.i126, %shl9.i62.i.i125
  %cmp.i38.i.i134 = icmp ult i32 %add.i37.i.i133, %add.i50.i.i126
  %cmp8.i39.i.i135 = icmp ult i32 %add.i37.i.i133, %shl9.i62.i.i125
  %or.cond.i40.i.i136 = or i1 %cmp.i38.i.i134, %cmp8.i39.i.i135
  %z2.0.i41.i.i137 = zext i1 %or.cond.i40.i.i136 to i32
  %factor = shl nuw nsw i32 %shr.i60.i.i124, 1
  %add9.i42.i.i139 = add i32 %z2.0.i54.i.i130, %mul5.i.i123
  %add10.i43.i.i140 = add i32 %add9.i42.i.i139, %z2.0.i41.i.i137
  %add9.i.i.i141 = add i32 %add10.i43.i.i140, %factor
  %shr.i105 = lshr i32 %add.i37.i.i133, 5
  ...
  %shr.i60.i.i74 = lshr i32 %mul3.i.i71, 16
  %shl9.i62.i.i75 = shl i32 %mul3.i.i71, 16
  %add.i50.i.i76 = add i32 %shl9.i62.i.i75, %mul.i.i70
  %cmp.i51.i.i77 = icmp ult i32 %add.i50.i.i76, %mul.i.i70
  %cmp8.i52.i.i78 = icmp ult i32 %add.i50.i.i76, %shl9.i62.i.i75
  %or.cond.i53.i.i79 = or i1 %cmp.i51.i.i77, %cmp8.i52.i.i78
  %z2.0.i54.i.i80 = zext i1 %or.cond.i53.i.i79 to i32
  %add.i37.i.i83 = add i32 %add.i50.i.i76, %shl9.i62.i.i75
  %cmp.i38.i.i84 = icmp ult i32 %add.i37.i.i83, %add.i50.i.i76
  %cmp8.i39.i.i85 = icmp ult i32 %add.i37.i.i83, %shl9.i62.i.i75
  %or.cond.i40.i.i86 = or i1 %cmp.i38.i.i84, %cmp8.i39.i.i85
  %z2.0.i41.i.i87 = zext i1 %or.cond.i40.i.i86 to i32
  %factor224 = shl nuw nsw i32 %shr.i60.i.i74, 1
  %add9.i42.i.i89 = add i32 %z2.0.i54.i.i80, %mul5.i.i73
  %add10.i43.i.i90 = add i32 %add9.i42.i.i89, %z2.0.i41.i.i87
  %add9.i.i.i91 = add i32 %add10.i43.i.i90, %factor224
  %shr.i = lshr i32 %add.i37.i.i83, 5
...
entry:
  ...
  %0 = bitcast [4 x [24 x i32]]* %powers to i8*
  call void @llvm.lifetime.start(i64 384, i8* %0) #2
  ...
  %arrayidx1 = getelementptr inbounds [4 x [24 x i32]], [4 x [24 x i32]]* %powers, i32 0, i32 0, i32 0
  %1 = load i32, i32* %arrayidx1, align 4, !tbaa !4
  %2 = load i32, i32* getelementptr inbounds ([4 x [24 x i32]], [4 x [24 x i32]]* @powers_temp, i32 0, i32 0, i32 0), align 4, !tbaa !4
  %cmp4 = icmp eq i32 %1, %2
  br i1 %cmp4, label %for.cond, label %if.then

for.cond:                                         ; preds = %entry
  %arrayidx1.1 = getelementptr inbounds [4 x [24 x i32]], [4 x [24 x i32]]* %powers, i32 0, i32 1, i32 0
  %3 = load i32, i32* %arrayidx1.1, align 4, !tbaa !4
  %4 = load i32, i32* getelementptr inbounds ([4 x [24 x i32]], [4 x [24 x i32]]* @powers_temp, i32 0, i32 1, i32 0), align 4, !tbaa !4
  %cmp4.1 = icmp eq i32 %3, %4
  br i1 %cmp4.1, label %for.cond.1, label %if.then

if.then:                                          ; preds = %for.cond.2, %for.cond.1, %for.cond, %entry
  %.lcssa21 = phi i32 [ %2, %entry ], [ %4, %for.cond ], [ %7, %for.cond.1 ], [ %9, %for.cond.2 ]
  %.lcssa = phi i32 [ %1, %entry ], [ %3, %for.cond ], [ %6, %for.cond.1 ], [ %8, %for.cond.2 ]
  %arrayidx1.lcssa = phi i32* [ %arrayidx1, %entry ], [ %arrayidx1.1, %for.cond ], [ %arrayidx1.2, %for.cond.1 ], [ %arrayidx1.3, %for.cond.2 ]
  %call = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str, i32 0, i32 0), i32 %.lcssa, i32 %.lcssa21) #2
  %5 = load i32, i32* %arrayidx1.lcssa, align 4, !tbaa !4
  br label %cleanup

cleanup:                                          ; preds = %for.cond.3, %if.then
  %retval.0 = phi i32 [ %5, %if.then ], [ -1, %for.cond.3 ]
  call void @llvm.lifetime.end(i64 384, i8* %0) #2
  ret i32 %retval.0

for.cond.1:                                       ; preds = %for.cond
  %arrayidx1.2 = getelementptr inbounds [4 x [24 x i32]], [4 x [24 x i32]]* %powers, i32 0, i32 2, i32 0
  %6 = load i32, i32* %arrayidx1.2, align 4, !tbaa !4
  %7 = load i32, i32* getelementptr inbounds ([4 x [24 x i32]], [4 x [24 x i32]]* @powers_temp, i32 0, i32 2, i32 0), align 4, !tbaa !4
  %cmp4.2 = icmp eq i32 %6, %7
  br i1 %cmp4.2, label %for.cond.2, label %if.then

for.cond.2:                                       ; preds = %for.cond.1
  %arrayidx1.3 = getelementptr inbounds [4 x [24 x i32]], [4 x [24 x i32]]* %powers, i32 0, i32 3, i32 0
  %8 = load i32, i32* %arrayidx1.3, align 4, !tbaa !4
  %9 = load i32, i32* getelementptr inbounds ([4 x [24 x i32]], [4 x [24 x i32]]* @powers_temp, i32 0, i32 3, i32 0), align 4, !tbaa !4
  %cmp4.3 = icmp eq i32 %8, %9
  br i1 %cmp4.3, label %for.cond.3, label %if.then
