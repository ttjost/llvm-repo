...
;;
	...
	c0	mov $r0.19 = 11
	c0	mov $r0.20 = 0
	c0	mov $r0.23 = pcmdata_2
;;
	c0	ldb $r0.16 = 2[$r0.17]
;;
	c0	ldh $r0.15 = 0[$r0.17]
;;
	c0	sh2add $r0.11 = $r0.16, $r0.18
;;
...
## BB#2:                                ## %if.else.i
	...
	c0	ldb $r0.29 = 0[$r0.58]
;;
	c0	add $r0.58 = $r0.58, 1
;;
	c0	shru $r0.30 = $r0.29, $r0.11
;;
LBB0_3::                                ## %if.end.i
                                        ##   in Loop: Header=BB0_1 Depth=1
	c0	shl $r0.31 = $r0.30, $r0.21
	c0	shl $r0.32 = $r0.30, $r0.22
	c0	shr $r0.33 = $r0.27, $r0.14
	c0	shr $r0.34 = $r0.27, $r0.12
	c0	and $r0.35 = $r0.30, 15
;;
	c0	shr $r0.31 = $r0.31, $r0.24
	c0	shr $r0.32 = $r0.32, $r0.24
	c0	shl $r0.36 = $r0.30, $r0.24
	c0	sh2add $r0.35 = $r0.35, $r0.25
	c0	shr $r0.37 = $r0.27, $r0.13
;;
	c0	and $r0.30 = $r0.30, 8
	c0	and $r0.27 = $r0.31, $r0.27
;;
	c0	shr $r0.31 = $r0.36, $r0.24
...
;;
	c0	and $r0.30 = $r0.31, $r0.37
;;
	c0	add $r0.16 = $r0.33, $r0.16
	c0	add $r0.27 = $r0.27, $r0.32
;;
	c0	max $r0.16 = $r0.16, 0
	c0	cmpeq $b0.1 = $r0.28, 0
	c0	add $r0.27 = $r0.27, $r0.30
;;
	c0	min $r0.16 = $r0.16, 88
	c0	add $r0.19 = $r0.19, -1
	c0	sub $r0.28 = $r0.20, $r0.27
;;
	c0	sh2add $r0.30 = $r0.16, $r0.18
	c0	slct $r0.28 = $b0.0, $r0.27, $r0.28
;;
	c0	ldw $r0.27 = 0[$r0.30]
	c0	add $r0.15 = $r0.28, $r0.15
	c0	add $r0.31 = $r0.23, 2
	c0	cmpgt $b0.0 = $r0.19, 1
;;
	c0	mfb $r0.28 = $b0.1
;;
	c0	cmpgt $b0.1 = $r0.15, 32767
;;
	c0	max $r0.15 = $r0.15, -32768
;;
	c0	slct $r0.15 = $b0.1, $r0.26, $r0.15
;;
	c0	sth 0[$r0.23] = $r0.15
	c0	mov $r0.30 = $r0.29
;;
	c0	mov $r0.23 = $r0.31
	c0	br $b0.0, LBB0_1
...
## BB#4:                                ## %adpcm_decoder.exit
	c0	sth 0[$r0.17] = $r0.15
;;
	c0	stb 2[$r0.17] = $r0.16
;;
	c0	mov $r0.17 = -3
...
## BB#8:                                ## %for.cond.preheader
	c0	mov $r0.15 = pcmdata_2_ref
	c0	mov $r0.16 = pcmdata_2
	c0	mov $r0.17 = 0
;;
...
;;
	c0	add $r0.31 = $r0.28, $r0.29
	c0	shr $r0.32 = $r0.27, $r0.18
	c0	shr $r0.33 = $r0.27, $r0.14
	c0	and $r0.30 = $r0.29, 8
;;
	c0	xor $r0.34 = $r0.31, $r0.29
;;
...
;;
;;
	c0	slct $r0.30 = $b0.0, $r0.17, $r0.33
	c0	sh2add $r0.31 = $r0.27, $r0.20
;;
	c0	add $r0.29 = $r0.30, $r0.29
	c0	cmpgt $b0.0 = $r0.28, -1
;;
	c0	ldw $r0.28 = 0[$r0.31]
	c0	sub $r0.30 = $r0.17, $r0.29
;;
;;
...
LBB1_7::                                ## %if.end60
	...
	c0	slct $r0.15 = $b0.1, $r0.21, $r0.15
...
## BB#3:                                ## %if.else
	...
	c0	ldb $r0.29 = 0[$r0.26]
;;
	c0	add $r0.26 = $r0.26, 1
;;
	c0	shru $r0.30 = $r0.29, $r0.24
;;
LBB2_4::                                ## %if.end
                                        ##   in Loop: Header=BB2_2 Depth=1
	c0	shl $r0.31 = $r0.30, $r0.16
	c0	shl $r0.32 = $r0.30, $r0.17
...
;;
	...
	c0	shl $r0.36 = $r0.30, $r0.20
	c0	sh2add $r0.35 = $r0.35, $r0.22
	c0	shr $r0.37 = $r0.25, $r0.21
;;
	c0	and $r0.30 = $r0.30, 8
	c0	and $r0.25 = $r0.31, $r0.25
;;
	c0	shr $r0.31 = $r0.36, $r0.20
	c0	and $r0.32 = $r0.32, $r0.33
;;
	c0	ldw $r0.33 = 0[$r0.35]
	c0	cmpeq $b0.0 = $r0.30, 0
...
;;
	...
	c0	sub $r0.27 = $r0.15, $r0.25
;;
	c0	sh2add $r0.30 = $r0.11, $r0.13
	c0	slct $r0.27 = $b0.0, $r0.25, $r0.27
;;
	c0	ldw $r0.25 = 0[$r0.30]
