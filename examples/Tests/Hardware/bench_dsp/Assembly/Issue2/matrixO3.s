...
;;
	c0	mpyhs $r0.32 = $r0.30, $r0.23
	c0	mpylu $r0.30 = $r0.30, $r0.23
;;
...
;;
	...
	c0	mpyhs $r0.31 = $r0.34, $r0.20
;;
	c0	mpylu $r0.32 = $r0.34, $r0.20
	c0	add $r0.29 = $r0.29, $r0.30
;;
	c0	ldw $r0.30 = 280[$r0.28]
;;
	c0	add $r0.31 = $r0.32, $r0.31
	c0	mpyhs $r0.32 = $r0.33, $r0.19
;;
	c0	mpylu $r0.33 = $r0.33, $r0.19
;;
	c0	ldw $r0.34 = 320[$r0.28]
;;
	c0	add $r0.29 = $r0.29, $r0.31
;;
	c0	add $r0.31 = $r0.33, $r0.32
	c0	mpyhs $r0.32 = $r0.30, $r0.18
;;
	c0	mpylu $r0.30 = $r0.30, $r0.18
;;
	c0	ldw $r0.33 = 360[$r0.28]
;;
	c0	add $r0.29 = $r0.29, $r0.31
;;
	c0	add $r0.30 = $r0.30, $r0.32
	c0	mpyhs $r0.31 = $r0.34, $r0.17
;;
	c0	mpylu $r0.32 = $r0.34, $r0.17
;;
...
;;
	c0	add $r0.30 = $r0.32, $r0.31
	c0	mpyhs $r0.31 = $r0.33, $r0.16
;;
	c0	mpylu $r0.32 = $r0.33, $r0.16
	c0	add $r0.29 = $r0.29, $r0.30
;;
;;
	c0	add $r0.30 = $r0.32, $r0.31
	c0	mpyhs $r0.31 = $r0.28, $r0.25
;;
...
LBB1_1::                                ## %for.cond1.preheader
	...
	c0	ldw $r0.13 = -20[$r0.58]
;;
	c0	ldw $r0.14 = -20[$r0.57]
;;
;;
...
## BB#2:                                ## %for.cond1
	...
	c0	ldw $r0.13 = -16[$r0.58]
;;
	c0	ldw $r0.14 = -16[$r0.57]
;;
;;
...
## BB#4:                                ## %for.cond1.1
                                        ##   in Loop: Header=BB1_1 Depth=1
	c0	ldw $r0.13 = -12[$r0.58]
;;
	c0	ldw $r0.14 = -12[$r0.57]
;;
;;
	c0	cmpne $b0.0 = $r0.14, $r0.13
	c0	mov $r0.13 = $r0.11
...
## BB#5:                                ## %for.cond1.2
                                        ##   in Loop: Header=BB1_1 Depth=1
	c0	ldw $r0.13 = -8[$r0.58]
;;
	c0	ldw $r0.14 = -8[$r0.57]
;;
;;
	c0	cmpne $b0.0 = $r0.14, $r0.13
	c0	mov $r0.13 = $r0.11
...
## BB#6:                                ## %for.cond1.3
                                        ##   in Loop: Header=BB1_1 Depth=1
	c0	ldw $r0.13 = -4[$r0.58]
;;
	c0	ldw $r0.14 = -4[$r0.57]
;;
;;
	c0	cmpne $b0.0 = $r0.14, $r0.13
	c0	mov $r0.13 = $r0.11
