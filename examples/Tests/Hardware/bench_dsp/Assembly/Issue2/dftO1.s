...
.section .text 
.proc 
.entry caller, sp=$r0.1, rl=$l0.0, asize=-128, arg() ## @umult
umult::
## BB#0:                                ## %entry
...
;;
	...
	c0	zxth $r0.60 = $r0.5
;;
	c0	shru $r0.61 = $r0.5, $r0.59
	c0	mpylu $r0.12 = $r0.60, $r0.11
;;
	c0	mpyhs $r0.13 = $r0.60, $r0.11
	c0	mpylu $r0.14 = $r0.61, $r0.11
;;
	c0	mpyhs $r0.11 = $r0.61, $r0.11
;;
	c0	add $r0.4 = $r0.12, $r0.13
;;
	c0	add $r0.62 = $r0.14, $r0.11
	c0	add $r0.63 = $r0.1, 88
;;
	c0	mov $r0.3 = $r0.63
;;
...
.call sll, caller, arg($r0.3:u32, $r0.4:u32, $r0.5:u32, $r0.6:u32, $r0.7:u32, $r0.8:u32, $r0.9:u32, $r0.10:u32), ret()
	c0	call $l0.0 = sll
;;
	c0	shru $r0.57 = $r0.57, $r0.59
;;
	c0	mpylu $r0.11 = $r0.60, $r0.57
	c0	mpyhs $r0.12 = $r0.60, $r0.57
;;
	c0	ldw $r0.6 = 80[$r0.1]
;;
	c0	add $r0.60 = $r0.11, $r0.12
	c0	ldw $r0.7 = 84[$r0.1]
;;
	c0	add $r0.62 = $r0.1, 56
	c0	ldw $r0.5 = 92[$r0.1]
;;
	c0	add $r0.58 = $r0.1, 64
	c0	ldw $r0.4 = 88[$r0.1]
;;
	c0	mov $r0.3 = $r0.63
;;
...
.call sll, caller, arg($r0.3:u32, $r0.4:u32, $r0.5:u32, $r0.6:u32, $r0.7:u32, $r0.8:u32, $r0.9:u32, $r0.10:u32), ret()
	c0	call $l0.0 = sll
;;
	c0	mpylu $r0.11 = $r0.61, $r0.57
	c0	mpyhs $r0.12 = $r0.61, $r0.57
;;
	c0	ldw $r0.6 = 64[$r0.1]
;;
	c0	ldw $r0.4 = 88[$r0.1]
	c0	add $r0.57 = $r0.11, $r0.12
;;
	c0	ldw $r0.7 = 68[$r0.1]
...
;;
	c0	mov $r0.11 = 31
;;
	c0	shr $r0.12 = $r0.58, $r0.11
	c0	shr $r0.11 = $r0.59, $r0.11
;;
	c0	add $r0.13 = $r0.58, $r0.12
	c0	add $r0.14 = $r0.59, $r0.11
;;
	c0	xor $r0.5 = $r0.13, $r0.12
	c0	xor $r0.4 = $r0.14, $r0.11
;;
	c0	add $r0.3 = $r0.1, 24
;;
...
;;
	c0	mov $r0.60 = rowsums
;;
	c0	mov $r0.62 = 17
	c0	add $r0.14 = $r0.1, 144
;;
	c0	stw 84[$r0.1] = $r0.14
	c0	add $r0.14 = $r0.1, 152
;;
	c0	stw 80[$r0.1] = $r0.14
	c0	add $r0.14 = $r0.1, 128
;;
	c0	stw 76[$r0.1] = $r0.14
	c0	add $r0.14 = $r0.1, 136
;;
	c0	stw 72[$r0.1] = $r0.14
	c0	mov $r0.14 = 12
;;
	c0	stw 68[$r0.1] = $r0.14
	c0	add $r0.14 = $r0.1, 112
;;
	c0	stw 40[$r0.1] = $r0.14
	c0	add $r0.14 = $r0.1, 120
;;
	c0	stw 36[$r0.1] = $r0.14
	c0	mov $r0.14 = 5
;;
	c0	stw 64[$r0.1] = $r0.14
	c0	add $r0.14 = $r0.1, 96
;;
	c0	stw 32[$r0.1] = $r0.14
	c0	add $r0.14 = $r0.1, 104
;;
...
;;
	c0	stw 408[$r0.1] = $r0.58
;;
	c0	stw 404[$r0.1] = $r0.59
;;
	c0	stw 400[$r0.1] = $l0.0
;;
	c0	mov $r0.57 = powers_temp
;;
	c0	mov $r0.58 = 0
	c0	add $r0.59 = $r0.1, 16
;;
	c0	mov $r0.3 = $r0.59
;;
...
LBB12_3::                               ## %cleanup
	c0	mov $r0.3 = $r0.12
;;
	c0	ldw $l0.0 = 400[$r0.1]
;;
	c0	ldw $r0.59 = 404[$r0.1]
;;
	c0	ldw $r0.58 = 408[$r0.1]
;;
