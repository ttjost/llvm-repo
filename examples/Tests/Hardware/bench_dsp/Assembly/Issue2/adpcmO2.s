...
;;
	c0	ldhu $r0.13 = 0[$r0.12]
	c0	mov $r0.11 = 0
;;
	c0	ldhu $r0.14 = 0[$r0.57]
;;
;;
...
;;
## BB#5:                                ## %for.inc
	c0	ldhu $r0.13 = 2[$r0.12]
	c0	mov $r0.11 = 1
;;
	c0	ldhu $r0.14 = 2[$r0.57]
;;
;;
...
;;
## BB#8:                                ## %for.inc.1
	c0	ldhu $r0.13 = 4[$r0.12]
	c0	mov $r0.11 = 2
;;
	c0	ldhu $r0.14 = 4[$r0.57]
;;
;;
	c0	cmpne $b0.0 = $r0.14, $r0.13
;;
...
;;
## BB#9:                                ## %for.inc.2
	c0	ldhu $r0.13 = 6[$r0.12]
	c0	mov $r0.11 = 3
;;
	c0	ldhu $r0.14 = 6[$r0.57]
;;
;;
	c0	cmpne $b0.0 = $r0.14, $r0.13
;;
...
;;
## BB#11:                               ## %for.inc.4
	c0	ldhu $r0.13 = 10[$r0.12]
	c0	mov $r0.11 = 5
;;
	c0	ldhu $r0.14 = 10[$r0.57]
;;
;;
	c0	cmpne $b0.0 = $r0.14, $r0.13
;;
...
;;
## BB#12:                               ## %for.inc.5
	c0	ldhu $r0.13 = 12[$r0.12]
	c0	mov $r0.11 = 6
;;
	c0	ldhu $r0.14 = 12[$r0.57]
;;
;;
	c0	cmpne $b0.0 = $r0.14, $r0.13
;;
...
;;
## BB#13:                               ## %for.inc.6
	c0	ldhu $r0.13 = 14[$r0.12]
	c0	mov $r0.11 = 7
;;
	c0	ldhu $r0.14 = 14[$r0.57]
;;
;;
	c0	cmpne $b0.0 = $r0.14, $r0.13
;;
...
;;
## BB#14:                               ## %for.inc.7
	c0	ldhu $r0.13 = 16[$r0.12]
	c0	mov $r0.11 = 8
;;
	c0	ldhu $r0.14 = 16[$r0.57]
;;
;;
	c0	cmpne $b0.0 = $r0.14, $r0.13
;;
