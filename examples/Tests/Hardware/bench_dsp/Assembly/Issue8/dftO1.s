...
;;
	...
	c0	mpyhs $r0.12 = $r0.59, $r0.11
	c0	mpylu $r0.13 = $r0.59, $r0.11
	c0	shru $r0.57 = $r0.5, $r0.58
	c0	shru $r0.63 = $r0.4, $r0.58
	c0	add $r0.15 = $r0.1, 80
;;
	c0	stw 36[$r0.1] = $r0.15
	c0	add $r0.15 = $r0.1, 56
;;
	c0	stw 40[$r0.1] = $r0.15
	c0	mpyhs $r0.62 = $r0.57, $r0.11
	c0	add $r0.4 = $r0.13, $r0.12
	c0	mpylu $r0.60 = $r0.57, $r0.11
	c0	mov $r0.3 = $r0.14
;;
.call ucast, caller, arg($r0.3:u32, $r0.4:u32, $r0.5:u32, $r0.6:u32, $r0.7:u32, $r0.8:u32, $r0.9:u32, $r0.10:u32), ret()
	c0	call $l0.0 = ucast
;;
	c0	add $r0.4 = $r0.60, $r0.62
	c0	mov $r0.3 = $r0.61
;;
.call ucast, caller, arg($r0.3:u32, $r0.4:u32, $r0.5:u32, $r0.6:u32, $r0.7:u32, $r0.8:u32, $r0.9:u32, $r0.10:u32), ret()
	c0	call $l0.0 = ucast
;;
	c0	ldw $r0.5 = 92[$r0.1]
	c0	mpyhs $r0.60 = $r0.59, $r0.63
	c0	mpylu $r0.59 = $r0.59, $r0.63
	c0	mpylu $r0.61 = $r0.57, $r0.63
	c0	mpyhs $r0.57 = $r0.57, $r0.63
	c0	mov $r0.62 = 32
	c0	add $r0.63 = $r0.1, 64
;;
	c0	ldw $r0.4 = 88[$r0.1]
;;
	c0	ldw $r0.3 = 28[$r0.1]
...
;;
	...
	c0	shr $r0.11 = $r0.4, $r0.11
	c0	add $r0.3 = $r0.1, 32
	c0	xor $r0.13 = $r0.5, $r0.4
;;
	c0	add $r0.14 = $r0.4, $r0.11
	c0	add $r0.15 = $r0.5, $r0.12
...
;;
	c0	ldw $r0.62 = 48[$r0.1]
;;
;;
	c0	mpylu $r0.57 = $r0.62, 96
	c0	mpyhs $r0.60 = $r0.62, 96
...
;;
;;
	c0	add $r0.61 = $r0.61, 96
	c0	cmpne $b0.0 = $r0.62, 4
