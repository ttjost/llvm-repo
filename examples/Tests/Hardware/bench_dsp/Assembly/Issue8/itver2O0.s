...
.section .text 
.proc 
.entry caller, sp=$r0.1, rl=$l0.0, asize=-2304, arg() ## @itver2
itver2::
## BB#0:                                ## %entry
	c0	add $r0.1 = $r0.1, -2304
;;
	c0	sth 2284[$r0.1] = $r0.3
;;
	c0	stw 2280[$r0.1] = $r0.4
;;
	c0	sth 2276[$r0.1] = $r0.5
;;
	c0	sth 2272[$r0.1] = $r0.6
;;
	c0	stw 2268[$r0.1] = $r0.7
;;
	c0	ldhu $r0.11 = 2284[$r0.1]
;;
;;
...
## BB#1:                                ## %if.then
	...
	c0	mov $r0.14 = 3
	c0	mov $r0.15 = 2
	c0	add $r0.11 = $r0.1, 1112
	c0	add $r0.12 = $r0.1, 88
;;
	c0	sth 2192[$r0.1] = $r0.13
;;
	c0	sth 2188[$r0.1] = $r0.14
;;
	c0	sth 2184[$r0.1] = $r0.15
;;
	c0	stw 2180[$r0.1] = $r0.11
;;
	c0	ldh $r0.13 = 2192[$r0.1]
	c0	mov $r0.14 = 0
;;
;;
	c0	sh2add $r0.13 = $r0.13, $r0.12
;;
	c0	stw 2176[$r0.1] = $r0.13
;;
	c0	sth 2216[$r0.1] = $r0.14
	c0	mov $r0.13 = zcos2_fixed
	c0	mov $r0.14 = zsin2_fixed
	c0	mov $r0.15 = 63
	c0	mov $r0.16 = 16
;;
	c0	mov $r0.17 = 15
...
LBB0_2::                                ## %for.cond
	...
	c0	ldh $r0.19 = 2216[$r0.1]
;;
;;
	c0	cmpgt $b0.0 = $r0.19, 63
;;
;;
	c0	br $b0.0, LBB0_7
;;
...
;;
;;
	c0	sh2add $r0.19 = $r0.19, $r0.13
;;
	c0	ldw $r0.19 = 0[$r0.19]
;;
;;
	c0	stw 2140[$r0.1] = $r0.19
;;
	c0	ldh $r0.19 = 2216[$r0.1]
;;
;;
	c0	sh2add $r0.19 = $r0.19, $r0.14
;;
	c0	ldw $r0.19 = 0[$r0.19]
;;
;;
	c0	stw 2136[$r0.1] = $r0.19
;;
	c0	ldw $r0.19 = 2280[$r0.1]
;;
	c0	ldh $r0.20 = 2216[$r0.1]
;;
;;
	c0	sh4add $r0.19 = $r0.20, $r0.19
;;
	c0	ldw $r0.19 = 0[$r0.19]
;;
;;
	c0	stw 2168[$r0.1] = $r0.19
;;
	c0	ldh $r0.19 = 2216[$r0.1]
;;
	c0	ldw $r0.20 = 2280[$r0.1]
;;
	c0	sub $r0.19 = $r0.15, $r0.19
;;
	c0	sh4add $r0.19 = $r0.19, $r0.20
;;
	c0	ldw $r0.19 = 8[$r0.19]
;;
;;
	c0	stw 2172[$r0.1] = $r0.19
;;
	c0	ldw $r0.19 = 2280[$r0.1]
;;
	c0	ldh $r0.20 = 2216[$r0.1]
...
;;
	c0	sh4add $r0.19 = $r0.20, $r0.19
;;
	c0	ldw $r0.19 = 4[$r0.19]
;;
;;
	c0	stw 2160[$r0.1] = $r0.19
;;
	c0	ldh $r0.19 = 2216[$r0.1]
;;
	c0	ldw $r0.20 = 2280[$r0.1]
...
;;
;;
	c0	stw 2164[$r0.1] = $r0.19
;;
	c0	ldw $r0.19 = 2140[$r0.1]
;;
	c0	ldw $r0.20 = 2172[$r0.1]
;;
	c0	zxth $r0.21 = $r0.19
	c0	shr $r0.19 = $r0.19, $r0.16
;;
	c0	shr $r0.22 = $r0.20, $r0.16
	c0	zxth $r0.20 = $r0.20
;;
	c0	mpylu $r0.23 = $r0.22, $r0.21
	c0	mpyhs $r0.21 = $r0.22, $r0.21
	c0	mpylu $r0.24 = $r0.19, $r0.20
	c0	mpyhs $r0.25 = $r0.22, $r0.19
	c0	mpyhs $r0.20 = $r0.19, $r0.20
	c0	mpylu $r0.19 = $r0.22, $r0.19
;;
;;
...
;;
	c0	stw 2264[$r0.1] = $r0.19
;;
	c0	ldw $r0.19 = 2136[$r0.1]
;;
	c0	ldw $r0.20 = 2168[$r0.1]
;;
	c0	zxth $r0.21 = $r0.19
	c0	shr $r0.19 = $r0.19, $r0.16
;;
...
;;
	c0	add $r0.19 = $r0.19, $r0.20
;;
	c0	stw 2252[$r0.1] = $r0.19
;;
	c0	ldw $r0.19 = 2140[$r0.1]
;;
	c0	ldw $r0.20 = 2164[$r0.1]
;;
	c0	zxth $r0.21 = $r0.19
	c0	shr $r0.19 = $r0.19, $r0.16
;;
...
;;
	c0	add $r0.19 = $r0.19, $r0.20
;;
	c0	stw 2248[$r0.1] = $r0.19
;;
	c0	ldw $r0.19 = 2136[$r0.1]
;;
	c0	ldw $r0.20 = 2160[$r0.1]
;;
	c0	zxth $r0.21 = $r0.19
	c0	shr $r0.19 = $r0.19, $r0.16
;;
...
;;
	c0	add $r0.19 = $r0.19, $r0.20
;;
	c0	stw 2236[$r0.1] = $r0.19
;;
	c0	ldh $r0.19 = 2216[$r0.1]
;;
;;
	c0	sh2add $r0.19 = $r0.19, $r0.18
;;
	c0	ldh $r0.19 = 0[$r0.19]
;;
;;
	c0	sth 2212[$r0.1] = $r0.19
;;
	c0	ldh $r0.19 = 2212[$r0.1]
;;
	c0	ldw $r0.20 = 2260[$r0.1]
;;
	c0	sh2add $r0.19 = $r0.19, $r0.11
	c0	ldw $r0.21 = 2264[$r0.1]
;;
;;
...
;;
	c0	ldh $r0.19 = 2212[$r0.1]
;;
	c0	ldw $r0.20 = 2252[$r0.1]
;;
	c0	sh2add $r0.19 = $r0.19, $r0.12
	c0	ldw $r0.21 = 2256[$r0.1]
;;
;;
	c0	add $r0.20 = $r0.21, $r0.20
;;
	c0	stw 256[$r0.19] = $r0.20
;;
	c0	ldh $r0.19 = 2212[$r0.1]
;;
	c0	ldw $r0.20 = 2244[$r0.1]
;;
	c0	sh2add $r0.19 = $r0.19, $r0.11
	c0	ldw $r0.21 = 2248[$r0.1]
;;
;;
	c0	sub $r0.20 = $r0.21, $r0.20
;;
...
;;
	c0	ldh $r0.19 = 2212[$r0.1]
;;
	c0	ldw $r0.20 = 2236[$r0.1]
;;
	c0	sh2add $r0.19 = $r0.19, $r0.12
	c0	ldw $r0.21 = 2240[$r0.1]
;;
;;
	c0	add $r0.20 = $r0.21, $r0.20
;;
...
LBB0_4::                                ## %if.else
	...
	c0	add $r0.11 = $r0.1, 1112
;;
	c0	sth 2192[$r0.1] = $r0.12
	c0	add $r0.12 = $r0.1, 88
;;
	c0	sth 2188[$r0.1] = $r0.13
;;
	c0	sth 2184[$r0.1] = $r0.14
;;
	c0	stw 2180[$r0.1] = $r0.11
	c0	mov $r0.13 = 0
;;
	c0	stw 2176[$r0.1] = $r0.12
;;
	c0	sth 2216[$r0.1] = $r0.13
	c0	mov $r0.13 = 127
	c0	mov $r0.14 = zcos1_fixed
	c0	mov $r0.15 = zsin1_fixed
	c0	mov $r0.16 = 16
;;
	c0	mov $r0.17 = 15
	c0	mov $r0.18 = bitrev
...
LBB0_5::                                ## %for.cond165
                                        ## =>This Inner Loop Header: Depth=1
	c0	ldh $r0.19 = 2192[$r0.1]
;;
	c0	ldh $r0.20 = 2216[$r0.1]
;;
;;
	c0	cmpge $b0.0 = $r0.20, $r0.19
;;
;;
	c0	br $b0.0, LBB0_7
;;
...
;;
	c0	ldw $r0.20 = 2280[$r0.1]
;;
	c0	sub $r0.19 = $r0.13, $r0.19
;;
	c0	sh3add $r0.19 = $r0.19, $r0.20
;;
	c0	ldw $r0.19 = 4[$r0.19]
;;
;;
...
LBB0_7::                                ## %if.end
	...
	c0	mov $r0.15 = 1
;;
	c0	sth 2200[$r0.1] = $r0.12
;;
	c0	ldh $r0.16 = 2192[$r0.1]
	c0	mov $r0.12 = 0
;;
;;
	c0	shru $r0.16 = $r0.16, $r0.13
;;
	c0	sth 2196[$r0.1] = $r0.16
;;
	c0	ldh $r0.16 = 2188[$r0.1]
;;
;;
	c0	sth 84[$r0.1] = $r0.16
;;
	c0	ldh $r0.16 = 84[$r0.1]
;;
;;
	c0	sub $r0.16 = $r0.11, $r0.16
;;
	c0	shru $r0.16 = $r0.14, $r0.16
;;
	c0	sth 52[$r0.1] = $r0.16
;;
	c0	ldh $r0.16 = 52[$r0.1]
;;
;;
	c0	xor $r0.16 = $r0.16, -1
;;
	c0	sth 48[$r0.1] = $r0.16
;;
	c0	sth 80[$r0.1] = $r0.13
;;
	c0	ldh $r0.13 = 2192[$r0.1]
;;
;;
...
;;
	c0	sth 56[$r0.1] = $r0.13
;;
	c0	ldh $r0.13 = 2188[$r0.1]
;;
;;
	c0	add $r0.13 = $r0.13, 2
;;
	c0	sth 44[$r0.1] = $r0.13
;;
	c0	ldh $r0.13 = 44[$r0.1]
;;
;;
	c0	sub $r0.13 = $r0.11, $r0.13
;;
	c0	shru $r0.13 = $r0.14, $r0.13
;;
...
;;
	c0	sth 2216[$r0.1] = $r0.12
	c0	add $r0.13 = $r0.1, 1112
	c0	add $r0.14 = $r0.1, 88
;;
LBB0_8::                                ## %for.cond281
                                        ## =>This Inner Loop Header: Depth=1
	c0	ldh $r0.16 = 2184[$r0.1]
;;
	c0	ldh $r0.17 = 2192[$r0.1]
;;
	c0	ldh $r0.18 = 2216[$r0.1]
;;
	c0	mpyhs $r0.19 = $r0.17, $r0.16
	c0	mpylu $r0.16 = $r0.17, $r0.16
;;
;;
	c0	add $r0.16 = $r0.16, $r0.19
;;
	c0	cmpge $b0.0 = $r0.18, $r0.16
;;
;;
	c0	br $b0.0, LBB0_19
;;
...
;;
	c0	mfb $r0.16 = $b0.0
;;
	c0	sth 2204[$r0.1] = $r0.16
;;
	c0	ldh $r0.16 = 2204[$r0.1]
;;
;;
...
;;
;;
	c0	sh2add $r0.16 = $r0.16, $r0.13
	c0	goto LBB0_12
;;
LBB0_11::                               ## %cond.false
                                        ##   in Loop: Header=BB0_8 Depth=1
	c0	ldw $r0.16 = 2180[$r0.1]
;;
LBB0_12::                               ## %cond.end
                                        ##   in Loop: Header=BB0_8 Depth=1
	c0	stw 2180[$r0.1] = $r0.16
;;
	c0	ldh $r0.16 = 2204[$r0.1]
;;
;;
...
## BB#13:                               ## %cond.true302
	...
	c0	goto LBB0_15
;;
LBB0_14::                               ## %cond.false304
                                        ##   in Loop: Header=BB0_8 Depth=1
	c0	ldw $r0.16 = 2176[$r0.1]
;;
LBB0_15::                               ## %cond.end305
                                        ##   in Loop: Header=BB0_8 Depth=1
	c0	stw 2176[$r0.1] = $r0.16
;;
	c0	ldh $r0.16 = 2192[$r0.1]
;;
	c0	ldh $r0.17 = 2216[$r0.1]
...
;;
	...
	c0	goto LBB0_18
;;
LBB0_17::                               ## %cond.false315
                                        ##   in Loop: Header=BB0_8 Depth=1
	c0	ldh $r0.16 = 2216[$r0.1]
;;
LBB0_18::                               ## %for.inc388
                                        ##   in Loop: Header=BB0_8 Depth=1
	c0	sth 2208[$r0.1] = $r0.16
;;
	c0	ldw $r0.16 = 2180[$r0.1]
;;
	c0	ldh $r0.17 = 2208[$r0.1]
;;
;;
	c0	sh2add $r0.16 = $r0.17, $r0.16
;;
	c0	ldw $r0.16 = 0[$r0.16]
;;
;;
	c0	stw 2172[$r0.1] = $r0.16
;;
	c0	ldw $r0.16 = 2176[$r0.1]
;;
	c0	ldh $r0.17 = 2208[$r0.1]
...
;;
	c0	sh2add $r0.16 = $r0.17, $r0.16
;;
	c0	ldw $r0.16 = 8[$r0.16]
;;
;;
	c0	stw 2156[$r0.1] = $r0.16
;;
	c0	ldw $r0.16 = 2176[$r0.1]
;;
	c0	ldh $r0.17 = 2208[$r0.1]
...
;;
	c0	sh2add $r0.16 = $r0.17, $r0.16
;;
	c0	ldw $r0.16 = 12[$r0.16]
;;
;;
	c0	stw 2148[$r0.1] = $r0.16
;;
	c0	ldw $r0.16 = 2176[$r0.1]
;;
	c0	ldh $r0.17 = 2208[$r0.1]
...
;;
;;
	c0	stw 2144[$r0.1] = $r0.16
;;
	c0	ldw $r0.16 = 2172[$r0.1]
;;
	c0	ldw $r0.17 = 2164[$r0.1]
;;
	c0	ldw $r0.18 = 2156[$r0.1]
;;
	c0	add $r0.16 = $r0.16, $r0.17
;;
	c0	add $r0.16 = $r0.16, $r0.18
	c0	ldw $r0.17 = 2148[$r0.1]
;;
	c0	ldw $r0.18 = 2180[$r0.1]
;;
	c0	add $r0.16 = $r0.16, $r0.17
	c0	ldh $r0.17 = 2208[$r0.1]
;;
...
;;
	c0	ldw $r0.16 = 2168[$r0.1]
;;
	c0	ldw $r0.17 = 2160[$r0.1]
;;
	c0	ldw $r0.18 = 2152[$r0.1]
;;
	c0	add $r0.16 = $r0.16, $r0.17
;;
	c0	add $r0.16 = $r0.16, $r0.18
	c0	ldw $r0.17 = 2144[$r0.1]
;;
	c0	ldw $r0.18 = 2176[$r0.1]
;;
	c0	add $r0.16 = $r0.16, $r0.17
	c0	ldh $r0.17 = 2208[$r0.1]
;;
...
;;
	c0	sth 2216[$r0.1] = $r0.16
	c0	goto LBB0_8
;;
LBB0_19::                               ## %for.end392
	c0	stw 2180[$r0.1] = $r0.13
;;
	c0	ldh $r0.14 = 2284[$r0.1]
;;
;;
...
;;
## BB#20:                               ## %cond.true396
	c0	ldh $r0.14 = 2192[$r0.1]
	c0	add $r0.16 = $r0.1, 88
;;
;;
	c0	sh2add $r0.14 = $r0.14, $r0.16
	c0	goto LBB0_22
;;
LBB0_21::                               ## %cond.false400
	c0	add $r0.14 = $r0.1, 88
;;
LBB0_22::                               ## %cond.end402
	c0	stw 2176[$r0.1] = $r0.14
;;
	c0	stw 36[$r0.1] = $r0.12
	c0	add $r0.16 = $r0.1, 88
	c0	mov $r0.17 = xcos_fixed
	c0	mov $r0.18 = xsin_fixed
	c0	mov $r0.14 = 16
;;
LBB0_23::                               ## %for.cond404
                                        ## =>This Inner Loop Header: Depth=1
	c0	ldh $r0.19 = 2184[$r0.1]
;;
	c0	ldw $r0.20 = 32[$r0.1]
;;
	c0	ldw $r0.21 = 36[$r0.1]
;;
	c0	mpyhs $r0.22 = $r0.20, $r0.19
	c0	mpylu $r0.19 = $r0.20, $r0.19
;;
;;
	c0	add $r0.19 = $r0.19, $r0.22
;;
	c0	cmpgeu $b0.0 = $r0.21, $r0.19
;;
;;
	c0	br $b0.0, LBB0_40
;;
## BB#24:                               ## %for.body409
	...
	c0	ldw $r0.19 = 32[$r0.1]
;;
	c0	ldw $r0.20 = 36[$r0.1]
;;
;;
	c0	cmpgeu $b0.0 = $r0.20, $r0.19
;;
;;
	c0	mfb $r0.19 = $b0.0
;;
	c0	sth 2204[$r0.1] = $r0.19
;;
	c0	ldh $r0.19 = 2204[$r0.1]
;;
;;
...
;;
	...
	c0	goto LBB0_27
;;
LBB0_26::                               ## %cond.false420
                                        ##   in Loop: Header=BB0_23 Depth=1
	c0	ldw $r0.19 = 2180[$r0.1]
;;
LBB0_27::                               ## %cond.end421
                                        ##   in Loop: Header=BB0_23 Depth=1
	c0	stw 2180[$r0.1] = $r0.19
;;
	c0	ldh $r0.19 = 2204[$r0.1]
;;
;;
...
## BB#28:                               ## %cond.true425
	...
	c0	goto LBB0_30
;;
LBB0_29::                               ## %cond.false427
                                        ##   in Loop: Header=BB0_23 Depth=1
	c0	ldw $r0.19 = 2176[$r0.1]
;;
LBB0_30::                               ## %cond.end428
                                        ##   in Loop: Header=BB0_23 Depth=1
	c0	stw 2176[$r0.1] = $r0.19
;;
	c0	ldh $r0.19 = 2204[$r0.1]
;;
;;
...
;;
	c0	ldw $r0.20 = 36[$r0.1]
;;
	c0	ldh $r0.21 = 44[$r0.1]
;;
	c0	sub $r0.19 = $r0.20, $r0.19
;;
	c0	shru $r0.19 = $r0.19, $r0.21
	c0	goto LBB0_33
;;
LBB0_32::                               ## %cond.false436
                                        ##   in Loop: Header=BB0_23 Depth=1
	c0	ldh $r0.19 = 44[$r0.1]
;;
	c0	ldw $r0.20 = 36[$r0.1]
;;
;;
	c0	shru $r0.19 = $r0.20, $r0.19
;;
LBB0_33::                               ## %cond.end439
                                        ##   in Loop: Header=BB0_23 Depth=1
...
;;
	c0	sub $r0.19 = $r0.20, $r0.19
;;
	c0	and $r0.19 = $r0.19, $r0.21
	c0	goto LBB0_36
;;
LBB0_35::                               ## %cond.false445
                                        ##   in Loop: Header=BB0_23 Depth=1
	c0	ldw $r0.19 = 28[$r0.1]
;;
	c0	ldw $r0.20 = 36[$r0.1]
;;
;;
...
LBB0_36::                               ## %cond.end447
                                        ##   in Loop: Header=BB0_23 Depth=1
	c0	sth 76[$r0.1] = $r0.19
;;
	c0	sth 68[$r0.1] = $r0.19
;;
	c0	sth 72[$r0.1] = $r0.19
;;
	c0	ldh $r0.19 = 2184[$r0.1]
;;
;;
	c0	cmpne $b0.0 = $r0.19, 2
;;
;;
	c0	br $b0.0, LBB0_38
;;
## BB#37:                               ## %cond.true453
                                        ##   in Loop: Header=BB0_23 Depth=1
	c0	ldw $r0.19 = 40[$r0.1]
;;
	c0	ldh $r0.20 = 48[$r0.1]
;;
	c0	ldh $r0.21 = 76[$r0.1]
;;
	c0	shr $r0.19 = $r0.20, $r0.19
;;
	c0	and $r0.19 = $r0.21, $r0.19
;;
	c0	shl $r0.19 = $r0.19, $r0.15
	c0	goto LBB0_39
;;
LBB0_38::                               ## %cond.false459
                                        ##   in Loop: Header=BB0_23 Depth=1
	c0	ldw $r0.19 = 40[$r0.1]
;;
	c0	ldh $r0.20 = 48[$r0.1]
...
LBB0_39::                               ## %for.inc577
                                        ##   in Loop: Header=BB0_23 Depth=1
	c0	sth 64[$r0.1] = $r0.19
;;
	c0	ldh $r0.19 = 52[$r0.1]
;;
	c0	ldh $r0.20 = 80[$r0.1]
;;
	c0	ldh $r0.21 = 84[$r0.1]
;;
	c0	ldh $r0.22 = 68[$r0.1]
;;
	c0	ldh $r0.23 = 72[$r0.1]
;;
	c0	ldw $r0.24 = 40[$r0.1]
;;
;;
	c0	shr $r0.19 = $r0.19, $r0.24
	c0	sub $r0.21 = $r0.21, $r0.24
	c0	add $r0.20 = $r0.20, $r0.24
;;
	c0	and $r0.19 = $r0.22, $r0.19
	c0	shr $r0.21 = $r0.23, $r0.21
;;
	c0	shl $r0.19 = $r0.19, $r0.20
;;
	c0	add $r0.19 = $r0.21, $r0.19
;;
	c0	sth 2208[$r0.1] = $r0.19
;;
	c0	ldw $r0.19 = 40[$r0.1]
;;
	c0	ldh $r0.20 = 2200[$r0.1]
;;
	c0	ldh $r0.21 = 2208[$r0.1]
;;
	c0	shl $r0.19 = $r0.20, $r0.19
;;
	c0	add $r0.19 = $r0.21, $r0.19
;;
	c0	sth 60[$r0.1] = $r0.19
;;
	c0	ldh $r0.19 = 64[$r0.1]
;;
;;
	c0	sh2add $r0.19 = $r0.19, $r0.17
;;
	c0	ldw $r0.19 = 0[$r0.19]
;;
;;
...
;;
	c0	ldw $r0.19 = 2180[$r0.1]
;;
	c0	ldh $r0.20 = 2208[$r0.1]
;;
;;
	c0	sh2add $r0.19 = $r0.20, $r0.19
;;
	c0	ldw $r0.19 = 0[$r0.19]
;;
;;
...
;;
	...
	c0	add $r0.19 = $r0.19, $r0.25
;;
	c0	shr $r0.21 = $r0.21, $r0.11
	c0	shr $r0.20 = $r0.20, $r0.11
;;
	c0	sh1add $r0.19 = $r0.19, $r0.21
;;
	c0	add $r0.19 = $r0.19, $r0.20
...
;;
	c0	stw 2236[$r0.1] = $r0.19
;;
	c0	ldw $r0.19 = 2172[$r0.1]
;;
	c0	ldw $r0.20 = 2248[$r0.1]
;;
	c0	ldw $r0.21 = 2180[$r0.1]
;;
	c0	sub $r0.19 = $r0.19, $r0.20
	c0	ldh $r0.20 = 2208[$r0.1]
;;
	c0	ldw $r0.22 = 2244[$r0.1]
;;
	c0	sh2add $r0.20 = $r0.20, $r0.21
;;
	c0	add $r0.19 = $r0.19, $r0.22
;;
	c0	stw 0[$r0.20] = $r0.19
;;
	c0	ldw $r0.19 = 2168[$r0.1]
;;
	c0	ldw $r0.20 = 2240[$r0.1]
;;
	c0	ldw $r0.21 = 2176[$r0.1]
;;
	c0	sub $r0.19 = $r0.19, $r0.20
	c0	ldh $r0.20 = 2208[$r0.1]
;;
	c0	ldw $r0.22 = 2236[$r0.1]
;;
	c0	sh2add $r0.20 = $r0.20, $r0.21
;;
	c0	sub $r0.19 = $r0.19, $r0.22
;;
	c0	stw 0[$r0.20] = $r0.19
;;
	c0	ldw $r0.19 = 2172[$r0.1]
...
;;
	c0	add $r0.19 = $r0.19, 1
;;
	c0	stw 36[$r0.1] = $r0.19
	c0	goto LBB0_23
;;
LBB0_40::                               ## %for.end579
	c0	ldhu $r0.15 = 2284[$r0.1]
;;
;;
...
;;
;;
	c0	sh2add $r0.18 = $r0.18, $r0.15
;;
	c0	ldw $r0.18 = 0[$r0.18]
;;
;;
	c0	stw 2140[$r0.1] = $r0.18
;;
	c0	ldh $r0.18 = 2216[$r0.1]
;;
;;
	c0	sh2add $r0.18 = $r0.18, $r0.16
;;
	c0	ldw $r0.18 = 0[$r0.18]
;;
;;
	c0	stw 2136[$r0.1] = $r0.18
;;
	c0	ldh $r0.18 = 2216[$r0.1]
;;
;;
	c0	sh2add $r0.18 = $r0.18, $r0.13
;;
	c0	ldw $r0.18 = 0[$r0.18]
;;
;;
	c0	stw 2172[$r0.1] = $r0.18
;;
	c0	ldh $r0.18 = 2216[$r0.1]
;;
;;
	c0	sh2add $r0.18 = $r0.18, $r0.17
;;
	c0	ldw $r0.18 = 256[$r0.18]
;;
;;
	c0	stw 2168[$r0.1] = $r0.18
;;
	c0	ldh $r0.18 = 2216[$r0.1]
;;
;;
...
;;
;;
	c0	stw 2160[$r0.1] = $r0.18
;;
	c0	ldw $r0.18 = 2140[$r0.1]
;;
	c0	ldw $r0.19 = 2172[$r0.1]
;;
	c0	zxth $r0.20 = $r0.18
...
;;
	c0	shr $r0.21 = $r0.19, $r0.14
	c0	zxth $r0.19 = $r0.19
;;
	c0	mpylu $r0.22 = $r0.21, $r0.20
	c0	mpyhs $r0.20 = $r0.21, $r0.20
	c0	mpylu $r0.23 = $r0.18, $r0.19
	c0	mpyhs $r0.24 = $r0.21, $r0.18
	c0	mpyhs $r0.19 = $r0.18, $r0.19
	c0	mpylu $r0.18 = $r0.21, $r0.18
;;
;;
...
;;
	c0	shr $r0.20 = $r0.20, $r0.11
	c0	shr $r0.19 = $r0.19, $r0.11
;;
	c0	sh1add $r0.18 = $r0.18, $r0.20
;;
	c0	add $r0.18 = $r0.18, $r0.19
;;
	c0	stw 2248[$r0.1] = $r0.18
;;
	c0	ldw $r0.18 = 2136[$r0.1]
;;
	c0	ldw $r0.19 = 2168[$r0.1]
;;
	c0	zxth $r0.20 = $r0.18
...
;;
	c0	add $r0.18 = $r0.18, $r0.19
;;
	c0	stw 2236[$r0.1] = $r0.18
;;
	c0	ldw $r0.18 = 2140[$r0.1]
;;
	c0	ldw $r0.19 = 2164[$r0.1]
;;
	c0	zxth $r0.20 = $r0.18
	c0	shr $r0.18 = $r0.18, $r0.14
;;
...
;;
	c0	add $r0.18 = $r0.18, $r0.19
;;
	c0	stw 2232[$r0.1] = $r0.18
;;
	c0	ldw $r0.18 = 2136[$r0.1]
;;
	c0	ldw $r0.19 = 2160[$r0.1]
;;
	c0	zxth $r0.20 = $r0.18
	c0	shr $r0.18 = $r0.18, $r0.14
;;
...
;;
	c0	add $r0.18 = $r0.18, $r0.19
;;
	c0	stw 2220[$r0.1] = $r0.18
;;
	c0	ldh $r0.18 = 2216[$r0.1]
;;
	c0	ldw $r0.19 = 2244[$r0.1]
;;
	c0	sh2add $r0.18 = $r0.18, $r0.13
	c0	ldw $r0.20 = 2248[$r0.1]
;;
...
;;
	c0	stw 256[$r0.18] = $r0.19
;;
	c0	ldh $r0.18 = 2216[$r0.1]
;;
	c0	ldw $r0.19 = 2228[$r0.1]
;;
	c0	sh2add $r0.18 = $r0.18, $r0.13
	c0	ldw $r0.20 = 2232[$r0.1]
;;
;;
	c0	sub $r0.19 = $r0.20, $r0.19
;;
...
;;
	c0	ldh $r0.18 = 2216[$r0.1]
;;
	c0	ldw $r0.19 = 2220[$r0.1]
;;
	c0	sh2add $r0.18 = $r0.18, $r0.17
	c0	ldw $r0.20 = 2224[$r0.1]
;;
;;
	c0	add $r0.19 = $r0.20, $r0.19
;;
...
;;
	c0	sth 2216[$r0.1] = $r0.18
	c0	goto LBB0_42
;;
LBB0_44::                               ## %if.else746
	c0	sth 2216[$r0.1] = $r0.12
	c0	add $r0.15 = $r0.1, 88
	c0	mov $r0.16 = zcos1_fixed
	c0	mov $r0.17 = zsin1_fixed
;;
LBB0_45::                               ## %for.cond747
                                        ## =>This Inner Loop Header: Depth=1
	c0	ldh $r0.18 = 2216[$r0.1]
...
LBB0_47::                               ## %if.end833
	c0	sth 2216[$r0.1] = $r0.12
	c0	add $r0.11 = $r0.1, 88
;;
LBB0_48::                               ## %for.cond834
                                        ## =>This Inner Loop Header: Depth=1
	c0	ldh $r0.12 = 2216[$r0.1]
;;
;;
	c0	cmpgt $b0.0 = $r0.12, 127
;;
;;
	c0	br $b0.0, LBB0_50
;;
...
;;
;;
	c0	sh2add $r0.14 = $r0.12, $r0.13
	c0	ldw $r0.15 = 2280[$r0.1]
;;
	c0	ldw $r0.14 = 0[$r0.14]
;;
	c0	sh2add $r0.12 = $r0.12, $r0.15
;;
	c0	stw 0[$r0.12] = $r0.14
;;
	c0	ldh $r0.12 = 2216[$r0.1]
;;
	c0	ldw $r0.14 = 2280[$r0.1]
;;
	c0	sh2add $r0.15 = $r0.12, $r0.11
;;
	c0	sh2add $r0.12 = $r0.12, $r0.14
	c0	ldw $r0.14 = 0[$r0.15]
;;
;;
	c0	stw 512[$r0.12] = $r0.14
;;
	c0	ldh $r0.12 = 2216[$r0.1]
;;
;;
...
;;
	...
	c0	mov $r0.58 = 0
	c0	mov $r0.11 = slct
	c0	mov $r0.12 = bswitch
	c0	mov $r0.13 = channum
;;
	c0	mov $r0.14 = acmod
