...
if.then:                                          ; preds = %for.body
  ...
  %arrayidx4 = getelementptr inbounds [256 x i32], [256 x i32]* @tcbuf_out, i32 0, i32 %11
  %12 = load i32, i32* %arrayidx4, align 4
  %call = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str, i32 0, i32 0), i32 %10, i32 %12)
...
for.end:                                          ; preds = %for.cond
  %call5 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str1, i32 0, i32 0))
